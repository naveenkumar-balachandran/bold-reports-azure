...
*  applicable laws. 
*/
function(e){"function"==typeof define&&define.amd?define(["./../common/ej.core.min"],e):e()}((function(){var e,t;e=jQuery,(t=Syncfusion).widget("ejWaitingPopup","ej.WaitingPopup",{element:null,model:null,validTags:["div","span"],_setFirst:!1,_rootCSS:"e-waitingpopup",defaults:{showOnInit:!1,target:null,appendTo:null,showImage:!0,htmlAttributes:{},cssClass:"",text:null,template:null,create:null,destroy:null},dataTypes:{showOnInit:"boolean",showImage:"boolean",cssClass:"string"},_isTargetVisible:function(){return"none"!=this.element.css("display")},show:function(){this._isTargetVisible()&&(this._refreshPanel(),this.maindiv.css("display","block"),this.model.showOnInit=!0)},hide:function(){this.maindiv.css("display","none"),this.model.showOnInit=!1},refresh:function(){this._isTargetVisible()&&this._refreshPanel()},_setText:function(e){e?this.popupText?this.popupText.html(e):(this._generateTextTag(e),this._setContentPosition()):this.popupText&&(this.popupText.remove(),this.popupText=null)},_showImage:function(e){e?(this.popupImage=t.buildTag("span.e-image"),this.popupText?this.popupImage.insertBefore(this.popupText):this.maindiv.append(this.popupImage)):this.popupImage&&(this.popupImage.remove(),this.popupImage=null)},_setTemplate:function(){var i=this.model.template;"string"==typeof i&&(i=e(i)),this.templateObj="object"==typeof i&&"function"==typeof i.css?i:t.buildTag("div","",{"text-align":"center"}).append(i),this.templateObj.css({visibility:"visible",display:"block"}),this.maindiv.append(this.templateObj)},_setTheme:function(e){this.maindiv.removeClass(this.model.cssClass).addClass(e)},_init:function(){this._initialize(),this._render(),this._wireEvents()},_wireEvents:function(){e(window).on("resize",e.proxy(this._resizeHandler,this))},_unwireEvents:function(){e(window).off("resize",e.proxy(this._resizeHandler,this))},_resizeHandler:function(){this.refresh()},_setModel:function(i){for(var s in i)switch(s){case"text":this._setText(i[s]);break;case"cssClass":this._setTheme(i[s]);break;case"htmlAttributes ":this._addAttr(i[s]);break;case"showOnInit":this._setVisibility(i[s]);break;case"showImage":this._showImage(i[s]),this._setContentPosition();break;case"target":this.model.target=i[s],this._setTarget(),this.refresh();break;case"appendTo":this.model.appendTo=i[s],this._setTarget(),t.isNullOrUndefined(this.model.appendTo)||"document"==this.model.appendTo||"window"==this.model.appendTo?e("body").append(this.maindiv):this.maindiv.appendTo(e(this.model.appendTo)),this.refresh();break;case"template":this.maindiv.empty(),i[s]?(this.model.template=i[s],this._setTemplate()):(this.model.template=i[s]=null,this._showImage(this.model.showImage),this.model.text&&this._generateTextTag(this.model.text)),this._setContentPosition()}},_setTarget:function(){this.targetElement="document"==this.model.target?e(document):"window"==this.model.target?e(window):this.model.target?e(this.model.target):this.element},_destroy:function(){this.maindiv.remove(),this._unwireEvents()},_initialize:function(){this.maindiv=null,this.popupText=null,this.popupImage=null,this.templateObj=null,this.targetElement=null},_render:function(){this._setTarget();var i=e("#"+this.element[0].id+"_WaitingPopup").get(0);i&&e(i).remove(),this.maindiv=t.buildTag("div.e-waitpopup-pane e-widget "+this.model.cssClass+"#"+this.element[0].id+"_WaitingPopup"),this.model.template?this._setTemplate():(this._showImage(this.model.showImage),this.model.text&&this._generateTextTag(this.model.text)),t.isNullOrUndefined(this.model.appendTo)||"document"==this.model.appendTo||"window"==this.model.appendTo?e("body").append(this.maindiv):this.maindiv.appendTo(e(this.model.appendTo)),this._setVisibility(this.model.showOnInit),this._addAttr(this.model.htmlAttributes)},_refreshPanel:function(){this.maindiv.width(this.targetElement.outerWidth()),this.maindiv.height(this.targetElement.outerHeight()),this._setPanelPosition(),this._setContentPosition()},_addAttr:function(t){var i=this;e.map(t,(function(e,t){"class"==t?i.maindiv.addClass(e):i.maindiv.attr(t,e)}))},_setPanelPosition:function(){var i=t.util.getOffset(this.targetElement);null!=this.model.appendTo&&e(this.model.appendTo).length>0&&("relative"!=this.targetElement.css("position")&&"absolute"!=this.targetElement.css("position")||this.targetElement[0]!==e(this.model.appendTo)[0]?(i.left-=this.targetElement.offsetParent().offset().left,i.top-=this.targetElement.offsetParent().offset().top):i={left:0,top:0}),this.maindiv.css({position:"absolute",left:Math.ceil(i.left)+"px",top:Math.ceil(i.top)+"px","z-index":this._maxZindex()+1})},_setContentPosition:function(){if(null==this.model.template){var e,t=0,i=0,s=null;e=this.targetElement.outerHeight(),this.popupText&&(t=this.popupText.outerHeight()),this.popupImage&&(i=this.popupImage.outerHeight()),this.popupImage&&(s=Math.ceil((e-(i+t))/2),this.popupImage.css("top",s+"px")),this.popupText&&(s||(s=Math.ceil((e-t)/2)),this.popupText.css("top",s+"px"))}else this.templateObj.css({position:"relative",left:Math.ceil((this.targetElement.outerWidth()-this.templateObj.outerWidth())/2),top:Math.ceil((this.targetElement.outerHeight()-this.templateObj.outerHeight())/2)})},_generateTextTag:function(e){this.popupText=t.buildTag("div.e-text",e),this.maindiv.append(this.popupText)},_setVisibility:function(e){e&&this._isTargetVisible()?this.show():this.hide()},_maxZindex:function(){return t.util.getZindexPartial(this.element)}})})),function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e(jQuery)}((function(e){e.extend(e.fn,{validate:function(t){if(this.length){var i=e.data(this[0],"validator");return i||(this.attr("novalidate","novalidate"),i=new e.validator(t,this[0]),e.data(this[0],"validator",i),i.settings.onsubmit&&(this.on("click.validate",":submit",(function(t){i.settings.submitHandler&&(i.submitButton=t.target),e(this).hasClass("cancel")&&(i.cancelSubmit=!0),void 0!==e(this).attr("formnovalidate")&&(i.cancelSubmit=!0)})),this.on("submit.validate",(function(t){function s(){var s,n;return!i.settings.submitHandler||(i.submitButton&&(s=e("<input type='hidden'/>").attr("name",i.submitButton.name).val(e(i.submitButton).val()).appendTo(i.currentForm)),n=i.settings.submitHandler.call(i,i.currentForm,t),i.submitButton&&s.remove(),void 0!==n&&n)}return i.settings.debug&&t.preventDefault(),i.cancelSubmit?(i.cancelSubmit=!1,s()):i.form()?i.pendingRequest?(i.formSubmitted=!0,!1):s():(i.focusInvalid(),!1)}))),i)}t&&t.debug&&window.console&&console.warn("Nothing selected, can't validate, returning nothing.")},valid:function(){var t,i,s;return e(this[0]).is("form")?t=this.validate().form():(s=[],t=!0,i=e(this[0].form).validate(),this.each((function(){t=i.element(this)&&t,s=s.concat(i.errorList)})),i.errorList=s),t},rules:function(t,i){var s,n,a,o,r,l,h=this[0];if(t)switch(s=e.data(h.form,"validator").settings,n=s.rules,a=e.validator.staticRules(h),t){case"add":e.extend(a,e.validator.normalizeRule(i)),delete a.messages,n[h.name]=a,i.messages&&(s.messages[h.name]=e.extend(s.messages[h.name],i.messages));break;case"remove":return i?(l={},e.each(i.split(/\s/),(function(t,i){l[i]=a[i],delete a[i],"required"===i&&e(h).removeAttr("aria-required")})),l):(delete n[h.name],a)}return(o=e.validator.normalizeRules(e.extend({},e.validator.classRules(h),e.validator.attributeRules(h),e.validator.dataRules(h),e.validator.staticRules(h)),h)).required&&(r=o.required,delete o.required,o=e.extend({required:r},o),e(h).attr("aria-required","true")),o.remote&&(r=o.remote,delete o.remote,o=e.extend(o,{remote:r})),o}}),e.extend(e.expr[":"],{blank:function(t){return!e.trim(""+e(t).val())},filled:function(t){return!!e.trim(""+e(t).val())},unchecked:function(t){return!e(t).prop("checked")}}),e.validator=function(t,i){this.settings=e.extend(!0,{},e.validator.defaults,t),this.currentForm=i,this.init()},e.validator.format=function(t,i){return 1===arguments.length?function(){var i=e.makeArray(arguments);return i.unshift(t),e.validator.format.apply(this,i)}:(arguments.length>2&&i.constructor!==Array&&(i=e.makeArray(arguments).slice(1)),i.constructor!==Array&&(i=[i]),e.each(i,(function(e,i){t=t.replace(new RegExp("\\{"+e+"\\}","g"),(function(){return i}))})),t)},e.extend(e.validator,{defaults:{messages:{},groups:{},rules:{},errorClass:"error",validClass:"valid",errorElement:"label",focusCleanup:!1,focusInvalid:!0,errorContainer:e([]),errorLabelContainer:e([]),onsubmit:!0,ignore:":hidden",ignoreTitle:!1,onfocusin:function(e){this.lastActive=e,this.settings.focusCleanup&&(this.settings.unhighlight&&this.settings.unhighlight.call(this,e,this.settings.errorClass,this.settings.validClass),this.hideThese(this.errorsFor(e)))},onfocusout:function(e){this.checkable(e)||!(e.name in this.submitted)&&this.optional(e)||this.element(e)},onkeyup:function(t,i){9===i.which&&""===this.elementValue(t)||-1!==e.inArray(i.keyCode,[16,17,18,20,35,36,37,38,39,40,45,144,225])||(t.name in this.submitted||t===this.lastElement)&&this.element(t)},onclick:function(e){e.name in this.submitted?this.element(e):e.parentNode.name in this.submitted&&this.element(e.parentNode)},highlight:function(t,i,s){"radio"===t.type?this.findByName(t.name).addClass(i).removeClass(s):e(t).addClass(i).removeClass(s)},unhighlight:function(t,i,s){"radio"===t.type?this.findByName(t.name).removeClass(i).addClass(s):e(t).removeClass(i).addClass(s)}},setDefaults:function(t){e.extend(e.validator.defaults,t)},messages:{required:"This field is required.",remote:"Please fix this field.",email:"Please enter a valid email address.",url:"Please enter a valid URL.",date:"Please enter a valid date.",dateISO:"Please enter a valid date ( ISO ).",number:"Please enter a valid number.",digits:"Please enter only digits.",creditcard:"Please enter a valid credit card number.",equalTo:"Please enter the same value again.",maxlength:e.validator.format("Please enter no more than {0} characters."),minlength:e.validator.format("Please enter at least {0} characters."),rangelength:e.validator.format("Please enter a value between {0} and {1} characters long."),range:e.validator.format("Please enter a value between {0} and {1}."),max:e.validator.format("Please enter a value less than or equal to {0}."),min:e.validator.format("Please enter a value greater than or equal to {0}.")},autoCreateRanges:!1,prototype:{init:function(){function t(t){var i=e.data(this.form,"validator"),s="on"+t.type.replace(/^validate/,""),n=i.settings;n[s]&&!e(this).is(n.ignore)&&n[s].call(i,this,t)}this.labelContainer=e(this.settings.errorLabelContainer),this.errorContext=this.labelContainer.length&&this.labelContainer||e(this.currentForm),this.containers=e(this.settings.errorContainer).add(this.settings.errorLabelContainer),this.submitted={},this.valueCache={},this.pendingRequest=0,this.pending={},this.invalid={},this.reset();var i,s=this.groups={};e.each(this.settings.groups,(function(t,i){"string"==typeof i&&(i=i.split(/\s/)),e.each(i,(function(e,i){s[i]=t}))})),i=this.settings.rules,e.each(i,(function(t,s){i[t]=e.validator.normalizeRule(s)})),e(this.currentForm).on("focusin.validate focusout.validate keyup.validate",":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'], [type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox']",t).on("click.validate","select, option, [type='radio'], [type='checkbox']",t),this.settings.invalidHandler&&e(this.currentForm).on("invalid-form.validate",this.settings.invalidHandler),e(this.currentForm).find("[required], [data-rule-required], .required").attr("aria-required","true")},form:function(){return this.checkForm(),e.extend(this.submitted,this.errorMap),this.invalid=e.extend({},this.errorMap),this.valid()||e(this.currentForm).triggerHandler("invalid-form",[this]),this.showErrors(),this.valid()},checkForm:function(){this.prepareForm();for(var e=0,t=this.currentElements=this.elements();t[e];e++)this.check(t[e]);return this.valid()},element:function(t){var i=this.clean(t),s=this.validationTargetFor(i),n=!0;return this.lastElement=s,void 0===s?delete this.invalid[i.name]:(this.prepareElement(s),this.currentElements=e(s),(n=!1!==this.check(s))?delete this.invalid[s.name]:this.invalid[s.name]=!0),e(t).attr("aria-invalid",!n),this.numberOfInvalids()||(this.toHide=this.toHide.add(this.containers)),this.showErrors(),n},showErrors:function(t){if(t){for(var i in e.extend(this.errorMap,t),this.errorList=[],t)this.errorList.push({message:t[i],element:this.findByName(i)[0]});this.successList=e.grep(this.successList,(function(e){return!(e.name in t)}))}this.settings.showErrors?this.settings.showErrors.call(this,this.errorMap,this.errorList):this.defaultShowErrors()},resetForm:function(){e.fn.resetForm&&e(this.currentForm).resetForm(),this.submitted={},this.lastElement=null,this.prepareForm(),this.hideErrors();var t,i=this.elements().removeData("previousValue").removeAttr("aria-invalid");if(this.settings.unhighlight)for(t=0;i[t];t++)this.settings.unhighlight.call(this,i[t],this.settings.errorClass,"");else i.removeClass(this.settings.errorClass)},numberOfInvalids:function(){return this.objectLength(this.invalid)},objectLength:function(e){var t,i=0;for(t in e)i++;return i},hideErrors:function(){this.hideThese(this.toHide)},hideThese:function(e){e.not(this.containers).text(""),this.addWrapper(e).hide()},valid:function(){return 0===this.size()},size:function(){return this.errorList.length},focusInvalid:function(){if(this.settings.focusInvalid)try{e(this.findLastActive()||this.errorList.length&&this.errorList[0].element||[]).filter(":visible").focus().trigger("focusin")}catch(e){}},findLastActive:function(){var t=this.lastActive;return t&&1===e.grep(this.errorList,(function(e){return e.element.name===t.name})).length&&t},elements:function(){var t=this,i={};return e(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter((function(){return!this.name&&t.settings.debug&&window.console&&console.error("%o has no name assigned",this),!(this.name in i||!t.objectLength(e(this).rules()))&&(i[this.name]=!0,!0)}))},clean:function(t){return e(t)[0]},errors:function(){var t=this.settings.errorClass.split(" ").join(".");return e(this.settings.errorElement+"."+t,this.errorContext)},reset:function(){this.successList=[],this.errorList=[],this.errorMap={},this.toShow=e([]),this.toHide=e([]),this.currentElements=e([])},prepareForm:function(){this.reset(),this.toHide=this.errors().add(this.containers)},prepareElement:function(e){this.reset(),this.toHide=this.errorsFor(e)},elementValue:function(t){var i,s=e(t),n=t.type;return"radio"===n||"checkbox"===n?this.findByName(t.name).filter(":checked").val():"number"===n&&void 0!==t.validity?!t.validity.badInput&&s.val():"string"==typeof(i=s.val())?i.replace(/\r/g,""):i},check:function(t){t=this.validationTargetFor(this.clean(t));var i,s,n,a=e(t).rules(),o=e.map(a,(function(e,t){return t})).length,r=!1,l=this.elementValue(t);for(s in a){n={method:s,parameters:a[s]};try{if("dependency-mismatch"===(i=e.validator.methods[s].call(this,l,t,n.parameters))&&1===o){r=!0;continue}if(r=!1,"pending"===i)return void(this.toHide=this.toHide.not(this.errorsFor(t)));if(!i)return this.formatAndAdd(t,n),!1}catch(e){throw this.settings.debug&&window.console&&console.log("Exception occurred when checking element "+t.id+", check the '"+n.method+"' method.",e),e instanceof TypeError&&(e.message+=".  Exception occurred when checking element "+t.id+", check the '"+n.method+"' method."),e}}if(!r)return this.objectLength(a)&&this.successList.push(t),!0},customDataMessage:function(t,i){return e(t).data("msg"+i.charAt(0).toUpperCase()+i.substring(1).toLowerCase())||e(t).data("msg")},customMessage:function(e,t){var i=this.settings.messages[e];return i&&(i.constructor===String?i:i[t])},findDefined:function(){for(var e=0;e<arguments.length;e++)if(void 0!==arguments[e])return arguments[e]},defaultMessage:function(t,i){return this.findDefined(this.customMessage(t.name,i),this.customDataMessage(t,i),!this.settings.ignoreTitle&&t.title||void 0,e.validator.messages[i],"<strong>Warning: No message defined for "+t.name+"</strong>")},formatAndAdd:function(t,i){var s=this.defaultMessage(t,i.method),n=/\$?\{(\d+)\}/g;"function"==typeof s?s=s.call(this,i.parameters,t):n.test(s)&&(s=e.validator.format(s.replace(n,"{$1}"),i.parameters)),this.errorList.push({message:s,element:t,method:i.method}),this.errorMap[t.name]=s,this.submitted[t.name]=s},addWrapper:function(e){return this.settings.wrapper&&(e=e.add(e.parent(this.settings.wrapper))),e},defaultShowErrors:function(){var e,t,i;for(e=0;this.errorList[e];e++)i=this.errorList[e],this.settings.highlight&&this.settings.highlight.call(this,i.element,this.settings.errorClass,this.settings.validClass),this.showLabel(i.element,i.message);if(this.errorList.length&&(this.toShow=this.toShow.add(this.containers)),this.settings.success)for(e=0;this.successList[e];e++)this.showLabel(this.successList[e]);if(this.settings.unhighlight)for(e=0,t=this.validElements();t[e];e++)this.settings.unhighlight.call(this,t[e],this.settings.errorClass,this.settings.validClass);this.toHide=this.toHide.not(this.toShow),this.hideErrors(),this.addWrapper(this.toShow).show()},validElements:function(){return this.currentElements.not(this.invalidElements())},invalidElements:function(){return e(this.errorList).map((function(){return this.element}))},showLabel:function(t,i){var s,n,a,o=this.errorsFor(t),r=this.idOrName(t),l=e(t).attr("aria-describedby");o.length?(o.removeClass(this.settings.validClass).addClass(this.settings.errorClass),o.html(i)):(s=o=e("<"+this.settings.errorElement+">").attr("id",r+"-error").addClass(this.settings.errorClass).html(i||""),this.settings.wrapper&&(s=o.hide().show().wrap("<"+this.settings.wrapper+"/>").parent()),this.labelContainer.length?this.labelContainer.append(s):this.settings.errorPlacement?this.settings.errorPlacement(s,e(t)):s.insertAfter(t),o.is("label")?o.attr("for",r):0===o.parents("label[for='"+r+"']").length&&(a=o.attr("id").replace(/(:|\.|\[|\]|\$)/g,"\\$1"),l?l.match(new RegExp("\\b"+a+"\\b"))||(l+=" "+a):l=a,e(t).attr("aria-describedby",l),(n=this.groups[t.name])&&e.each(this.groups,(function(t,i){i===n&&e("[name='"+t+"']",this.currentForm).attr("aria-describedby",o.attr("id"))})))),!i&&this.settings.success&&(o.text(""),"string"==typeof this.settings.success?o.addClass(this.settings.success):this.settings.success(o,t)),this.toShow=this.toShow.add(o)},errorsFor:function(t){var i=this.idOrName(t),s=e(t).attr("aria-describedby"),n="label[for='"+i+"'], label[for='"+i+"'] *";return s&&(n=n+", #"+s.replace(/\s+/g,", #")),this.errors().filter(n)},idOrName:function(e){return this.groups[e.name]||(this.checkable(e)?e.name:e.id||e.name)},validationTargetFor:function(t){return this.checkable(t)&&(t=this.findByName(t.name)),e(t).not(this.settings.ignore)[0]},checkable:function(e){return/radio|checkbox/i.test(e.type)},findByName:function(t){return e(this.currentForm).find("[name='"+t+"']")},getLength:function(t,i){switch(i.nodeName.toLowerCase()){case"select":return e("option:selected",i).length;case"input":if(this.checkable(i))return this.findByName(i.name).filter(":checked").length}return t.length},depend:function(e,t){return!this.dependTypes[typeof e]||this.dependTypes[typeof e](e,t)},dependTypes:{boolean:function(e){return e},string:function(t,i){return!!e(t,i.form).length},function:function(e,t){return e(t)}},optional:function(t){var i=this.elementValue(t);return!e.validator.methods.required.call(this,i,t)&&"dependency-mismatch"},startRequest:function(e){this.pending[e.name]||(this.pendingRequest++,this.pending[e.name]=!0)},stopRequest:function(t,i){this.pendingRequest--,this.pendingRequest<0&&(this.pendingRequest=0),delete this.pending[t.name],i&&0===this.pendingRequest&&this.formSubmitted&&this.form()?(e(this.currentForm).submit(),this.formSubmitted=!1):!i&&0===this.pendingRequest&&this.formSubmitted&&(e(this.currentForm).triggerHandler("invalid-form",[this]),this.formSubmitted=!1)},previousValue:function(t){return e.data(t,"previousValue")||e.data(t,"previousValue",{old:null,valid:!0,message:this.defaultMessage(t,"remote")})},destroy:function(){this.resetForm(),e(this.currentForm).off(".validate").removeData("validator")}},classRuleSettings:{required:{required:!0},email:{email:!0},url:{url:!0},date:{date:!0},dateISO:{dateISO:!0},number:{number:!0},digits:{digits:!0},creditcard:{creditcard:!0}},addClassRules:function(t,i){t.constructor===String?this.classRuleSettings[t]=i:e.extend(this.classRuleSettings,t)},classRules:function(t){var i={},s=e(t).attr("class");return s&&e.each(s.split(" "),(function(){this in e.validator.classRuleSettings&&e.extend(i,e.validator.classRuleSettings[this])})),i},normalizeAttributeRule:function(e,t,i,s){/min|max/.test(i)&&(null===t||/number|range|text/.test(t))&&(s=Number(s),isNaN(s)&&(s=void 0)),s||0===s?e[i]=s:t===i&&"range"!==t&&(e[i]=!0)},attributeRules:function(t){var i,s,n={},a=e(t),o=t.getAttribute("type");for(i in e.validator.methods)"required"===i?(""===(s=t.getAttribute(i))&&(s=!0),s=!!s):s=a.attr(i),this.normalizeAttributeRule(n,o,i,s);return n.maxlength&&/-1|2147483647|524288/.test(n.maxlength)&&delete n.maxlength,n},dataRules:function(t){var i,s,n={},a=e(t),o=t.getAttribute("type");for(i in e.validator.methods)s=a.data("rule"+i.charAt(0).toUpperCase()+i.substring(1).toLowerCase()),this.normalizeAttributeRule(n,o,i,s);return n},staticRules:function(t){var i={},s=e.data(t.form,"validator");return s.settings.rules&&(i=e.validator.normalizeRule(s.settings.rules[t.name])||{}),i},normalizeRules:function(t,i){return e.each(t,(function(s,n){if(!1!==n){if(n.param||n.depends){var a=!0;switch(typeof n.depends){case"string":a=!!e(n.depends,i.form).length;break;case"function":a=n.depends.call(i,i)}a?t[s]=void 0===n.param||n.param:delete t[s]}}else delete t[s]})),e.each(t,(function(s,n){t[s]=e.isFunction(n)?n(i):n})),e.each(["minlength","maxlength"],(function(){t[this]&&(t[this]=Number(t[this]))})),e.each(["rangelength","range"],(function(){var i;t[this]&&(e.isArray(t[this])?t[this]=[Number(t[this][0]),Number(t[this][1])]:"string"==typeof t[this]&&(i=t[this].replace(/[\[\]]/g,"").split(/[\s,]+/),t[this]=[Number(i[0]),Number(i[1])]))})),e.validator.autoCreateRanges&&(null!=t.min&&null!=t.max&&(t.range=[t.min,t.max],delete t.min,delete t.max),null!=t.minlength&&null!=t.maxlength&&(t.rangelength=[t.minlength,t.maxlength],delete t.minlength,delete t.maxlength)),t},normalizeRule:function(t){if("string"==typeof t){var i={};e.each(t.split(/\s/),(function(){i[this]=!0})),t=i}return t},addMethod:function(t,i,s){e.validator.methods[t]=i,e.validator.messages[t]=void 0!==s?s:e.validator.messages[t],i.length<3&&e.validator.addClassRules(t,e.validator.normalizeRule(t))},methods:{required:function(t,i,s){if(!this.depend(s,i))return"dependency-mismatch";if("select"===i.nodeName.toLowerCase()){var n=e(i).val();return n&&n.length>0}return this.checkable(i)?this.getLength(t,i)>0:t.length>0},email:function(e,t){return this.optional(t)||/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(e)},url:function(e,t){return this.optional(t)||/^(?:(?:(?:https?|ftp):)?\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,})).?)(?::\d{2,5})?(?:[/?#]\S*)?$/i.test(e)},date:function(e,t){return this.optional(t)||!/Invalid|NaN/.test(new Date(e).toString())},dateISO:function(e,t){return this.optional(t)||/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/.test(e)},number:function(e,t){return this.optional(t)||/^(?:-?\d+|-?\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(e)},digits:function(e,t){return this.optional(t)||/^\d+$/.test(e)},creditcard:function(e,t){if(this.optional(t))return"dependency-mismatch";if(/[^0-9 \-]+/.test(e))return!1;var i,s,n=0,a=0,o=!1;if((e=e.replace(/\D/g,"")).length<13||e.length>19)return!1;for(i=e.length-1;i>=0;i--)s=e.charAt(i),a=parseInt(s,10),o&&(a*=2)>9&&(a-=9),n+=a,o=!o;return n%10==0},minlength:function(t,i,s){var n=e.isArray(t)?t.length:this.getLength(t,i);return this.optional(i)||n>=s},maxlength:function(t,i,s){var n=e.isArray(t)?t.length:this.getLength(t,i);return this.optional(i)||s>=n},rangelength:function(t,i,s){var n=e.isArray(t)?t.length:this.getLength(t,i);return this.optional(i)||n>=s[0]&&n<=s[1]},min:function(e,t,i){return this.optional(t)||e>=i},max:function(e,t,i){return this.optional(t)||i>=e},range:function(e,t,i){return this.optional(t)||e>=i[0]&&e<=i[1]},equalTo:function(t,i,s){var n=e(s);return this.settings.onfocusout&&n.off(".validate-equalTo").on("blur.validate-equalTo",(function(){e(i).valid()})),t===n.val()},remote:function(t,i,s){if(this.optional(i))return"dependency-mismatch";var n,a,o=this.previousValue(i);return this.settings.messages[i.name]||(this.settings.messages[i.name]={}),o.originalMessage=this.settings.messages[i.name].remote,this.settings.messages[i.name].remote=o.message,s="string"==typeof s&&{url:s}||s,o.old===t?o.valid:(o.old=t,n=this,this.startRequest(i),(a={})[i.name]=t,e.ajax(e.extend(!0,{mode:"abort",port:"validate"+i.name,dataType:"json",data:a,context:n.currentForm,success:function(s){var a,r,l,h=!0===s||"true"===s;n.settings.messages[i.name].remote=o.originalMessage,h?(l=n.formSubmitted,n.prepareElement(i),n.formSubmitted=l,n.successList.push(i),delete n.invalid[i.name],n.showErrors()):(a={},r=s||n.defaultMessage(i,"remote"),a[i.name]=o.message=e.isFunction(r)?r(t):r,n.invalid[i.name]=!0,n.showErrors(a)),o.valid=h,n.stopRequest(i,h)}},s)),"pending")}}});var t,i={};e.ajaxPrefilter?e.ajaxPrefilter((function(e,t,s){var n=e.port;"abort"===e.mode&&(i[n]&&i[n].abort(),i[n]=s)})):(t=e.ajax,e.ajax=function(s){var n=("mode"in s?s:e.ajaxSettings).mode,a=("port"in s?s:e.ajaxSettings).port;return"abort"===n?(i[a]&&i[a].abort(),i[a]=t.apply(this,arguments),i[a]):t.apply(this,arguments)})})),jQuery.easing.jswing=jQuery.easing.swing,jQuery.extend(jQuery.easing,{def:"easeOutQuad",swing:function(e,t,i,s,n){return jQuery.easing[jQuery.easing.def](e,t,i,s,n)},easeInQuad:function(e,t,i,s,n){return s*(t/=n)*t+i},easeOutQuad:function(e,t,i,s,n){return-s*(t/=n)*(t-2)+i},easeInOutQuad:function(e,t,i,s,n){return(t/=n/2)<1?s/2*t*t+i:-s/2*(--t*(t-2)-1)+i},easeInCubic:function(e,t,i,s,n){return s*(t/=n)*t*t+i},easeOutCubic:function(e,t,i,s,n){return s*((t=t/n-1)*t*t+1)+i},easeInOutCubic:function(e,t,i,s,n){return(t/=n/2)<1?s/2*t*t*t+i:s/2*((t-=2)*t*t+2)+i},easeInQuart:function(e,t,i,s,n){return s*(t/=n)*t*t*t+i},easeOutQuart:function(e,t,i,s,n){return-s*((t=t/n-1)*t*t*t-1)+i},easeInOutQuart:function(e,t,i,s,n){return(t/=n/2)<1?s/2*t*t*t*t+i:-s/2*((t-=2)*t*t*t-2)+i},easeInQuint:function(e,t,i,s,n){return s*(t/=n)*t*t*t*t+i},easeOutQuint:function(e,t,i,s,n){return s*((t=t/n-1)*t*t*t*t+1)+i},easeInOutQuint:function(e,t,i,s,n){return(t/=n/2)<1?s/2*t*t*t*t*t+i:s/2*((t-=2)*t*t*t*t+2)+i},easeInSine:function(e,t,i,s,n){return-s*Math.cos(t/n*(Math.PI/2))+s+i},easeOutSine:function(e,t,i,s,n){return s*Math.sin(t/n*(Math.PI/2))+i},easeInOutSine:function(e,t,i,s,n){return-s/2*(Math.cos(Math.PI*t/n)-1)+i},easeInExpo:function(e,t,i,s,n){return 0==t?i:s*Math.pow(2,10*(t/n-1))+i},easeOutExpo:function(e,t,i,s,n){return t==n?i+s:s*(1-Math.pow(2,-10*t/n))+i},easeInOutExpo:function(e,t,i,s,n){return 0==t?i:t==n?i+s:(t/=n/2)<1?s/2*Math.pow(2,10*(t-1))+i:s/2*(2-Math.pow(2,-10*--t))+i},easeInCirc:function(e,t,i,s,n){return-s*(Math.sqrt(1-(t/=n)*t)-1)+i},easeOutCirc:function(e,t,i,s,n){return s*Math.sqrt(1-(t=t/n-1)*t)+i},easeInOutCirc:function(e,t,i,s,n){return(t/=n/2)<1?-s/2*(Math.sqrt(1-t*t)-1)+i:s/2*(Math.sqrt(1-(t-=2)*t)+1)+i},easeInElastic:function(e,t,i,s,n){e=1.70158;var a=0,o=s;return 0==t?i:1==(t/=n)?i+s:(a||(a=.3*n),o<Math.abs(s)?(o=s,e=a/4):e=a/(2*Math.PI)*Math.asin(s/o),-o*Math.pow(2,10*(t-=1))*Math.sin(2*(t*n-e)*Math.PI/a)+i)},easeOutElastic:function(e,t,i,s,n){e=1.70158;var a=0,o=s;return 0==t?i:1==(t/=n)?i+s:(a||(a=.3*n),o<Math.abs(s)?(o=s,e=a/4):e=a/(2*Math.PI)*Math.asin(s/o),o*Math.pow(2,-10*t)*Math.sin(2*(t*n-e)*Math.PI/a)+s+i)},easeInOutElastic:function(e,t,i,s,n){e=1.70158;var a=0,o=s;return 0==t?i:2==(t/=n/2)?i+s:(a||(a=.3*n*1.5),o<Math.abs(s)?(o=s,e=a/4):e=a/(2*Math.PI)*Math.asin(s/o),t<1?-.5*o*Math.pow(2,10*(t-=1))*Math.sin(2*(t*n-e)*Math.PI/a)+i:o*Math.pow(2,-10*(t-=1))*Math.sin(2*(t*n-e)*Math.PI/a)*.5+s+i)},easeInBack:function(e,t,i,s,n,a){return null==a&&(a=1.70158),s*(t/=n)*t*((a+1)*t-a)+i},easeOutBack:function(e,t,i,s,n,a){return null==a&&(a=1.70158),s*((t=t/n-1)*t*((a+1)*t+a)+1)+i},easeInOutBack:function(e,t,i,s,n,a){return null==a&&(a=1.70158),(t/=n/2)<1?s/2*t*t*((1+(a*=1.525))*t-a)+i:s/2*((t-=2)*t*((1+(a*=1.525))*t+a)+2)+i},easeInBounce:function(e,t,i,s,n){return s-jQuery.easing.easeOutBounce(e,n-t,0,s,n)+i},easeOutBounce:function(e,t,i,s,n){return(t/=n)<1/2.75?7.5625*s*t*t+i:t<2/2.75?s*(7.5625*(t-=1.5/2.75)*t+.75)+i:t<2.5/2.75?s*(7.5625*(t-=2.25/2.75)*t+.9375)+i:s*(7.5625*(t-=2.625/2.75)*t+.984375)+i},easeInOutBounce:function(e,t,i,s,n){return t<n/2?.5*jQuery.easing.easeInBounce(e,2*t,0,s,n)+i:.5*jQuery.easing.easeOutBounce(e,2*t-n,0,s,n)+.5*s+i}}),function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):(e="undefined"!=typeof globalThis?globalThis:e||self).bootstrap=t()}(this,(function(){"use strict";const e=new Map,t={set(t,i,s){e.has(t)||e.set(t,new Map);const n=e.get(t);n.has(i)||0===n.size?n.set(i,s):console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(n.keys())[0]}.`)},get:(t,i)=>e.has(t)&&e.get(t).get(i)||null,remove(t,i){if(!e.has(t))return;const s=e.get(t);s.delete(i),0===s.size&&e.delete(t)}},i="transitionend",s=e=>(e&&window.CSS&&window.CSS.escape&&(e=e.replace(/#([^\s"#']+)/g,((e,t)=>`#${CSS.escape(t)}`))),e),n=e=>{e.dispatchEvent(new Event(i))},a=e=>!(!e||"object"!=typeof e)&&(void 0!==e.jquery&&(e=e[0]),void 0!==e.nodeType),o=e=>a(e)?e.jquery?e[0]:e:"string"==typeof e&&e.length>0?document.querySelector(s(e)):null,r=e=>{if(!a(e)||0===e.getClientRects().length)return!1;const t="visible"===getComputedStyle(e).getPropertyValue("visibility"),i=e.closest("details:not([open])");if(!i)return t;if(i!==e){const t=e.closest("summary");if(t&&t.parentNode!==i)return!1;if(null===t)return!1}return t},l=e=>!e||e.nodeType!==Node.ELEMENT_NODE||!!e.classList.contains("disabled")||(void 0!==e.disabled?e.disabled:e.hasAttribute("disabled")&&"false"!==e.getAttribute("disabled")),h=e=>{if(!document.documentElement.attachShadow)return null;if("function"==typeof e.getRootNode){const t=e.getRootNode();return t instanceof ShadowRoot?t:null}return e instanceof ShadowRoot?e:e.parentNode?h(e.parentNode):null},d=()=>{},c=e=>{e.offsetHeight},u=()=>window.jQuery&&!document.body.hasAttribute("data-bs-no-jquery")?window.jQuery:null,m=[],p=()=>"rtl"===document.documentElement.dir,f=e=>{var t;t=()=>{const t=u();if(t){const i=e.NAME,s=t.fn[i];t.fn[i]=e.jQueryInterface,t.fn[i].Constructor=e,t.fn[i].noConflict=()=>(t.fn[i]=s,e.jQueryInterface)}},"loading"===document.readyState?(m.length||document.addEventListener("DOMContentLoaded",(()=>{for(const e of m)e()})),m.push(t)):t()},_=(e,t=[],i=e)=>"function"==typeof e?e(...t):i,g=(e,t,s=!0)=>{if(!s)return void _(e);const a=(e=>{if(!e)return 0;let{transitionDuration:t,transitionDelay:i}=window.getComputedStyle(e);const s=Number.parseFloat(t),n=Number.parseFloat(i);return s||n?(t=t.split(",")[0],i=i.split(",")[0],1e3*(Number.parseFloat(t)+Number.parseFloat(i))):0})(t)+5;let o=!1;const r=({target:s})=>{s===t&&(o=!0,t.removeEventListener(i,r),_(e))};t.addEventListener(i,r),setTimeout((()=>{o||n(t)}),a)},v=(e,t,i,s)=>{const n=e.length;let a=e.indexOf(t);return-1===a?!i&&s?e[n-1]:e[0]:(a+=i?1:-1,s&&(a=(a+n)%n),e[Math.max(0,Math.min(a,n-1))])},b=/[^.]*(?=\..*)\.|.*/,y=/\..*/,w=/::\d+$/,x={};let D=1;const C={mouseenter:"mouseover",mouseleave:"mouseout"},T=new Set(["click","dblclick","mouseup","mousedown","contextmenu","mousewheel","DOMMouseScroll","mouseover","mouseout","mousemove","selectstart","selectend","keydown","keypress","keyup","orientationchange","touchstart","touchmove","touchend","touchcancel","pointerdown","pointermove","pointerup","pointerleave","pointercancel","gesturestart","gesturechange","gestureend","focus","blur","change","reset","select","submit","focusin","focusout","load","unload","beforeunload","resize","move","DOMContentLoaded","readystatechange","error","abort","scroll"]);function k(e,t){return t&&`${t}::${D++}`||e.uidEvent||D++}function S(e){const t=k(e);return e.uidEvent=t,x[t]=x[t]||{},x[t]}function O(e,t,i=null){return Object.values(e).find((e=>e.callable===t&&e.delegationSelector===i))}function I(e,t,i){const s="string"==typeof t,n=s?i:t||i;let a=L(e);return T.has(a)||(a=e),[s,n,a]}function M(e,t,i,s,n){if("string"!=typeof t||!e)return;let[a,o,r]=I(t,i,s);if(t in C){const e=e=>function(t){if(!t.relatedTarget||t.relatedTarget!==t.delegateTarget&&!t.delegateTarget.contains(t.relatedTarget))return e.call(this,t)};o=e(o)}const l=S(e),h=l[r]||(l[r]={}),d=O(h,o,a?i:null);if(d)return void(d.oneOff=d.oneOff&&n);const c=k(o,t.replace(b,"")),u=a?function(e,t,i){return function s(n){const a=e.querySelectorAll(t);for(let{target:o}=n;o&&o!==this;o=o.parentNode)for(const r of a)if(r===o)return A(n,{delegateTarget:o}),s.oneOff&&N.off(e,n.type,t,i),i.apply(o,[n])}}(e,i,o):function(e,t){return function i(s){return A(s,{delegateTarget:e}),i.oneOff&&N.off(e,s.type,t),t.apply(e,[s])}}(e,o);u.delegationSelector=a?i:null,u.callable=o,u.oneOff=n,u.uidEvent=c,h[c]=u,e.addEventListener(r,u,a)}function E(e,t,i,s,n){const a=O(t[i],s,n);a&&(e.removeEventListener(i,a,Boolean(n)),delete t[i][a.uidEvent])}function P(e,t,i,s){const n=t[i]||{};for(const[a,o]of Object.entries(n))a.includes(s)&&E(e,t,i,o.callable,o.delegationSelector)}function L(e){return e=e.replace(y,""),C[e]||e}const N={on(e,t,i,s){M(e,t,i,s,!1)},one(e,t,i,s){M(e,t,i,s,!0)},off(e,t,i,s){if("string"!=typeof t||!e)return;const[n,a,o]=I(t,i,s),r=o!==t,l=S(e),h=l[o]||{},d=t.startsWith(".");if(void 0===a){if(d)for(const i of Object.keys(l))P(e,l,i,t.slice(1));for(const[i,s]of Object.entries(h)){const n=i.replace(w,"");r&&!t.includes(n)||E(e,l,o,s.callable,s.delegationSelector)}}else{if(!Object.keys(h).length)return;E(e,l,o,a,n?i:null)}},trigger(e,t,i){if("string"!=typeof t||!e)return null;const s=u();let n=null,a=!0,o=!0,r=!1;t!==L(t)&&s&&(n=s.Event(t,i),s(e).trigger(n),a=!n.isPropagationStopped(),o=!n.isImmediatePropagationStopped(),r=n.isDefaultPrevented());const l=A(new Event(t,{bubbles:a,cancelable:!0}),i);return r&&l.preventDefault(),o&&e.dispatchEvent(l),l.defaultPrevented&&n&&n.preventDefault(),l}};function A(e,t={}){for(const[i,s]of Object.entries(t))try{e[i]=s}catch(t){Object.defineProperty(e,i,{configurable:!0,get:()=>s})}return e}function z(e){if("true"===e)return!0;if("false"===e)return!1;if(e===Number(e).toString())return Number(e);if(""===e||"null"===e)return null;if("string"!=typeof e)return e;try{return JSON.parse(decodeURIComponent(e))}catch(t){return e}}function H(e){return e.replace(/[A-Z]/g,(e=>`-${e.toLowerCase()}`))}const j={setDataAttribute(e,t,i){e.setAttribute(`data-bs-${H(t)}`,i)},removeDataAttribute(e,t){e.removeAttribute(`data-bs-${H(t)}`)},getDataAttributes(e){if(!e)return{};const t={},i=Object.keys(e.dataset).filter((e=>e.startsWith("bs")&&!e.startsWith("bsConfig")));for(const s of i){let i=s.replace(/^bs/,"");i=i.charAt(0).toLowerCase()+i.slice(1,i.length),t[i]=z(e.dataset[s])}return t},getDataAttribute:(e,t)=>z(e.getAttribute(`data-bs-${H(t)}`))};class F{static get Default(){return{}}static get DefaultType(){return{}}static get NAME(){throw new Error('You have to implement the static method "NAME", for each component!')}_getConfig(e){return e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e}_mergeConfigObj(e,t){const i=a(t)?j.getDataAttribute(t,"config"):{};return{...this.constructor.Default,..."object"==typeof i?i:{},...a(t)?j.getDataAttributes(t):{},..."object"==typeof e?e:{}}}_typeCheckConfig(e,t=this.constructor.DefaultType){for(const[s,n]of Object.entries(t)){const t=e[s],o=a(t)?"element":null==(i=t)?`${i}`:Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase();if(!new RegExp(n).test(o))throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${s}" provided type "${o}" but expected type "${n}".`)}var i}}class V extends F{constructor(e,i){super(),(e=o(e))&&(this._element=e,this._config=this._getConfig(i),t.set(this._element,this.constructor.DATA_KEY,this))}dispose(){t.remove(this._element,this.constructor.DATA_KEY),N.off(this._element,this.constructor.EVENT_KEY);for(const e of Object.getOwnPropertyNames(this))this[e]=null}_queueCallback(e,t,i=!0){g(e,t,i)}_getConfig(e){return e=this._mergeConfigObj(e,this._element),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}static getInstance(e){return t.get(o(e),this.DATA_KEY)}static getOrCreateInstance(e,t={}){return this.getInstance(e)||new this(e,"object"==typeof t?t:null)}static get VERSION(){return"5.3.3"}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(e){return`${e}${this.EVENT_KEY}`}}const R=e=>{let t=e.getAttribute("data-bs-target");if(!t||"#"===t){let i=e.getAttribute("href");if(!i||!i.includes("#")&&!i.startsWith("."))return null;i.includes("#")&&!i.startsWith("#")&&(i=`#${i.split("#")[1]}`),t=i&&"#"!==i?i.trim():null}return t?t.split(",").map((e=>s(e))).join(","):null},$={find:(e,t=document.documentElement)=>[].concat(...Element.prototype.querySelectorAll.call(t,e)),findOne:(e,t=document.documentElement)=>Element.prototype.querySelector.call(t,e),children:(e,t)=>[].concat(...e.children).filter((e=>e.matches(t))),parents(e,t){const i=[];let s=e.parentNode.closest(t);for(;s;)i.push(s),s=s.parentNode.closest(t);return i},prev(e,t){let i=e.previousElementSibling;for(;i;){if(i.matches(t))return[i];i=i.previousElementSibling}return[]},next(e,t){let i=e.nextElementSibling;for(;i;){if(i.matches(t))return[i];i=i.nextElementSibling}return[]},focusableChildren(e){const t=["a","button","input","textarea","select","details","[tabindex]",'[contenteditable="true"]'].map((e=>`${e}:not([tabindex^="-"])`)).join(",");return this.find(t,e).filter((e=>!l(e)&&r(e)))},getSelectorFromElement(e){const t=R(e);return t&&$.findOne(t)?t:null},getElementFromSelector(e){const t=R(e);return t?$.findOne(t):null},getMultipleElementsFromSelector(e){const t=R(e);return t?$.find(t):[]}},W=(e,t="hide")=>{const i=`click.dismiss${e.EVENT_KEY}`,s=e.NAME;N.on(document,i,`[data-bs-dismiss="${s}"]`,(function(i){if(["A","AREA"].includes(this.tagName)&&i.preventDefault(),l(this))return;const n=$.getElementFromSelector(this)||this.closest(`.${s}`);e.getOrCreateInstance(n)[t]()}))},U=".bs.alert",Y=`close${U}`,B=`closed${U}`;class G extends V{static get NAME(){return"alert"}close(){if(N.trigger(this._element,Y).defaultPrevented)return;this._element.classList.remove("show");const e=this._element.classList.contains("fade");this._queueCallback((()=>this._destroyElement()),this._element,e)}_destroyElement(){this._element.remove(),N.trigger(this._element,B),this.dispose()}static jQueryInterface(e){return this.each((function(){const t=G.getOrCreateInstance(this);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}W(G,"close"),f(G);const K='[data-bs-toggle="button"]';class X extends V{static get NAME(){return"button"}toggle(){this._element.setAttribute("aria-pressed",this._element.classList.toggle("active"))}static jQueryInterface(e){return this.each((function(){const t=X.getOrCreateInstance(this);"toggle"===e&&t[e]()}))}}N.on(document,"click.bs.button.data-api",K,(e=>{e.preventDefault();const t=e.target.closest(K);X.getOrCreateInstance(t).toggle()})),f(X);const q=".bs.swipe",Z=`touchstart${q}`,Q=`touchmove${q}`,J=`touchend${q}`,ee=`pointerdown${q}`,te=`pointerup${q}`,ie={endCallback:null,leftCallback:null,rightCallback:null},se={endCallback:"(function|null)",leftCallback:"(function|null)",rightCallback:"(function|null)"};class ne extends F{constructor(e,t){super(),this._element=e,e&&ne.isSupported()&&(this._config=this._getConfig(t),this._deltaX=0,this._supportPointerEvents=Boolean(window.PointerEvent),this._initEvents())}static get Default(){return ie}static get DefaultType(){return se}static get NAME(){return"swipe"}dispose(){N.off(this._element,q)}_start(e){this._supportPointerEvents?this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX):this._deltaX=e.touches[0].clientX}_end(e){this._eventIsPointerPenTouch(e)&&(this._deltaX=e.clientX-this._deltaX),this._handleSwipe(),_(this._config.endCallback)}_move(e){this._deltaX=e.touches&&e.touches.length>1?0:e.touches[0].clientX-this._deltaX}_handleSwipe(){const e=Math.abs(this._deltaX);if(e<=40)return;const t=e/this._deltaX;this._deltaX=0,t&&_(t>0?this._config.rightCallback:this._config.leftCallback)}_initEvents(){this._supportPointerEvents?(N.on(this._element,ee,(e=>this._start(e))),N.on(this._element,te,(e=>this._end(e))),this._element.classList.add("pointer-event")):(N.on(this._element,Z,(e=>this._start(e))),N.on(this._element,Q,(e=>this._move(e))),N.on(this._element,J,(e=>this._end(e))))}_eventIsPointerPenTouch(e){return this._supportPointerEvents&&("pen"===e.pointerType||"touch"===e.pointerType)}static isSupported(){return"ontouchstart"in document.documentElement||navigator.maxTouchPoints>0}}const ae=".bs.carousel",oe=".data-api",re="next",le="prev",he="left",de="right",ce=`slide${ae}`,ue=`slid${ae}`,me=`keydown${ae}`,pe=`mouseenter${ae}`,fe=`mouseleave${ae}`,_e=`dragstart${ae}`,ge=`load${ae}${oe}`,ve=`click${ae}${oe}`,be="carousel",ye="active",we=".active",xe=".carousel-item",De=we+xe,Ce={ArrowLeft:de,ArrowRight:he},Te={interval:5e3,keyboard:!0,pause:"hover",ride:!1,touch:!0,wrap:!0},ke={interval:"(number|boolean)",keyboard:"boolean",pause:"(string|boolean)",ride:"(boolean|string)",touch:"boolean",wrap:"boolean"};class Se extends V{constructor(e,t){super(e,t),this._interval=null,this._activeElement=null,this._isSliding=!1,this.touchTimeout=null,this._swipeHelper=null,this._indicatorsElement=$.findOne(".carousel-indicators",this._element),this._addEventListeners(),this._config.ride===be&&this.cycle()}static get Default(){return Te}static get DefaultType(){return ke}static get NAME(){return"carousel"}next(){this._slide(re)}nextWhenVisible(){!document.hidden&&r(this._element)&&this.next()}prev(){this._slide(le)}pause(){this._isSliding&&n(this._element),this._clearInterval()}cycle(){this._clearInterval(),this._updateInterval(),this._interval=setInterval((()=>this.nextWhenVisible()),this._config.interval)}_maybeEnableCycle(){this._config.ride&&(this._isSliding?N.one(this._element,ue,(()=>this.cycle())):this.cycle())}to(e){const t=this._getItems();if(e>t.length-1||e<0)return;if(this._isSliding)return void N.one(this._element,ue,(()=>this.to(e)));const i=this._getItemIndex(this._getActive());if(i===e)return;const s=e>i?re:le;this._slide(s,t[e])}dispose(){this._swipeHelper&&this._swipeHelper.dispose(),super.dispose()}_configAfterMerge(e){return e.defaultInterval=e.interval,e}_addEventListeners(){this._config.keyboard&&N.on(this._element,me,(e=>this._keydown(e))),"hover"===this._config.pause&&(N.on(this._element,pe,(()=>this.pause())),N.on(this._element,fe,(()=>this._maybeEnableCycle()))),this._config.touch&&ne.isSupported()&&this._addTouchEventListeners()}_addTouchEventListeners(){for(const e of $.find(".carousel-item img",this._element))N.on(e,_e,(e=>e.preventDefault()));const e={leftCallback:()=>this._slide(this._directionToOrder(he)),rightCallback:()=>this._slide(this._directionToOrder(de)),endCallback:()=>{"hover"===this._config.pause&&(this.pause(),this.touchTimeout&&clearTimeout(this.touchTimeout),this.touchTimeout=setTimeout((()=>this._maybeEnableCycle()),500+this._config.interval))}};this._swipeHelper=new ne(this._element,e)}_keydown(e){if(/input|textarea/i.test(e.target.tagName))return;const t=Ce[e.key];t&&(e.preventDefault(),this._slide(this._directionToOrder(t)))}_getItemIndex(e){return this._getItems().indexOf(e)}_setActiveIndicatorElement(e){if(!this._indicatorsElement)return;const t=$.findOne(we,this._indicatorsElement);t.classList.remove(ye),t.removeAttribute("aria-current");const i=$.findOne(`[data-bs-slide-to="${e}"]`,this._indicatorsElement);i&&(i.classList.add(ye),i.setAttribute("aria-current","true"))}_updateInterval(){const e=this._activeElement||this._getActive();if(!e)return;const t=Number.parseInt(e.getAttribute("data-bs-interval"),10);this._config.interval=t||this._config.defaultInterval}_slide(e,t=null){if(this._isSliding)return;const i=this._getActive(),s=e===re,n=t||v(this._getItems(),i,s,this._config.wrap);if(n===i)return;const a=this._getItemIndex(n),o=t=>N.trigger(this._element,t,{relatedTarget:n,direction:this._orderToDirection(e),from:this._getItemIndex(i),to:a});if(o(ce).defaultPrevented)return;if(!i||!n)return;const r=Boolean(this._interval);this.pause(),this._isSliding=!0,this._setActiveIndicatorElement(a),this._activeElement=n;const l=s?"carousel-item-start":"carousel-item-end",h=s?"carousel-item-next":"carousel-item-prev";n.classList.add(h),c(n),i.classList.add(l),n.classList.add(l),this._queueCallback((()=>{n.classList.remove(l,h),n.classList.add(ye),i.classList.remove(ye,h,l),this._isSliding=!1,o(ue)}),i,this._isAnimated()),r&&this.cycle()}_isAnimated(){return this._element.classList.contains("slide")}_getActive(){return $.findOne(De,this._element)}_getItems(){return $.find(xe,this._element)}_clearInterval(){this._interval&&(clearInterval(this._interval),this._interval=null)}_directionToOrder(e){return p()?e===he?le:re:e===he?re:le}_orderToDirection(e){return p()?e===le?he:de:e===le?de:he}static jQueryInterface(e){return this.each((function(){const t=Se.getOrCreateInstance(this,e);if("number"!=typeof e){if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e]()}}else t.to(e)}))}}N.on(document,ve,"[data-bs-slide], [data-bs-slide-to]",(function(e){const t=$.getElementFromSelector(this);if(!t||!t.classList.contains(be))return;e.preventDefault();const i=Se.getOrCreateInstance(t),s=this.getAttribute("data-bs-slide-to");return s?(i.to(s),void i._maybeEnableCycle()):"next"===j.getDataAttribute(this,"slide")?(i.next(),void i._maybeEnableCycle()):(i.prev(),void i._maybeEnableCycle())})),N.on(window,ge,(()=>{const e=$.find('[data-bs-ride="carousel"]');for(const t of e)Se.getOrCreateInstance(t)})),f(Se);const Oe=".bs.collapse",Ie=`show${Oe}`,Me=`shown${Oe}`,Ee=`hide${Oe}`,Pe=`hidden${Oe}`,Le=`click${Oe}.data-api`,Ne="show",Ae="collapse",ze="collapsing",He=`:scope .${Ae} .${Ae}`,je='[data-bs-toggle="collapse"]',Fe={parent:null,toggle:!0},Ve={parent:"(null|element)",toggle:"boolean"};class Re extends V{constructor(e,t){super(e,t),this._isTransitioning=!1,this._triggerArray=[];const i=$.find(je);for(const e of i){const t=$.getSelectorFromElement(e),i=$.find(t).filter((e=>e===this._element));null!==t&&i.length&&this._triggerArray.push(e)}this._initializeChildren(),this._config.parent||this._addAriaAndCollapsedClass(this._triggerArray,this._isShown()),this._config.toggle&&this.toggle()}static get Default(){return Fe}static get DefaultType(){return Ve}static get NAME(){return"collapse"}toggle(){this._isShown()?this.hide():this.show()}show(){if(this._isTransitioning||this._isShown())return;let e=[];if(this._config.parent&&(e=this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter((e=>e!==this._element)).map((e=>Re.getOrCreateInstance(e,{toggle:!1})))),e.length&&e[0]._isTransitioning)return;if(N.trigger(this._element,Ie).defaultPrevented)return;for(const t of e)t.hide();const t=this._getDimension();this._element.classList.remove(Ae),this._element.classList.add(ze),this._element.style[t]=0,this._addAriaAndCollapsedClass(this._triggerArray,!0),this._isTransitioning=!0;const i=`scroll${t[0].toUpperCase()+t.slice(1)}`;this._queueCallback((()=>{this._isTransitioning=!1,this._element.classList.remove(ze),this._element.classList.add(Ae,Ne),this._element.style[t]="",N.trigger(this._element,Me)}),this._element,!0),this._element.style[t]=`${this._element[i]}px`}hide(){if(this._isTransitioning||!this._isShown())return;if(N.trigger(this._element,Ee).defaultPrevented)return;const e=this._getDimension();this._element.style[e]=`${this._element.getBoundingClientRect()[e]}px`,c(this._element),this._element.classList.add(ze),this._element.classList.remove(Ae,Ne);for(const e of this._triggerArray){const t=$.getElementFromSelector(e);t&&!this._isShown(t)&&this._addAriaAndCollapsedClass([e],!1)}this._isTransitioning=!0,this._element.style[e]="",this._queueCallback((()=>{this._isTransitioning=!1,this._element.classList.remove(ze),this._element.classList.add(Ae),N.trigger(this._element,Pe)}),this._element,!0)}_isShown(e=this._element){return e.classList.contains(Ne)}_configAfterMerge(e){return e.toggle=Boolean(e.toggle),e.parent=o(e.parent),e}_getDimension(){return this._element.classList.contains("collapse-horizontal")?"width":"height"}_initializeChildren(){if(!this._config.parent)return;const e=this._getFirstLevelChildren(je);for(const t of e){const e=$.getElementFromSelector(t);e&&this._addAriaAndCollapsedClass([t],this._isShown(e))}}_getFirstLevelChildren(e){const t=$.find(He,this._config.parent);return $.find(e,this._config.parent).filter((e=>!t.includes(e)))}_addAriaAndCollapsedClass(e,t){if(e.length)for(const i of e)i.classList.toggle("collapsed",!t),i.setAttribute("aria-expanded",t)}static jQueryInterface(e){const t={};return"string"==typeof e&&/show|hide/.test(e)&&(t.toggle=!1),this.each((function(){const i=Re.getOrCreateInstance(this,t);if("string"==typeof e){if(void 0===i[e])throw new TypeError(`No method named "${e}"`);i[e]()}}))}}N.on(document,Le,je,(function(e){("A"===e.target.tagName||e.delegateTarget&&"A"===e.delegateTarget.tagName)&&e.preventDefault();for(const e of $.getMultipleElementsFromSelector(this))Re.getOrCreateInstance(e,{toggle:!1}).toggle()})),f(Re);var $e="top",We="bottom",Ue="right",Ye="left",Be="auto",Ge=[$e,We,Ue,Ye],Ke="start",Xe="end",qe="clippingParents",Ze="viewport",Qe="popper",Je="reference",et=Ge.reduce((function(e,t){return e.concat([t+"-"+Ke,t+"-"+Xe])}),[]),tt=[].concat(Ge,[Be]).reduce((function(e,t){return e.concat([t,t+"-"+Ke,t+"-"+Xe])}),[]),it="beforeRead",st="read",nt="afterRead",at="beforeMain",ot="main",rt="afterMain",lt="beforeWrite",ht="write",dt="afterWrite",ct=[it,st,nt,at,ot,rt,lt,ht,dt];function ut(e){return e?(e.nodeName||"").toLowerCase():null}function mt(e){if(null==e)return window;if("[object Window]"!==e.toString()){var t=e.ownerDocument;return t&&t.defaultView||window}return e}function pt(e){return e instanceof mt(e).Element||e instanceof Element}function ft(e){return e instanceof mt(e).HTMLElement||e instanceof HTMLElement}function _t(e){return"undefined"!=typeof ShadowRoot&&(e instanceof mt(e).ShadowRoot||e instanceof ShadowRoot)}const gt={name:"applyStyles",enabled:!0,phase:"write",fn:function(e){var t=e.state;Object.keys(t.elements).forEach((function(e){var i=t.styles[e]||{},s=t.attributes[e]||{},n=t.elements[e];ft(n)&&ut(n)&&(Object.assign(n.style,i),Object.keys(s).forEach((function(e){var t=s[e];!1===t?n.removeAttribute(e):n.setAttribute(e,!0===t?"":t)})))}))},effect:function(e){var t=e.state,i={popper:{position:t.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(t.elements.popper.style,i.popper),t.styles=i,t.elements.arrow&&Object.assign(t.elements.arrow.style,i.arrow),function(){Object.keys(t.elements).forEach((function(e){var s=t.elements[e],n=t.attributes[e]||{},a=Object.keys(t.styles.hasOwnProperty(e)?t.styles[e]:i[e]).reduce((function(e,t){return e[t]="",e}),{});ft(s)&&ut(s)&&(Object.assign(s.style,a),Object.keys(n).forEach((function(e){s.removeAttribute(e)})))}))}},requires:["computeStyles"]};function vt(e){return e.split("-")[0]}var bt=Math.max,yt=Math.min,wt=Math.round;function xt(){var e=navigator.userAgentData;return null!=e&&e.brands&&Array.isArray(e.brands)?e.brands.map((function(e){return e.brand+"/"+e.version})).join(" "):navigator.userAgent}function Dt(){return!/^((?!chrome|android).)*safari/i.test(xt())}function Ct(e,t,i){void 0===t&&(t=!1),void 0===i&&(i=!1);var s=e.getBoundingClientRect(),n=1,a=1;t&&ft(e)&&(n=e.offsetWidth>0&&wt(s.width)/e.offsetWidth||1,a=e.offsetHeight>0&&wt(s.height)/e.offsetHeight||1);var o=(pt(e)?mt(e):window).visualViewport,r=!Dt()&&i,l=(s.left+(r&&o?o.offsetLeft:0))/n,h=(s.top+(r&&o?o.offsetTop:0))/a,d=s.width/n,c=s.height/a;return{width:d,height:c,top:h,right:l+d,bottom:h+c,left:l,x:l,y:h}}function Tt(e){var t=Ct(e),i=e.offsetWidth,s=e.offsetHeight;return Math.abs(t.width-i)<=1&&(i=t.width),Math.abs(t.height-s)<=1&&(s=t.height),{x:e.offsetLeft,y:e.offsetTop,width:i,height:s}}function kt(e,t){var i=t.getRootNode&&t.getRootNode();if(e.contains(t))return!0;if(i&&_t(i)){var s=t;do{if(s&&e.isSameNode(s))return!0;s=s.parentNode||s.host}while(s)}return!1}function St(e){return mt(e).getComputedStyle(e)}function Ot(e){return["table","td","th"].indexOf(ut(e))>=0}function It(e){return((pt(e)?e.ownerDocument:e.document)||window.document).documentElement}function Mt(e){return"html"===ut(e)?e:e.assignedSlot||e.parentNode||(_t(e)?e.host:null)||It(e)}function Et(e){return ft(e)&&"fixed"!==St(e).position?e.offsetParent:null}function Pt(e){for(var t=mt(e),i=Et(e);i&&Ot(i)&&"static"===St(i).position;)i=Et(i);return i&&("html"===ut(i)||"body"===ut(i)&&"static"===St(i).position)?t:i||function(e){var t=/firefox/i.test(xt());if(/Trident/i.test(xt())&&ft(e)&&"fixed"===St(e).position)return null;var i=Mt(e);for(_t(i)&&(i=i.host);ft(i)&&["html","body"].indexOf(ut(i))<0;){var s=St(i);if("none"!==s.transform||"none"!==s.perspective||"paint"===s.contain||-1!==["transform","perspective"].indexOf(s.willChange)||t&&"filter"===s.willChange||t&&s.filter&&"none"!==s.filter)return i;i=i.parentNode}return null}(e)||t}function Lt(e){return["top","bottom"].indexOf(e)>=0?"x":"y"}function Nt(e,t,i){return bt(e,yt(t,i))}function At(e){return Object.assign({},{top:0,right:0,bottom:0,left:0},e)}function zt(e,t){return t.reduce((function(t,i){return t[i]=e,t}),{})}const Ht={name:"arrow",enabled:!0,phase:"main",fn:function(e){var t,i=e.state,s=e.name,n=e.options,a=i.elements.arrow,o=i.modifiersData.popperOffsets,r=vt(i.placement),l=Lt(r),h=[Ye,Ue].indexOf(r)>=0?"height":"width";if(a&&o){var d=function(e,t){return At("number"!=typeof(e="function"==typeof e?e(Object.assign({},t.rects,{placement:t.placement})):e)?e:zt(e,Ge))}(n.padding,i),c=Tt(a),u="y"===l?$e:Ye,m="y"===l?We:Ue,p=i.rects.reference[h]+i.rects.reference[l]-o[l]-i.rects.popper[h],f=o[l]-i.rects.reference[l],_=Pt(a),g=_?"y"===l?_.clientHeight||0:_.clientWidth||0:0,v=p/2-f/2,b=d[u],y=g-c[h]-d[m],w=g/2-c[h]/2+v,x=Nt(b,w,y),D=l;i.modifiersData[s]=((t={})[D]=x,t.centerOffset=x-w,t)}},effect:function(e){var t=e.state,i=e.options.element,s=void 0===i?"[data-popper-arrow]":i;null!=s&&("string"!=typeof s||(s=t.elements.popper.querySelector(s)))&&kt(t.elements.popper,s)&&(t.elements.arrow=s)},requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function jt(e){return e.split("-")[1]}var Ft={top:"auto",right:"auto",bottom:"auto",left:"auto"};function Vt(e){var t,i=e.popper,s=e.popperRect,n=e.placement,a=e.variation,o=e.offsets,r=e.position,l=e.gpuAcceleration,h=e.adaptive,d=e.roundOffsets,c=e.isFixed,u=o.x,m=void 0===u?0:u,p=o.y,f=void 0===p?0:p,_="function"==typeof d?d({x:m,y:f}):{x:m,y:f};m=_.x,f=_.y;var g=o.hasOwnProperty("x"),v=o.hasOwnProperty("y"),b=Ye,y=$e,w=window;if(h){var x=Pt(i),D="clientHeight",C="clientWidth";x===mt(i)&&"static"!==St(x=It(i)).position&&"absolute"===r&&(D="scrollHeight",C="scrollWidth"),(n===$e||(n===Ye||n===Ue)&&a===Xe)&&(y=We,f-=(c&&x===w&&w.visualViewport?w.visualViewport.height:x[D])-s.height,f*=l?1:-1),n!==Ye&&(n!==$e&&n!==We||a!==Xe)||(b=Ue,m-=(c&&x===w&&w.visualViewport?w.visualViewport.width:x[C])-s.width,m*=l?1:-1)}var T,k=Object.assign({position:r},h&&Ft),S=!0===d?function(e,t){var i=e.x,s=e.y,n=t.devicePixelRatio||1;return{x:wt(i*n)/n||0,y:wt(s*n)/n||0}}({x:m,y:f},mt(i)):{x:m,y:f};return m=S.x,f=S.y,l?Object.assign({},k,((T={})[y]=v?"0":"",T[b]=g?"0":"",T.transform=(w.devicePixelRatio||1)<=1?"translate("+m+"px, "+f+"px)":"translate3d("+m+"px, "+f+"px, 0)",T)):Object.assign({},k,((t={})[y]=v?f+"px":"",t[b]=g?m+"px":"",t.transform="",t))}const Rt={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(e){var t=e.state,i=e.options,s=i.gpuAcceleration,n=void 0===s||s,a=i.adaptive,o=void 0===a||a,r=i.roundOffsets,l=void 0===r||r,h={placement:vt(t.placement),variation:jt(t.placement),popper:t.elements.popper,popperRect:t.rects.popper,gpuAcceleration:n,isFixed:"fixed"===t.options.strategy};null!=t.modifiersData.popperOffsets&&(t.styles.popper=Object.assign({},t.styles.popper,Vt(Object.assign({},h,{offsets:t.modifiersData.popperOffsets,position:t.options.strategy,adaptive:o,roundOffsets:l})))),null!=t.modifiersData.arrow&&(t.styles.arrow=Object.assign({},t.styles.arrow,Vt(Object.assign({},h,{offsets:t.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:l})))),t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-placement":t.placement})},data:{}};var $t={passive:!0};const Wt={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(e){var t=e.state,i=e.instance,s=e.options,n=s.scroll,a=void 0===n||n,o=s.resize,r=void 0===o||o,l=mt(t.elements.popper),h=[].concat(t.scrollParents.reference,t.scrollParents.popper);return a&&h.forEach((function(e){e.addEventListener("scroll",i.update,$t)})),r&&l.addEventListener("resize",i.update,$t),function(){a&&h.forEach((function(e){e.removeEventListener("scroll",i.update,$t)})),r&&l.removeEventListener("resize",i.update,$t)}},data:{}};var Ut={left:"right",right:"left",bottom:"top",top:"bottom"};function Yt(e){return e.replace(/left|right|bottom|top/g,(function(e){return Ut[e]}))}var Bt={start:"end",end:"start"};function Gt(e){return e.replace(/start|end/g,(function(e){return Bt[e]}))}function Kt(e){var t=mt(e);return{scrollLeft:t.pageXOffset,scrollTop:t.pageYOffset}}function Xt(e){return Ct(It(e)).left+Kt(e).scrollLeft}function qt(e){var t=St(e),i=t.overflow,s=t.overflowX,n=t.overflowY;return/auto|scroll|overlay|hidden/.test(i+n+s)}function Zt(e){return["html","body","#document"].indexOf(ut(e))>=0?e.ownerDocument.body:ft(e)&&qt(e)?e:Zt(Mt(e))}function Qt(e,t){var i;void 0===t&&(t=[]);var s=Zt(e),n=s===(null==(i=e.ownerDocument)?void 0:i.body),a=mt(s),o=n?[a].concat(a.visualViewport||[],qt(s)?s:[]):s,r=t.concat(o);return n?r:r.concat(Qt(Mt(o)))}function Jt(e){return Object.assign({},e,{left:e.x,top:e.y,right:e.x+e.width,bottom:e.y+e.height})}function ei(e,t,i){return t===Ze?Jt(function(e,t){var i=mt(e),s=It(e),n=i.visualViewport,a=s.clientWidth,o=s.clientHeight,r=0,l=0;if(n){a=n.width,o=n.height;var h=Dt();(h||!h&&"fixed"===t)&&(r=n.offsetLeft,l=n.offsetTop)}return{width:a,height:o,x:r+Xt(e),y:l}}(e,i)):pt(t)?function(e,t){var i=Ct(e,!1,"fixed"===t);return i.top=i.top+e.clientTop,i.left=i.left+e.clientLeft,i.bottom=i.top+e.clientHeight,i.right=i.left+e.clientWidth,i.width=e.clientWidth,i.height=e.clientHeight,i.x=i.left,i.y=i.top,i}(t,i):Jt(function(e){var t,i=It(e),s=Kt(e),n=null==(t=e.ownerDocument)?void 0:t.body,a=bt(i.scrollWidth,i.clientWidth,n?n.scrollWidth:0,n?n.clientWidth:0),o=bt(i.scrollHeight,i.clientHeight,n?n.scrollHeight:0,n?n.clientHeight:0),r=-s.scrollLeft+Xt(e),l=-s.scrollTop;return"rtl"===St(n||i).direction&&(r+=bt(i.clientWidth,n?n.clientWidth:0)-a),{width:a,height:o,x:r,y:l}}(It(e)))}function ti(e){var t,i=e.reference,s=e.element,n=e.placement,a=n?vt(n):null,o=n?jt(n):null,r=i.x+i.width/2-s.width/2,l=i.y+i.height/2-s.height/2;switch(a){case $e:t={x:r,y:i.y-s.height};break;case We:t={x:r,y:i.y+i.height};break;case Ue:t={x:i.x+i.width,y:l};break;case Ye:t={x:i.x-s.width,y:l};break;default:t={x:i.x,y:i.y}}var h=a?Lt(a):null;if(null!=h){var d="y"===h?"height":"width";switch(o){case Ke:t[h]=t[h]-(i[d]/2-s[d]/2);break;case Xe:t[h]=t[h]+(i[d]/2-s[d]/2)}}return t}function ii(e,t){void 0===t&&(t={});var i=t,s=i.placement,n=void 0===s?e.placement:s,a=i.strategy,o=void 0===a?e.strategy:a,r=i.boundary,l=void 0===r?qe:r,h=i.rootBoundary,d=void 0===h?Ze:h,c=i.elementContext,u=void 0===c?Qe:c,m=i.altBoundary,p=void 0!==m&&m,f=i.padding,_=void 0===f?0:f,g=At("number"!=typeof _?_:zt(_,Ge)),v=u===Qe?Je:Qe,b=e.rects.popper,y=e.elements[p?v:u],w=function(e,t,i,s){var n="clippingParents"===t?function(e){var t=Qt(Mt(e)),i=["absolute","fixed"].indexOf(St(e).position)>=0&&ft(e)?Pt(e):e;return pt(i)?t.filter((function(e){return pt(e)&&kt(e,i)&&"body"!==ut(e)})):[]}(e):[].concat(t),a=[].concat(n,[i]),o=a[0],r=a.reduce((function(t,i){var n=ei(e,i,s);return t.top=bt(n.top,t.top),t.right=yt(n.right,t.right),t.bottom=yt(n.bottom,t.bottom),t.left=bt(n.left,t.left),t}),ei(e,o,s));return r.width=r.right-r.left,r.height=r.bottom-r.top,r.x=r.left,r.y=r.top,r}(pt(y)?y:y.contextElement||It(e.elements.popper),l,d,o),x=Ct(e.elements.reference),D=ti({reference:x,element:b,strategy:"absolute",placement:n}),C=Jt(Object.assign({},b,D)),T=u===Qe?C:x,k={top:w.top-T.top+g.top,bottom:T.bottom-w.bottom+g.bottom,left:w.left-T.left+g.left,right:T.right-w.right+g.right},S=e.modifiersData.offset;if(u===Qe&&S){var O=S[n];Object.keys(k).forEach((function(e){var t=[Ue,We].indexOf(e)>=0?1:-1,i=[$e,We].indexOf(e)>=0?"y":"x";k[e]+=O[i]*t}))}return k}const si={name:"flip",enabled:!0,phase:"main",fn:function(e){var t=e.state,i=e.options,s=e.name;if(!t.modifiersData[s]._skip){for(var n=i.mainAxis,a=void 0===n||n,o=i.altAxis,r=void 0===o||o,l=i.fallbackPlacements,h=i.padding,d=i.boundary,c=i.rootBoundary,u=i.altBoundary,m=i.flipVariations,p=void 0===m||m,f=i.allowedAutoPlacements,_=t.options.placement,g=vt(_),v=l||(g!==_&&p?function(e){if(vt(e)===Be)return[];var t=Yt(e);return[Gt(e),t,Gt(t)]}(_):[Yt(_)]),b=[_].concat(v).reduce((function(e,i){return e.concat(vt(i)===Be?function(e,t){void 0===t&&(t={});var i=t,s=i.placement,n=i.boundary,a=i.rootBoundary,o=i.padding,r=i.flipVariations,l=i.allowedAutoPlacements,h=void 0===l?tt:l,d=jt(s),c=d?r?et:et.filter((function(e){return jt(e)===d})):Ge,u=c.filter((function(e){return h.indexOf(e)>=0}));0===u.length&&(u=c);var m=u.reduce((function(t,i){return t[i]=ii(e,{placement:i,boundary:n,rootBoundary:a,padding:o})[vt(i)],t}),{});return Object.keys(m).sort((function(e,t){return m[e]-m[t]}))}(t,{placement:i,boundary:d,rootBoundary:c,padding:h,flipVariations:p,allowedAutoPlacements:f}):i)}),[]),y=t.rects.reference,w=t.rects.popper,x=new Map,D=!0,C=b[0],T=0;T<b.length;T++){var k=b[T],S=vt(k),O=jt(k)===Ke,I=[$e,We].indexOf(S)>=0,M=I?"width":"height",E=ii(t,{placement:k,boundary:d,rootBoundary:c,altBoundary:u,padding:h}),P=I?O?Ue:Ye:O?We:$e;y[M]>w[M]&&(P=Yt(P));var L=Yt(P),N=[];if(a&&N.push(E[S]<=0),r&&N.push(E[P]<=0,E[L]<=0),N.every((function(e){return e}))){C=k,D=!1;break}x.set(k,N)}if(D)for(var A=function(e){var t=b.find((function(t){var i=x.get(t);if(i)return i.slice(0,e).every((function(e){return e}))}));if(t)return C=t,"break"},z=p?3:1;z>0&&"break"!==A(z);z--);t.placement!==C&&(t.modifiersData[s]._skip=!0,t.placement=C,t.reset=!0)}},requiresIfExists:["offset"],data:{_skip:!1}};function ni(e,t,i){return void 0===i&&(i={x:0,y:0}),{top:e.top-t.height-i.y,right:e.right-t.width+i.x,bottom:e.bottom-t.height+i.y,left:e.left-t.width-i.x}}function ai(e){return[$e,Ue,We,Ye].some((function(t){return e[t]>=0}))}const oi={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:function(e){var t=e.state,i=e.name,s=t.rects.reference,n=t.rects.popper,a=t.modifiersData.preventOverflow,o=ii(t,{elementContext:"reference"}),r=ii(t,{altBoundary:!0}),l=ni(o,s),h=ni(r,n,a),d=ai(l),c=ai(h);t.modifiersData[i]={referenceClippingOffsets:l,popperEscapeOffsets:h,isReferenceHidden:d,hasPopperEscaped:c},t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-reference-hidden":d,"data-popper-escaped":c})}},ri={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(e){var t=e.state,i=e.options,s=e.name,n=i.offset,a=void 0===n?[0,0]:n,o=tt.reduce((function(e,i){return e[i]=function(e,t,i){var s=vt(e),n=[Ye,$e].indexOf(s)>=0?-1:1,a="function"==typeof i?i(Object.assign({},t,{placement:e})):i,o=a[0],r=a[1];return o=o||0,r=(r||0)*n,[Ye,Ue].indexOf(s)>=0?{x:r,y:o}:{x:o,y:r}}(i,t.rects,a),e}),{}),r=o[t.placement],l=r.x,h=r.y;null!=t.modifiersData.popperOffsets&&(t.modifiersData.popperOffsets.x+=l,t.modifiersData.popperOffsets.y+=h),t.modifiersData[s]=o}},li={name:"popperOffsets",enabled:!0,phase:"read",fn:function(e){var t=e.state,i=e.name;t.modifiersData[i]=ti({reference:t.rects.reference,element:t.rects.popper,strategy:"absolute",placement:t.placement})},data:{}},hi={name:"preventOverflow",enabled:!0,phase:"main",fn:function(e){var t=e.state,i=e.options,s=e.name,n=i.mainAxis,a=void 0===n||n,o=i.altAxis,r=void 0!==o&&o,l=i.boundary,h=i.rootBoundary,d=i.altBoundary,c=i.padding,u=i.tether,m=void 0===u||u,p=i.tetherOffset,f=void 0===p?0:p,_=ii(t,{boundary:l,rootBoundary:h,padding:c,altBoundary:d}),g=vt(t.placement),v=jt(t.placement),b=!v,y=Lt(g),w="x"===y?"y":"x",x=t.modifiersData.popperOffsets,D=t.rects.reference,C=t.rects.popper,T="function"==typeof f?f(Object.assign({},t.rects,{placement:t.placement})):f,k="number"==typeof T?{mainAxis:T,altAxis:T}:Object.assign({mainAxis:0,altAxis:0},T),S=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,O={x:0,y:0};if(x){if(a){var I,M="y"===y?$e:Ye,E="y"===y?We:Ue,P="y"===y?"height":"width",L=x[y],N=L+_[M],A=L-_[E],z=m?-C[P]/2:0,H=v===Ke?D[P]:C[P],j=v===Ke?-C[P]:-D[P],F=t.elements.arrow,V=m&&F?Tt(F):{width:0,height:0},R=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},$=R[M],W=R[E],U=Nt(0,D[P],V[P]),Y=b?D[P]/2-z-U-$-k.mainAxis:H-U-$-k.mainAxis,B=b?-D[P]/2+z+U+W+k.mainAxis:j+U+W+k.mainAxis,G=t.elements.arrow&&Pt(t.elements.arrow),K=G?"y"===y?G.clientTop||0:G.clientLeft||0:0,X=null!=(I=null==S?void 0:S[y])?I:0,q=L+B-X,Z=Nt(m?yt(N,L+Y-X-K):N,L,m?bt(A,q):A);x[y]=Z,O[y]=Z-L}if(r){var Q,J="x"===y?$e:Ye,ee="x"===y?We:Ue,te=x[w],ie="y"===w?"height":"width",se=te+_[J],ne=te-_[ee],ae=-1!==[$e,Ye].indexOf(g),oe=null!=(Q=null==S?void 0:S[w])?Q:0,re=ae?se:te-D[ie]-C[ie]-oe+k.altAxis,le=ae?te+D[ie]+C[ie]-oe-k.altAxis:ne,he=m&&ae?function(e,t,i){var s=Nt(e,t,i);return s>i?i:s}(re,te,le):Nt(m?re:se,te,m?le:ne);x[w]=he,O[w]=he-te}t.modifiersData[s]=O}},requiresIfExists:["offset"]};function di(e,t,i){void 0===i&&(i=!1);var s,n,a=ft(t),o=ft(t)&&function(e){var t=e.getBoundingClientRect(),i=wt(t.width)/e.offsetWidth||1,s=wt(t.height)/e.offsetHeight||1;return 1!==i||1!==s}(t),r=It(t),l=Ct(e,o,i),h={scrollLeft:0,scrollTop:0},d={x:0,y:0};return(a||!a&&!i)&&(("body"!==ut(t)||qt(r))&&(h=(s=t)!==mt(s)&&ft(s)?{scrollLeft:(n=s).scrollLeft,scrollTop:n.scrollTop}:Kt(s)),ft(t)?((d=Ct(t,!0)).x+=t.clientLeft,d.y+=t.clientTop):r&&(d.x=Xt(r))),{x:l.left+h.scrollLeft-d.x,y:l.top+h.scrollTop-d.y,width:l.width,height:l.height}}function ci(e){var t=new Map,i=new Set,s=[];function n(e){i.add(e.name),[].concat(e.requires||[],e.requiresIfExists||[]).forEach((function(e){if(!i.has(e)){var s=t.get(e);s&&n(s)}})),s.push(e)}return e.forEach((function(e){t.set(e.name,e)})),e.forEach((function(e){i.has(e.name)||n(e)})),s}var ui={placement:"bottom",modifiers:[],strategy:"absolute"};function mi(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];return!t.some((function(e){return!(e&&"function"==typeof e.getBoundingClientRect)}))}function pi(e){void 0===e&&(e={});var t=e,i=t.defaultModifiers,s=void 0===i?[]:i,n=t.defaultOptions,a=void 0===n?ui:n;return function(e,t,i){void 0===i&&(i=a);var n,o,r={placement:"bottom",orderedModifiers:[],options:Object.assign({},ui,a),modifiersData:{},elements:{reference:e,popper:t},attributes:{},styles:{}},l=[],h=!1,d={state:r,setOptions:function(i){var n="function"==typeof i?i(r.options):i;c(),r.options=Object.assign({},a,r.options,n),r.scrollParents={reference:pt(e)?Qt(e):e.contextElement?Qt(e.contextElement):[],popper:Qt(t)};var o,h,u=function(e){var t=ci(e);return ct.reduce((function(e,i){return e.concat(t.filter((function(e){return e.phase===i})))}),[])}((o=[].concat(s,r.options.modifiers),h=o.reduce((function(e,t){var i=e[t.name];return e[t.name]=i?Object.assign({},i,t,{options:Object.assign({},i.options,t.options),data:Object.assign({},i.data,t.data)}):t,e}),{}),Object.keys(h).map((function(e){return h[e]}))));return r.orderedModifiers=u.filter((function(e){return e.enabled})),r.orderedModifiers.forEach((function(e){var t=e.name,i=e.options,s=void 0===i?{}:i,n=e.effect;if("function"==typeof n){var a=n({state:r,name:t,instance:d,options:s});l.push(a||function(){})}})),d.update()},forceUpdate:function(){if(!h){var e=r.elements,t=e.reference,i=e.popper;if(mi(t,i)){r.rects={reference:di(t,Pt(i),"fixed"===r.options.strategy),popper:Tt(i)},r.reset=!1,r.placement=r.options.placement,r.orderedModifiers.forEach((function(e){return r.modifiersData[e.name]=Object.assign({},e.data)}));for(var s=0;s<r.orderedModifiers.length;s++)if(!0!==r.reset){var n=r.orderedModifiers[s],a=n.fn,o=n.options,l=void 0===o?{}:o,c=n.name;"function"==typeof a&&(r=a({state:r,options:l,name:c,instance:d})||r)}else r.reset=!1,s=-1}}},update:(n=function(){return new Promise((function(e){d.forceUpdate(),e(r)}))},function(){return o||(o=new Promise((function(e){Promise.resolve().then((function(){o=void 0,e(n())}))}))),o}),destroy:function(){c(),h=!0}};if(!mi(e,t))return d;function c(){l.forEach((function(e){return e()})),l=[]}return d.setOptions(i).then((function(e){!h&&i.onFirstUpdate&&i.onFirstUpdate(e)})),d}}var fi=pi(),_i=pi({defaultModifiers:[Wt,li,Rt,gt]}),gi=pi({defaultModifiers:[Wt,li,Rt,gt,ri,si,hi,Ht,oi]});const vi=Object.freeze(Object.defineProperty({__proto__:null,afterMain:rt,afterRead:nt,afterWrite:dt,applyStyles:gt,arrow:Ht,auto:Be,basePlacements:Ge,beforeMain:at,beforeRead:it,beforeWrite:lt,bottom:We,clippingParents:qe,computeStyles:Rt,createPopper:gi,createPopperBase:fi,createPopperLite:_i,detectOverflow:ii,end:Xe,eventListeners:Wt,flip:si,hide:oi,left:Ye,main:ot,modifierPhases:ct,offset:ri,placements:tt,popper:Qe,popperGenerator:pi,popperOffsets:li,preventOverflow:hi,read:st,reference:Je,right:Ue,start:Ke,top:$e,variationPlacements:et,viewport:Ze,write:ht},Symbol.toStringTag,{value:"Module"})),bi="dropdown",yi=".bs.dropdown",wi=".data-api",xi="ArrowUp",Di="ArrowDown",Ci=`hide${yi}`,Ti=`hidden${yi}`,ki=`show${yi}`,Si=`shown${yi}`,Oi=`click${yi}${wi}`,Ii=`keydown${yi}${wi}`,Mi=`keyup${yi}${wi}`,Ei="show",Pi='[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',Li=`${Pi}.${Ei}`,Ni=".dropdown-menu",Ai=p()?"top-end":"top-start",zi=p()?"top-start":"top-end",Hi=p()?"bottom-end":"bottom-start",ji=p()?"bottom-start":"bottom-end",Fi=p()?"left-start":"right-start",Vi=p()?"right-start":"left-start",Ri={autoClose:!0,boundary:"clippingParents",display:"dynamic",offset:[0,2],popperConfig:null,reference:"toggle"},$i={autoClose:"(boolean|string)",boundary:"(string|element)",display:"string",offset:"(array|string|function)",popperConfig:"(null|object|function)",reference:"(string|element|object)"};class Wi extends V{constructor(e,t){super(e,t),this._popper=null,this._parent=this._element.parentNode,this._menu=$.next(this._element,Ni)[0]||$.prev(this._element,Ni)[0]||$.findOne(Ni,this._parent),this._inNavbar=this._detectNavbar()}static get Default(){return Ri}static get DefaultType(){return $i}static get NAME(){return bi}toggle(){return this._isShown()?this.hide():this.show()}show(){if(l(this._element)||this._isShown())return;const e={relatedTarget:this._element};if(!N.trigger(this._element,ki,e).defaultPrevented){if(this._createPopper(),"ontouchstart"in document.documentElement&&!this._parent.closest(".navbar-nav"))for(const e of[].concat(...document.body.children))N.on(e,"mouseover",d);this._element.focus(),this._element.setAttribute("aria-expanded",!0),this._menu.classList.add(Ei),this._element.classList.add(Ei),N.trigger(this._element,Si,e)}}hide(){if(l(this._element)||!this._isShown())return;const e={relatedTarget:this._element};this._completeHide(e)}dispose(){this._popper&&this._popper.destroy(),super.dispose()}update(){this._inNavbar=this._detectNavbar(),this._popper&&this._popper.update()}_completeHide(e){if(!N.trigger(this._element,Ci,e).defaultPrevented){if("ontouchstart"in document.documentElement)for(const e of[].concat(...document.body.children))N.off(e,"mouseover",d);this._popper&&this._popper.destroy(),this._menu.classList.remove(Ei),this._element.classList.remove(Ei),this._element.setAttribute("aria-expanded","false"),j.removeDataAttribute(this._menu,"popper"),N.trigger(this._element,Ti,e)}}_getConfig(e){if("object"==typeof(e=super._getConfig(e)).reference&&!a(e.reference)&&"function"!=typeof e.reference.getBoundingClientRect)throw new TypeError(`${bi.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);return e}_createPopper(){if(void 0===vi)throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");let e=this._element;"parent"===this._config.reference?e=this._parent:a(this._config.reference)?e=o(this._config.reference):"object"==typeof this._config.reference&&(e=this._config.reference);const t=this._getPopperConfig();this._popper=gi(e,this._menu,t)}_isShown(){return this._menu.classList.contains(Ei)}_getPlacement(){const e=this._parent;if(e.classList.contains("dropend"))return Fi;if(e.classList.contains("dropstart"))return Vi;if(e.classList.contains("dropup-center"))return"top";if(e.classList.contains("dropdown-center"))return"bottom";const t="end"===getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();return e.classList.contains("dropup")?t?zi:Ai:t?ji:Hi}_detectNavbar(){return null!==this._element.closest(".navbar")}_getOffset(){const{offset:e}=this._config;return"string"==typeof e?e.split(",").map((e=>Number.parseInt(e,10))):"function"==typeof e?t=>e(t,this._element):e}_getPopperConfig(){const e={placement:this._getPlacement(),modifiers:[{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"offset",options:{offset:this._getOffset()}}]};return(this._inNavbar||"static"===this._config.display)&&(j.setDataAttribute(this._menu,"popper","static"),e.modifiers=[{name:"applyStyles",enabled:!1}]),{...e,..._(this._config.popperConfig,[e])}}_selectMenuItem({key:e,target:t}){const i=$.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",this._menu).filter((e=>r(e)));i.length&&v(i,t,e===Di,!i.includes(t)).focus()}static jQueryInterface(e){return this.each((function(){const t=Wi.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e]()}}))}static clearMenus(e){if(2===e.button||"keyup"===e.type&&"Tab"!==e.key)return;const t=$.find(Li);for(const i of t){const t=Wi.getInstance(i);if(!t||!1===t._config.autoClose)continue;const s=e.composedPath(),n=s.includes(t._menu);if(s.includes(t._element)||"inside"===t._config.autoClose&&!n||"outside"===t._config.autoClose&&n)continue;if(t._menu.contains(e.target)&&("keyup"===e.type&&"Tab"===e.key||/input|select|option|textarea|form/i.test(e.target.tagName)))continue;const a={relatedTarget:t._element};"click"===e.type&&(a.clickEvent=e),t._completeHide(a)}}static dataApiKeydownHandler(e){const t=/input|textarea/i.test(e.target.tagName),i="Escape"===e.key,s=[xi,Di].includes(e.key);if(!s&&!i)return;if(t&&!i)return;e.preventDefault();const n=this.matches(Pi)?this:$.prev(this,Pi)[0]||$.next(this,Pi)[0]||$.findOne(Pi,e.delegateTarget.parentNode),a=Wi.getOrCreateInstance(n);if(s)return e.stopPropagation(),a.show(),void a._selectMenuItem(e);a._isShown()&&(e.stopPropagation(),a.hide(),n.focus())}}N.on(document,Ii,Pi,Wi.dataApiKeydownHandler),N.on(document,Ii,Ni,Wi.dataApiKeydownHandler),N.on(document,Oi,Wi.clearMenus),N.on(document,Mi,Wi.clearMenus),N.on(document,Oi,Pi,(function(e){e.preventDefault(),Wi.getOrCreateInstance(this).toggle()})),f(Wi);const Ui="backdrop",Yi="show",Bi=`mousedown.bs.${Ui}`,Gi={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},Ki={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class Xi extends F{constructor(e){super(),this._config=this._getConfig(e),this._isAppended=!1,this._element=null}static get Default(){return Gi}static get DefaultType(){return Ki}static get NAME(){return Ui}show(e){if(!this._config.isVisible)return void _(e);this._append();const t=this._getElement();this._config.isAnimated&&c(t),t.classList.add(Yi),this._emulateAnimation((()=>{_(e)}))}hide(e){this._config.isVisible?(this._getElement().classList.remove(Yi),this._emulateAnimation((()=>{this.dispose(),_(e)}))):_(e)}dispose(){this._isAppended&&(N.off(this._element,Bi),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const e=document.createElement("div");e.className=this._config.className,this._config.isAnimated&&e.classList.add("fade"),this._element=e}return this._element}_configAfterMerge(e){return e.rootElement=o(e.rootElement),e}_append(){if(this._isAppended)return;const e=this._getElement();this._config.rootElement.append(e),N.on(e,Bi,(()=>{_(this._config.clickCallback)})),this._isAppended=!0}_emulateAnimation(e){g(e,this._getElement(),this._config.isAnimated)}}const qi=".bs.focustrap",Zi=`focusin${qi}`,Qi=`keydown.tab${qi}`,Ji="backward",es={autofocus:!0,trapElement:null},ts={autofocus:"boolean",trapElement:"element"};class is extends F{constructor(e){super(),this._config=this._getConfig(e),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return es}static get DefaultType(){return ts}static get NAME(){return"focustrap"}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),N.off(document,qi),N.on(document,Zi,(e=>this._handleFocusin(e))),N.on(document,Qi,(e=>this._handleKeydown(e))),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,N.off(document,qi))}_handleFocusin(e){const{trapElement:t}=this._config;if(e.target===document||e.target===t||t.contains(e.target))return;const i=$.focusableChildren(t);0===i.length?t.focus():this._lastTabNavDirection===Ji?i[i.length-1].focus():i[0].focus()}_handleKeydown(e){"Tab"===e.key&&(this._lastTabNavDirection=e.shiftKey?Ji:"forward")}}const ss=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",ns=".sticky-top",as="padding-right",os="margin-right";class rs{constructor(){this._element=document.body}getWidth(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}hide(){const e=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,as,(t=>t+e)),this._setElementAttributes(ss,as,(t=>t+e)),this._setElementAttributes(ns,os,(t=>t-e))}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,as),this._resetElementAttributes(ss,as),this._resetElementAttributes(ns,os)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(e,t,i){const s=this.getWidth();this._applyManipulationCallback(e,(e=>{if(e!==this._element&&window.innerWidth>e.clientWidth+s)return;this._saveInitialAttribute(e,t);const n=window.getComputedStyle(e).getPropertyValue(t);e.style.setProperty(t,`${i(Number.parseFloat(n))}px`)}))}_saveInitialAttribute(e,t){const i=e.style.getPropertyValue(t);i&&j.setDataAttribute(e,t,i)}_resetElementAttributes(e,t){this._applyManipulationCallback(e,(e=>{const i=j.getDataAttribute(e,t);null!==i?(j.removeDataAttribute(e,t),e.style.setProperty(t,i)):e.style.removeProperty(t)}))}_applyManipulationCallback(e,t){if(a(e))t(e);else for(const i of $.find(e,this._element))t(i)}}const ls=".bs.modal",hs=`hide${ls}`,ds=`hidePrevented${ls}`,cs=`hidden${ls}`,us=`show${ls}`,ms=`shown${ls}`,ps=`resize${ls}`,fs=`click.dismiss${ls}`,_s=`mousedown.dismiss${ls}`,gs=`keydown.dismiss${ls}`,vs=`click${ls}.data-api`,bs="modal-open",ys="show",ws="modal-static",xs={backdrop:!0,focus:!0,keyboard:!0},Ds={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class Cs extends V{constructor(e,t){super(e,t),this._dialog=$.findOne(".modal-dialog",this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new rs,this._addEventListeners()}static get Default(){return xs}static get DefaultType(){return Ds}static get NAME(){return"modal"}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){this._isShown||this._isTransitioning||N.trigger(this._element,us,{relatedTarget:e}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(bs),this._adjustDialog(),this._backdrop.show((()=>this._showElement(e))))}hide(){this._isShown&&!this._isTransitioning&&(N.trigger(this._element,hs).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(ys),this._queueCallback((()=>this._hideModal()),this._element,this._isAnimated())))}dispose(){N.off(window,ls),N.off(this._dialog,ls),this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new Xi({isVisible:Boolean(this._config.backdrop),isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new is({trapElement:this._element})}_showElement(e){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const t=$.findOne(".modal-body",this._dialog);t&&(t.scrollTop=0),c(this._element),this._element.classList.add(ys),this._queueCallback((()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,N.trigger(this._element,ms,{relatedTarget:e})}),this._dialog,this._isAnimated())}_addEventListeners(){N.on(this._element,gs,(e=>{"Escape"===e.key&&(this._config.keyboard?this.hide():this._triggerBackdropTransition())})),N.on(window,ps,(()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()})),N.on(this._element,_s,(e=>{N.one(this._element,fs,(t=>{this._element===e.target&&this._element===t.target&&("static"!==this._config.backdrop?this._config.backdrop&&this.hide():this._triggerBackdropTransition())}))}))}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide((()=>{document.body.classList.remove(bs),this._resetAdjustments(),this._scrollBar.reset(),N.trigger(this._element,cs)}))}_isAnimated(){return this._element.classList.contains("fade")}_triggerBackdropTransition(){if(N.trigger(this._element,ds).defaultPrevented)return;const e=this._element.scrollHeight>document.documentElement.clientHeight,t=this._element.style.overflowY;"hidden"===t||this._element.classList.contains(ws)||(e||(this._element.style.overflowY="hidden"),this._element.classList.add(ws),this._queueCallback((()=>{this._element.classList.remove(ws),this._queueCallback((()=>{this._element.style.overflowY=t}),this._dialog)}),this._dialog),this._element.focus())}_adjustDialog(){const e=this._element.scrollHeight>document.documentElement.clientHeight,t=this._scrollBar.getWidth(),i=t>0;if(i&&!e){const e=p()?"paddingLeft":"paddingRight";this._element.style[e]=`${t}px`}if(!i&&e){const e=p()?"paddingRight":"paddingLeft";this._element.style[e]=`${t}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(e,t){return this.each((function(){const i=Cs.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===i[e])throw new TypeError(`No method named "${e}"`);i[e](t)}}))}}N.on(document,vs,'[data-bs-toggle="modal"]',(function(e){const t=$.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&e.preventDefault(),N.one(t,us,(e=>{e.defaultPrevented||N.one(t,cs,(()=>{r(this)&&this.focus()}))}));const i=$.findOne(".modal.show");i&&Cs.getInstance(i).hide(),Cs.getOrCreateInstance(t).toggle(this)})),W(Cs),f(Cs);const Ts=".bs.offcanvas",ks=".data-api",Ss=`load${Ts}${ks}`,Os="show",Is="showing",Ms="hiding",Es=".offcanvas.show",Ps=`show${Ts}`,Ls=`shown${Ts}`,Ns=`hide${Ts}`,As=`hidePrevented${Ts}`,zs=`hidden${Ts}`,Hs=`resize${Ts}`,js=`click${Ts}${ks}`,Fs=`keydown.dismiss${Ts}`,Vs={backdrop:!0,keyboard:!0,scroll:!1},Rs={backdrop:"(boolean|string)",keyboard:"boolean",scroll:"boolean"};class $s extends V{constructor(e,t){super(e,t),this._isShown=!1,this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._addEventListeners()}static get Default(){return Vs}static get DefaultType(){return Rs}static get NAME(){return"offcanvas"}toggle(e){return this._isShown?this.hide():this.show(e)}show(e){this._isShown||N.trigger(this._element,Ps,{relatedTarget:e}).defaultPrevented||(this._isShown=!0,this._backdrop.show(),this._config.scroll||(new rs).hide(),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.classList.add(Is),this._queueCallback((()=>{this._config.scroll&&!this._config.backdrop||this._focustrap.activate(),this._element.classList.add(Os),this._element.classList.remove(Is),N.trigger(this._element,Ls,{relatedTarget:e})}),this._element,!0))}hide(){this._isShown&&(N.trigger(this._element,Ns).defaultPrevented||(this._focustrap.deactivate(),this._element.blur(),this._isShown=!1,this._element.classList.add(Ms),this._backdrop.hide(),this._queueCallback((()=>{this._element.classList.remove(Os,Ms),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._config.scroll||(new rs).reset(),N.trigger(this._element,zs)}),this._element,!0)))}dispose(){this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}_initializeBackDrop(){const e=Boolean(this._config.backdrop);return new Xi({className:"offcanvas-backdrop",isVisible:e,isAnimated:!0,rootElement:this._element.parentNode,clickCallback:e?()=>{"static"!==this._config.backdrop?this.hide():N.trigger(this._element,As)}:null})}_initializeFocusTrap(){return new is({trapElement:this._element})}_addEventListeners(){N.on(this._element,Fs,(e=>{"Escape"===e.key&&(this._config.keyboard?this.hide():N.trigger(this._element,As))}))}static jQueryInterface(e){return this.each((function(){const t=$s.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}N.on(document,js,'[data-bs-toggle="offcanvas"]',(function(e){const t=$.getElementFromSelector(this);if(["A","AREA"].includes(this.tagName)&&e.preventDefault(),l(this))return;N.one(t,zs,(()=>{r(this)&&this.focus()}));const i=$.findOne(Es);i&&i!==t&&$s.getInstance(i).hide(),$s.getOrCreateInstance(t).toggle(this)})),N.on(window,Ss,(()=>{for(const e of $.find(Es))$s.getOrCreateInstance(e).show()})),N.on(window,Hs,(()=>{for(const e of $.find("[aria-modal][class*=show][class*=offcanvas-]"))"fixed"!==getComputedStyle(e).position&&$s.getOrCreateInstance(e).hide()})),W($s),f($s);const Ws={"*":["class","dir","id","lang","role",/^aria-[\w-]*$/i],a:["target","href","title","rel"],area:[],b:[],br:[],col:[],code:[],dd:[],div:[],dl:[],dt:[],em:[],hr:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],i:[],img:["src","srcset","alt","title","width","height"],li:[],ol:[],p:[],pre:[],s:[],small:[],span:[],sub:[],sup:[],strong:[],u:[],ul:[]},Us=new Set(["background","cite","href","itemtype","longdesc","poster","src","xlink:href"]),Ys=/^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,Bs=(e,t)=>{const i=e.nodeName.toLowerCase();return t.includes(i)?!Us.has(i)||Boolean(Ys.test(e.nodeValue)):t.filter((e=>e instanceof RegExp)).some((e=>e.test(i)))},Gs={allowList:Ws,content:{},extraClass:"",html:!1,sanitize:!0,sanitizeFn:null,template:"<div></div>"},Ks={allowList:"object",content:"object",extraClass:"(string|function)",html:"boolean",sanitize:"boolean",sanitizeFn:"(null|function)",template:"string"},Xs={entry:"(string|element|function|null)",selector:"(string|element)"};class qs extends F{constructor(e){super(),this._config=this._getConfig(e)}static get Default(){return Gs}static get DefaultType(){return Ks}static get NAME(){return"TemplateFactory"}getContent(){return Object.values(this._config.content).map((e=>this._resolvePossibleFunction(e))).filter(Boolean)}hasContent(){return this.getContent().length>0}changeContent(e){return this._checkContent(e),this._config.content={...this._config.content,...e},this}toHtml(){const e=document.createElement("div");e.innerHTML=this._maybeSanitize(this._config.template);for(const[t,i]of Object.entries(this._config.content))this._setContent(e,i,t);const t=e.children[0],i=this._resolvePossibleFunction(this._config.extraClass);return i&&t.classList.add(...i.split(" ")),t}_typeCheckConfig(e){super._typeCheckConfig(e),this._checkContent(e.content)}_checkContent(e){for(const[t,i]of Object.entries(e))super._typeCheckConfig({selector:t,entry:i},Xs)}_setContent(e,t,i){const s=$.findOne(i,e);s&&((t=this._resolvePossibleFunction(t))?a(t)?this._putElementInTemplate(o(t),s):this._config.html?s.innerHTML=this._maybeSanitize(t):s.textContent=t:s.remove())}_maybeSanitize(e){return this._config.sanitize?function(e,t,i){if(!e.length)return e;if(i&&"function"==typeof i)return i(e);const s=(new window.DOMParser).parseFromString(e,"text/html"),n=[].concat(...s.body.querySelectorAll("*"));for(const e of n){const i=e.nodeName.toLowerCase();if(!Object.keys(t).includes(i)){e.remove();continue}const s=[].concat(...e.attributes),n=[].concat(t["*"]||[],t[i]||[]);for(const t of s)Bs(t,n)||e.removeAttribute(t.nodeName)}return s.body.innerHTML}(e,this._config.allowList,this._config.sanitizeFn):e}_resolvePossibleFunction(e){return _(e,[this])}_putElementInTemplate(e,t){if(this._config.html)return t.innerHTML="",void t.append(e);t.textContent=e.textContent}}const Zs=new Set(["sanitize","allowList","sanitizeFn"]),Qs="fade",Js="show",en=".modal",tn="hide.bs.modal",sn="hover",nn="focus",an={AUTO:"auto",TOP:"top",RIGHT:p()?"left":"right",BOTTOM:"bottom",LEFT:p()?"right":"left"},on={allowList:Ws,animation:!0,boundary:"clippingParents",container:!1,customClass:"",delay:0,fallbackPlacements:["top","right","bottom","left"],html:!1,offset:[0,6],placement:"top",popperConfig:null,sanitize:!0,sanitizeFn:null,selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',title:"",trigger:"hover focus"},rn={allowList:"object",animation:"boolean",boundary:"(string|element)",container:"(string|element|boolean)",customClass:"(string|function)",delay:"(number|object)",fallbackPlacements:"array",html:"boolean",offset:"(array|string|function)",placement:"(string|function)",popperConfig:"(null|object|function)",sanitize:"boolean",sanitizeFn:"(null|function)",selector:"(string|boolean)",template:"string",title:"(string|element|function)",trigger:"string"};class ln extends V{constructor(e,t){if(void 0===vi)throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");super(e,t),this._isEnabled=!0,this._timeout=0,this._isHovered=null,this._activeTrigger={},this._popper=null,this._templateFactory=null,this._newContent=null,this.tip=null,this._setListeners(),this._config.selector||this._fixTitle()}static get Default(){return on}static get DefaultType(){return rn}static get NAME(){return"tooltip"}enable(){this._isEnabled=!0}disable(){this._isEnabled=!1}toggleEnabled(){this._isEnabled=!this._isEnabled}toggle(){this._isEnabled&&(this._activeTrigger.click=!this._activeTrigger.click,this._isShown()?this._leave():this._enter())}dispose(){clearTimeout(this._timeout),N.off(this._element.closest(en),tn,this._hideModalHandler),this._element.getAttribute("data-bs-original-title")&&this._element.setAttribute("title",this._element.getAttribute("data-bs-original-title")),this._disposePopper(),super.dispose()}show(){if("none"===this._element.style.display)throw new Error("Please use show on visible elements");if(!this._isWithContent()||!this._isEnabled)return;const e=N.trigger(this._element,this.constructor.eventName("show")),t=(h(this._element)||this._element.ownerDocument.documentElement).contains(this._element);if(e.defaultPrevented||!t)return;this._disposePopper();const i=this._getTipElement();this._element.setAttribute("aria-describedby",i.getAttribute("id"));const{container:s}=this._config;if(this._element.ownerDocument.documentElement.contains(this.tip)||(s.append(i),N.trigger(this._element,this.constructor.eventName("inserted"))),this._popper=this._createPopper(i),i.classList.add(Js),"ontouchstart"in document.documentElement)for(const e of[].concat(...document.body.children))N.on(e,"mouseover",d);this._queueCallback((()=>{N.trigger(this._element,this.constructor.eventName("shown")),!1===this._isHovered&&this._leave(),this._isHovered=!1}),this.tip,this._isAnimated())}hide(){if(this._isShown()&&!N.trigger(this._element,this.constructor.eventName("hide")).defaultPrevented){if(this._getTipElement().classList.remove(Js),"ontouchstart"in document.documentElement)for(const e of[].concat(...document.body.children))N.off(e,"mouseover",d);this._activeTrigger.click=!1,this._activeTrigger[nn]=!1,this._activeTrigger[sn]=!1,this._isHovered=null,this._queueCallback((()=>{this._isWithActiveTrigger()||(this._isHovered||this._disposePopper(),this._element.removeAttribute("aria-describedby"),N.trigger(this._element,this.constructor.eventName("hidden")))}),this.tip,this._isAnimated())}}update(){this._popper&&this._popper.update()}_isWithContent(){return Boolean(this._getTitle())}_getTipElement(){return this.tip||(this.tip=this._createTipElement(this._newContent||this._getContentForTemplate())),this.tip}_createTipElement(e){const t=this._getTemplateFactory(e).toHtml();if(!t)return null;t.classList.remove(Qs,Js),t.classList.add(`bs-${this.constructor.NAME}-auto`);const i=(e=>{do{e+=Math.floor(1e6*Math.random())}while(document.getElementById(e));return e})(this.constructor.NAME).toString();return t.setAttribute("id",i),this._isAnimated()&&t.classList.add(Qs),t}setContent(e){this._newContent=e,this._isShown()&&(this._disposePopper(),this.show())}_getTemplateFactory(e){return this._templateFactory?this._templateFactory.changeContent(e):this._templateFactory=new qs({...this._config,content:e,extraClass:this._resolvePossibleFunction(this._config.customClass)}),this._templateFactory}_getContentForTemplate(){return{".tooltip-inner":this._getTitle()}}_getTitle(){return this._resolvePossibleFunction(this._config.title)||this._element.getAttribute("data-bs-original-title")}_initializeOnDelegatedTarget(e){return this.constructor.getOrCreateInstance(e.delegateTarget,this._getDelegateConfig())}_isAnimated(){return this._config.animation||this.tip&&this.tip.classList.contains(Qs)}_isShown(){return this.tip&&this.tip.classList.contains(Js)}_createPopper(e){const t=_(this._config.placement,[this,e,this._element]),i=an[t.toUpperCase()];return gi(this._element,e,this._getPopperConfig(i))}_getOffset(){const{offset:e}=this._config;return"string"==typeof e?e.split(",").map((e=>Number.parseInt(e,10))):"function"==typeof e?t=>e(t,this._element):e}_resolvePossibleFunction(e){return _(e,[this._element])}_getPopperConfig(e){const t={placement:e,modifiers:[{name:"flip",options:{fallbackPlacements:this._config.fallbackPlacements}},{name:"offset",options:{offset:this._getOffset()}},{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"arrow",options:{element:`.${this.constructor.NAME}-arrow`}},{name:"preSetPlacement",enabled:!0,phase:"beforeMain",fn:e=>{this._getTipElement().setAttribute("data-popper-placement",e.state.placement)}}]};return{...t,..._(this._config.popperConfig,[t])}}_setListeners(){const e=this._config.trigger.split(" ");for(const t of e)if("click"===t)N.on(this._element,this.constructor.eventName("click"),this._config.selector,(e=>{this._initializeOnDelegatedTarget(e).toggle()}));else if("manual"!==t){const e=t===sn?this.constructor.eventName("mouseenter"):this.constructor.eventName("focusin"),i=t===sn?this.constructor.eventName("mouseleave"):this.constructor.eventName("focusout");N.on(this._element,e,this._config.selector,(e=>{const t=this._initializeOnDelegatedTarget(e);t._activeTrigger["focusin"===e.type?nn:sn]=!0,t._enter()})),N.on(this._element,i,this._config.selector,(e=>{const t=this._initializeOnDelegatedTarget(e);t._activeTrigger["focusout"===e.type?nn:sn]=t._element.contains(e.relatedTarget),t._leave()}))}this._hideModalHandler=()=>{this._element&&this.hide()},N.on(this._element.closest(en),tn,this._hideModalHandler)}_fixTitle(){const e=this._element.getAttribute("title");e&&(this._element.getAttribute("aria-label")||this._element.textContent.trim()||this._element.setAttribute("aria-label",e),this._element.setAttribute("data-bs-original-title",e),this._element.removeAttribute("title"))}_enter(){this._isShown()||this._isHovered?this._isHovered=!0:(this._isHovered=!0,this._setTimeout((()=>{this._isHovered&&this.show()}),this._config.delay.show))}_leave(){this._isWithActiveTrigger()||(this._isHovered=!1,this._setTimeout((()=>{this._isHovered||this.hide()}),this._config.delay.hide))}_setTimeout(e,t){clearTimeout(this._timeout),this._timeout=setTimeout(e,t)}_isWithActiveTrigger(){return Object.values(this._activeTrigger).includes(!0)}_getConfig(e){const t=j.getDataAttributes(this._element);for(const e of Object.keys(t))Zs.has(e)&&delete t[e];return e={...t,..."object"==typeof e&&e?e:{}},e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}_configAfterMerge(e){return e.container=!1===e.container?document.body:o(e.container),"number"==typeof e.delay&&(e.delay={show:e.delay,hide:e.delay}),"number"==typeof e.title&&(e.title=e.title.toString()),"number"==typeof e.content&&(e.content=e.content.toString()),e}_getDelegateConfig(){const e={};for(const[t,i]of Object.entries(this._config))this.constructor.Default[t]!==i&&(e[t]=i);return e.selector=!1,e.trigger="manual",e}_disposePopper(){this._popper&&(this._popper.destroy(),this._popper=null),this.tip&&(this.tip.remove(),this.tip=null)}static jQueryInterface(e){return this.each((function(){const t=ln.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e]()}}))}}f(ln);const hn={...ln.Default,content:"",offset:[0,8],placement:"right",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',trigger:"click"},dn={...ln.DefaultType,content:"(null|string|element|function)"};class cn extends ln{static get Default(){return hn}static get DefaultType(){return dn}static get NAME(){return"popover"}_isWithContent(){return this._getTitle()||this._getContent()}_getContentForTemplate(){return{".popover-header":this._getTitle(),".popover-body":this._getContent()}}_getContent(){return this._resolvePossibleFunction(this._config.content)}static jQueryInterface(e){return this.each((function(){const t=cn.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e]()}}))}}f(cn);const un=".bs.scrollspy",mn=`activate${un}`,pn=`click${un}`,fn=`load${un}.data-api`,_n="active",gn="[href]",vn=".nav-link",bn=`${vn}, .nav-item > ${vn}, .list-group-item`,yn={offset:null,rootMargin:"0px 0px -25%",smoothScroll:!1,target:null,threshold:[.1,.5,1]},wn={offset:"(number|null)",rootMargin:"string",smoothScroll:"boolean",target:"element",threshold:"array"};class xn extends V{constructor(e,t){super(e,t),this._targetLinks=new Map,this._observableSections=new Map,this._rootElement="visible"===getComputedStyle(this._element).overflowY?null:this._element,this._activeTarget=null,this._observer=null,this._previousScrollData={visibleEntryTop:0,parentScrollTop:0},this.refresh()}static get Default(){return yn}static get DefaultType(){return wn}static get NAME(){return"scrollspy"}refresh(){this._initializeTargetsAndObservables(),this._maybeEnableSmoothScroll(),this._observer?this._observer.disconnect():this._observer=this._getNewObserver();for(const e of this._observableSections.values())this._observer.observe(e)}dispose(){this._observer.disconnect(),super.dispose()}_configAfterMerge(e){return e.target=o(e.target)||document.body,e.rootMargin=e.offset?`${e.offset}px 0px -30%`:e.rootMargin,"string"==typeof e.threshold&&(e.threshold=e.threshold.split(",").map((e=>Number.parseFloat(e)))),e}_maybeEnableSmoothScroll(){this._config.smoothScroll&&(N.off(this._config.target,pn),N.on(this._config.target,pn,gn,(e=>{const t=this._observableSections.get(e.target.hash);if(t){e.preventDefault();const i=this._rootElement||window,s=t.offsetTop-this._element.offsetTop;if(i.scrollTo)return void i.scrollTo({top:s,behavior:"smooth"});i.scrollTop=s}})))}_getNewObserver(){const e={root:this._rootElement,threshold:this._config.threshold,rootMargin:this._config.rootMargin};return new IntersectionObserver((e=>this._observerCallback(e)),e)}_observerCallback(e){const t=e=>this._targetLinks.get(`#${e.target.id}`),i=e=>{this._previousScrollData.visibleEntryTop=e.target.offsetTop,this._process(t(e))},s=(this._rootElement||document.documentElement).scrollTop,n=s>=this._previousScrollData.parentScrollTop;this._previousScrollData.parentScrollTop=s;for(const a of e){if(!a.isIntersecting){this._activeTarget=null,this._clearActiveClass(t(a));continue}const e=a.target.offsetTop>=this._previousScrollData.visibleEntryTop;if(n&&e){if(i(a),!s)return}else n||e||i(a)}}_initializeTargetsAndObservables(){this._targetLinks=new Map,this._observableSections=new Map;const e=$.find(gn,this._config.target);for(const t of e){if(!t.hash||l(t))continue;const e=$.findOne(decodeURI(t.hash),this._element);r(e)&&(this._targetLinks.set(decodeURI(t.hash),t),this._observableSections.set(t.hash,e))}}_process(e){this._activeTarget!==e&&(this._clearActiveClass(this._config.target),this._activeTarget=e,e.classList.add(_n),this._activateParents(e),N.trigger(this._element,mn,{relatedTarget:e}))}_activateParents(e){if(e.classList.contains("dropdown-item"))$.findOne(".dropdown-toggle",e.closest(".dropdown")).classList.add(_n);else for(const t of $.parents(e,".nav, .list-group"))for(const e of $.prev(t,bn))e.classList.add(_n)}_clearActiveClass(e){e.classList.remove(_n);const t=$.find(`${gn}.${_n}`,e);for(const e of t)e.classList.remove(_n)}static jQueryInterface(e){return this.each((function(){const t=xn.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e]()}}))}}N.on(window,fn,(()=>{for(const e of $.find('[data-bs-spy="scroll"]'))xn.getOrCreateInstance(e)})),f(xn);const Dn=".bs.tab",Cn=`hide${Dn}`,Tn=`hidden${Dn}`,kn=`show${Dn}`,Sn=`shown${Dn}`,On=`click${Dn}`,In=`keydown${Dn}`,Mn=`load${Dn}`,En="ArrowLeft",Pn="ArrowRight",Ln="ArrowUp",Nn="ArrowDown",An="Home",zn="End",Hn="active",jn="fade",Fn="show",Vn=".dropdown-toggle",Rn=`:not(${Vn})`,$n='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',Wn=`.nav-link${Rn}, .list-group-item${Rn}, [role="tab"]${Rn}, ${$n}`,Un=`.${Hn}[data-bs-toggle="tab"], .${Hn}[data-bs-toggle="pill"], .${Hn}[data-bs-toggle="list"]`;class Yn extends V{constructor(e){super(e),this._parent=this._element.closest('.list-group, .nav, [role="tablist"]'),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),N.on(this._element,In,(e=>this._keydown(e))))}static get NAME(){return"tab"}show(){const e=this._element;if(this._elemIsActive(e))return;const t=this._getActiveElem(),i=t?N.trigger(t,Cn,{relatedTarget:e}):null;N.trigger(e,kn,{relatedTarget:t}).defaultPrevented||i&&i.defaultPrevented||(this._deactivate(t,e),this._activate(e,t))}_activate(e,t){e&&(e.classList.add(Hn),this._activate($.getElementFromSelector(e)),this._queueCallback((()=>{"tab"===e.getAttribute("role")?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),N.trigger(e,Sn,{relatedTarget:t})):e.classList.add(Fn)}),e,e.classList.contains(jn)))}_deactivate(e,t){e&&(e.classList.remove(Hn),e.blur(),this._deactivate($.getElementFromSelector(e)),this._queueCallback((()=>{"tab"===e.getAttribute("role")?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),N.trigger(e,Tn,{relatedTarget:t})):e.classList.remove(Fn)}),e,e.classList.contains(jn)))}_keydown(e){if(![En,Pn,Ln,Nn,An,zn].includes(e.key))return;e.stopPropagation(),e.preventDefault();const t=this._getChildren().filter((e=>!l(e)));let i;if([An,zn].includes(e.key))i=t[e.key===An?0:t.length-1];else{const s=[Pn,Nn].includes(e.key);i=v(t,e.target,s,!0)}i&&(i.focus({preventScroll:!0}),Yn.getOrCreateInstance(i).show())}_getChildren(){return $.find(Wn,this._parent)}_getActiveElem(){return this._getChildren().find((e=>this._elemIsActive(e)))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist");for(const e of t)this._setInitialAttributesOnChild(e)}_setInitialAttributesOnChild(e){e=this._getInnerElement(e);const t=this._elemIsActive(e),i=this._getOuterElement(e);e.setAttribute("aria-selected",t),i!==e&&this._setAttributeIfNotExists(i,"role","presentation"),t||e.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(e,"role","tab"),this._setInitialAttributesOnTargetPanel(e)}_setInitialAttributesOnTargetPanel(e){const t=$.getElementFromSelector(e);t&&(this._setAttributeIfNotExists(t,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(t,"aria-labelledby",`${e.id}`))}_toggleDropDown(e,t){const i=this._getOuterElement(e);if(!i.classList.contains("dropdown"))return;const s=(e,s)=>{const n=$.findOne(e,i);n&&n.classList.toggle(s,t)};s(Vn,Hn),s(".dropdown-menu",Fn),i.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,i){e.hasAttribute(t)||e.setAttribute(t,i)}_elemIsActive(e){return e.classList.contains(Hn)}_getInnerElement(e){return e.matches(Wn)?e:$.findOne(Wn,e)}_getOuterElement(e){return e.closest(".nav-item, .list-group-item")||e}static jQueryInterface(e){return this.each((function(){const t=Yn.getOrCreateInstance(this);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e]()}}))}}N.on(document,On,$n,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),l(this)||Yn.getOrCreateInstance(this).show()})),N.on(window,Mn,(()=>{for(const e of $.find(Un))Yn.getOrCreateInstance(e)})),f(Yn);const Bn=".bs.toast",Gn=`mouseover${Bn}`,Kn=`mouseout${Bn}`,Xn=`focusin${Bn}`,qn=`focusout${Bn}`,Zn=`hide${Bn}`,Qn=`hidden${Bn}`,Jn=`show${Bn}`,ea=`shown${Bn}`,ta="hide",ia="show",sa="showing",na={animation:"boolean",autohide:"boolean",delay:"number"},aa={animation:!0,autohide:!0,delay:5e3};class oa extends V{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return aa}static get DefaultType(){return na}static get NAME(){return"toast"}show(){N.trigger(this._element,Jn).defaultPrevented||(this._clearTimeout(),this._config.animation&&this._element.classList.add("fade"),this._element.classList.remove(ta),c(this._element),this._element.classList.add(ia,sa),this._queueCallback((()=>{this._element.classList.remove(sa),N.trigger(this._element,ea),this._maybeScheduleHide()}),this._element,this._config.animation))}hide(){this.isShown()&&(N.trigger(this._element,Zn).defaultPrevented||(this._element.classList.add(sa),this._queueCallback((()=>{this._element.classList.add(ta),this._element.classList.remove(sa,ia),N.trigger(this._element,Qn)}),this._element,this._config.animation)))}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(ia),super.dispose()}isShown(){return this._element.classList.contains(ia)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const i=e.relatedTarget;this._element===i||this._element.contains(i)||this._maybeScheduleHide()}_setListeners(){N.on(this._element,Gn,(e=>this._onInteraction(e,!0))),N.on(this._element,Kn,(e=>this._onInteraction(e,!1))),N.on(this._element,Xn,(e=>this._onInteraction(e,!0))),N.on(this._element,qn,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=oa.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return W(oa),f(oa),{Alert:G,Button:X,Carousel:Se,Collapse:Re,Dropdown:Wi,Modal:Cs,Offcanvas:$s,Popover:cn,ScrollSpy:xn,Tab:Yn,Toast:oa,Tooltip:ln}})),function(e,t){void 0===e&&void 0!==window&&(e=window),"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof module&&module.exports?module.exports=t(require("jquery")):t(e.jQuery)}(this,(function(e){!function(e){"use strict";var t,i,s,n,a=["sanitize","whiteList","sanitizeFn"],o=["background","cite","href","itemtype","longdesc","poster","src","xlink:href"],r=/^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi,l=/^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i,h=["title","placeholder"];function d(t,i,s){if(s&&"function"==typeof s)return s(t);for(var n=Object.keys(i),a=0,h=t.length;a<h;a++)for(var d=t[a].querySelectorAll("*"),c=0,u=d.length;c<u;c++){var m=d[c],p=m.nodeName.toLowerCase();if(-1===n.indexOf(p))m.parentNode.removeChild(m);else for(var f=[].slice.call(m.attributes),_=[].concat(i["*"]||[],i[p]||[]),g=0,v=f.length;g<v;g++){var b=f[g];!function(t,i){var s=t.nodeName.toLowerCase();if(-1!==e.inArray(s,i))return-1===e.inArray(s,o)||Boolean(t.nodeValue.match(r)||t.nodeValue.match(l));for(var n=e(i).filter((function(e,t){return t instanceof RegExp})),a=0,h=n.length;a<h;a++)if(s.match(n[a]))return 1}(b,_)&&m.removeAttribute(b.nodeName)}}}function c(e){var t,i={};return h.forEach((function(s){(t=e.attr(s))&&(i[s]=t)})),!i.placeholder&&i.title&&(i.placeholder=i.title),i}if(!("classList"in document.createElement("_"))&&"Element"in(p=window)){var u="classList",m="prototype",p=p.Element[m],f=Object,_=function(){var t=e(this);return{add:function(e){return e=Array.prototype.slice.call(arguments).join(" "),t.addClass(e)},remove:function(e){return e=Array.prototype.slice.call(arguments).join(" "),t.removeClass(e)},toggle:function(e,i){return t.toggleClass(e,i)},contains:function(e){return t.hasClass(e)}}};if(f.defineProperty){var g={get:_,enumerable:!0,configurable:!0};try{f.defineProperty(p,u,g)}catch(m){void 0!==m.number&&-2146823252!==m.number||(g.enumerable=!1,f.defineProperty(p,u,g))}}else f[m].__defineGetter__&&p.__defineGetter__(u,_)}function v(e){if(null==this)throw new TypeError;var t=String(this);if(e&&"[object RegExp]"==n.call(e))throw new TypeError;var i=t.length,s=String(e),a=s.length,o=((e=(e=1<arguments.length?arguments[1]:void 0)?Number(e):0)!=e&&(e=0),Math.min(Math.max(e,0),i));if(i<a+o)return!1;for(var r=-1;++r<a;)if(t.charCodeAt(o+r)!=s.charCodeAt(r))return!1;return!0}function b(){var e=this.selectpicker.main.data,t=(e=this.options.source.data||this.options.source.search?Object.values(this.selectpicker.optionValuesDataMap):e).filter((function(e){return!(!e.selected||this.options.hideDisabled&&e.disabled)}),this);if(this.options.source.data&&!this.multiple&&1<t.length){for(var i=0;i<t.length-1;i++)t[i].selected=!1;t=[t[t.length-1]]}return t}function y(e){for(var t,i=[],s=e||b.call(this),n=0,a=s.length;n<a;n++)(t=s[n]).disabled||i.push(void 0===t.value?t.text:t.value);return this.multiple?i:i.length?i[0]:null}(g=document.createElement("_")).classList.add("c1","c2"),g.classList.contains("c2")||(t=DOMTokenList.prototype.add,i=DOMTokenList.prototype.remove,DOMTokenList.prototype.add=function(){Array.prototype.forEach.call(arguments,t.bind(this))},DOMTokenList.prototype.remove=function(){Array.prototype.forEach.call(arguments,i.bind(this))}),g.classList.toggle("c3",!1),g.classList.contains("c3")&&(s=DOMTokenList.prototype.toggle,DOMTokenList.prototype.toggle=function(e,t){return 1 in arguments&&!this.contains(e)==!t?t:s.call(this,e)}),g=null,Object.values="function"==typeof Object.values?Object.values:function(e){return Object.keys(e).map((function(t){return e[t]}))},String.prototype.startsWith||(n={}.toString,Object.defineProperty?Object.defineProperty(String.prototype,"startsWith",{value:v,configurable:!0,writable:!0}):String.prototype.startsWith=v);var w={useDefault:!1,_set:e.valHooks.select.set},x=(e.valHooks.select.set=function(t,i){return i&&!w.useDefault&&e(t).data("selected",!0),w._set.apply(this,arguments)},null),D=function(){try{return new Event("change"),!0}catch(e){return!1}}();function C(e,t,i,s){for(var n=["display","subtext","tokens"],a=!1,o=0;o<n.length;o++){var r=n[o],l=e[r];if(l&&(l=l.toString(),"display"===r&&(l=l.replace(/<[^>]+>/g,"")),l=(l=s?M(l):l).toUpperCase(),a="function"==typeof i?i(l,t):"contains"===i?0<=l.indexOf(t):l.startsWith(t)))break}return a}function T(e){return parseInt(e,10)||0}e.fn.triggerNative=function(e){var t,i=this[0];i.dispatchEvent&&(D?t=new Event(e,{bubbles:!0}):(t=document.createEvent("Event")).initEvent(e,!0,!1),i.dispatchEvent(t))};var k={"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","Ç":"C","ç":"c","Ð":"D","ð":"d","È":"E","É":"E","Ê":"E","Ë":"E","è":"e","é":"e","ê":"e","ë":"e","Ì":"I","Í":"I","Î":"I","Ï":"I","ì":"i","í":"i","î":"i","ï":"i","Ñ":"N","ñ":"n","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","Ø":"O","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","ø":"o","Ù":"U","Ú":"U","Û":"U","Ü":"U","ù":"u","ú":"u","û":"u","ü":"u","Ý":"Y","ý":"y","ÿ":"y","Æ":"Ae","æ":"ae","Þ":"Th","þ":"th","ß":"ss","Ā":"A","Ă":"A","Ą":"A","ā":"a","ă":"a","ą":"a","Ć":"C","Ĉ":"C","Ċ":"C","Č":"C","ć":"c","ĉ":"c","ċ":"c","č":"c","Ď":"D","Đ":"D","ď":"d","đ":"d","Ē":"E","Ĕ":"E","Ė":"E","Ę":"E","Ě":"E","ē":"e","ĕ":"e","ė":"e","ę":"e","ě":"e","Ĝ":"G","Ğ":"G","Ġ":"G","Ģ":"G","ĝ":"g","ğ":"g","ġ":"g","ģ":"g","Ĥ":"H","Ħ":"H","ĥ":"h","ħ":"h","Ĩ":"I","Ī":"I","Ĭ":"I","Į":"I","İ":"I","ĩ":"i","ī":"i","ĭ":"i","į":"i","ı":"i","Ĵ":"J","ĵ":"j","Ķ":"K","ķ":"k","ĸ":"k","Ĺ":"L","Ļ":"L","Ľ":"L","Ŀ":"L","Ł":"L","ĺ":"l","ļ":"l","ľ":"l","ŀ":"l","ł":"l","Ń":"N","Ņ":"N","Ň":"N","Ŋ":"N","ń":"n","ņ":"n","ň":"n","ŋ":"n","Ō":"O","Ŏ":"O","Ő":"O","ō":"o","ŏ":"o","ő":"o","Ŕ":"R","Ŗ":"R","Ř":"R","ŕ":"r","ŗ":"r","ř":"r","Ś":"S","Ŝ":"S","Ş":"S","Š":"S","ś":"s","ŝ":"s","ş":"s","š":"s","Ţ":"T","Ť":"T","Ŧ":"T","ţ":"t","ť":"t","ŧ":"t","Ũ":"U","Ū":"U","Ŭ":"U","Ů":"U","Ű":"U","Ų":"U","ũ":"u","ū":"u","ŭ":"u","ů":"u","ű":"u","ų":"u","Ŵ":"W","ŵ":"w","Ŷ":"Y","ŷ":"y","Ÿ":"Y","Ź":"Z","Ż":"Z","Ž":"Z","ź":"z","ż":"z","ž":"z","Ĳ":"IJ","ĳ":"ij","Œ":"Oe","œ":"oe","ŉ":"'n","ſ":"s"},S=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,O=RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\u1ab0-\\u1aff\\u1dc0-\\u1dff]","g");function I(e){return k[e]}function M(e){return(e=e.toString())&&e.replace(S,I).replace(O,"")}E={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},f="(?:"+Object.keys(E).join("|")+")",P=RegExp(f),L=RegExp(f,"g");var E,P,L,N=function(e){return P.test(e=null==e?"":""+e)?e.replace(L,A):e};function A(e){return E[e]}var z={32:" ",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",59:";",65:"A",66:"B",67:"C",68:"D",69:"E",70:"F",71:"G",72:"H",73:"I",74:"J",75:"K",76:"L",77:"M",78:"N",79:"O",80:"P",81:"Q",82:"R",83:"S",84:"T",85:"U",86:"V",87:"W",88:"X",89:"Y",90:"Z",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9"},H=window.Dropdown||bootstrap.Dropdown;function j(){var t;try{t=e.fn.dropdown.Constructor.VERSION}catch(e){t=H.VERSION}return t}var F={success:!1,major:"3"};try{F.full=(j()||"").split(" ")[0].split("."),F.major=F.full[0],F.success=!0}catch(m){}var V=0,R=".bs.select",$={DISABLED:"disabled",DIVIDER:"divider",SHOW:"open",DROPUP:"dropup",MENU:"dropdown-menu",MENURIGHT:"dropdown-menu-right",MENULEFT:"dropdown-menu-left",BUTTONCLASS:"btn-default",POPOVERHEADER:"popover-title",ICONBASE:"glyphicon",TICKICON:"glyphicon-ok"},W={MENU:"."+$.MENU,DATA_TOGGLE:'data-toggle="dropdown"'},U={div:document.createElement("div"),span:document.createElement("span"),i:document.createElement("i"),subtext:document.createElement("small"),a:document.createElement("a"),li:document.createElement("li"),whitespace:document.createTextNode(" "),fragment:document.createDocumentFragment(),option:document.createElement("option")},Y=(U.selectedOption=U.option.cloneNode(!1),U.selectedOption.setAttribute("selected",!0),U.noResults=U.li.cloneNode(!1),U.noResults.className="no-results",U.a.setAttribute("role","option"),U.a.className="dropdown-item",U.subtext.className="text-muted",U.text=U.span.cloneNode(!1),U.text.className="text",U.checkMark=U.span.cloneNode(!1),new RegExp("38|40")),B=new RegExp("^9$|27"),G={li:function(e,t,i){var s=U.li.cloneNode(!1);return e&&(1===e.nodeType||11===e.nodeType?s.appendChild(e):s.innerHTML=e),void 0!==t&&""!==t&&(s.className=t),null!=i&&s.classList.add("optgroup-"+i),s},a:function(e,t,i){var s=U.a.cloneNode(!0);return e&&(11===e.nodeType?s.appendChild(e):s.insertAdjacentHTML("beforeend",e)),void 0!==t&&""!==t&&s.classList.add.apply(s.classList,t.split(/\s+/)),i&&s.setAttribute("style",i),s},text:function(e,t){var i,s,n=U.text.cloneNode(!1);if(e.content?n.innerHTML=e.content:(n.textContent=e.text,e.icon&&(i=U.whitespace.cloneNode(!1),(s=(!0===t?U.i:U.span).cloneNode(!1)).className=this.options.iconBase+" "+e.icon,U.fragment.appendChild(s),U.fragment.appendChild(i)),e.subtext&&((s=U.subtext.cloneNode(!1)).textContent=e.subtext,n.appendChild(s))),!0===t)for(;0<n.childNodes.length;)U.fragment.appendChild(n.childNodes[0]);else U.fragment.appendChild(n);return U.fragment},label:function(e){var t,i,s=U.text.cloneNode(!1);return s.innerHTML=e.display,e.icon&&(t=U.whitespace.cloneNode(!1),(i=U.span.cloneNode(!1)).className=this.options.iconBase+" "+e.icon,U.fragment.appendChild(i),U.fragment.appendChild(t)),e.subtext&&((i=U.subtext.cloneNode(!1)).textContent=e.subtext,s.appendChild(i)),U.fragment.appendChild(s),U.fragment}},K={fromOption:function(e,t){var i;switch(t){case"divider":i="true"===e.getAttribute("data-divider");break;case"text":i=e.textContent;break;case"label":i=e.label;break;case"style":i=e.style.cssText;break;case"title":i=e.title;break;default:i=e.getAttribute("data-"+t.replace(/[A-Z]+(?![a-z])|[A-Z]/g,(function(e,t){return(t?"-":"")+e.toLowerCase()})))}return i},fromDataSource:function(e,t){var i;switch(t){case"text":case"label":i=e.text||e.value||"";break;default:i=e[t]}return i}};function X(e,t){e.length||(U.noResults.innerHTML=this.options.noneResultsText.replace("{0}",'"'+N(t)+'"'),this.$menuInner[0].firstChild.appendChild(U.noResults))}function q(e){return!(e.hidden||this.options.hideDisabled&&e.disabled)}function Z(t,i){var s=this;w.useDefault||(e.valHooks.select.set=w._set,w.useDefault=!0),this.$element=e(t),this.$newElement=null,this.$button=null,this.$menu=null,this.options=i,this.selectpicker={main:{data:[],optionQueue:U.fragment.cloneNode(!1),hasMore:!1},search:{data:[],hasMore:!1},current:{},view:{},optionValuesDataMap:{},isSearching:!1,keydown:{keyHistory:"",resetKeyHistory:{start:function(){return setTimeout((function(){s.selectpicker.keydown.keyHistory=""}),800)}}}},this.sizeInfo={},"number"==typeof(t=this.options.windowPadding)&&(this.options.windowPadding=[t,t,t,t]),this.val=Z.prototype.val,this.render=Z.prototype.render,this.refresh=Z.prototype.refresh,this.setStyle=Z.prototype.setStyle,this.selectAll=Z.prototype.selectAll,this.deselectAll=Z.prototype.deselectAll,this.destroy=Z.prototype.destroy,this.remove=Z.prototype.remove,this.show=Z.prototype.show,this.hide=Z.prototype.hide,this.init()}function Q(t){var i,s=arguments,n=t;if([].shift.apply(s),!F.success){try{F.full=(j()||"").split(" ")[0].split(".")}catch(t){Z.BootstrapVersion?F.full=Z.BootstrapVersion.split(" ")[0].split("."):(F.full=[F.major,"0","0"],console.warn("There was an issue retrieving Bootstrap's version. Ensure Bootstrap is being loaded before bootstrap-select and there is no namespace collision. If loading Bootstrap asynchronously, the version may need to be manually specified via $.fn.selectpicker.Constructor.BootstrapVersion.",t))}F.major=F.full[0],F.success=!0}if("4"<=F.major){var o=[];Z.DEFAULTS.style===$.BUTTONCLASS&&o.push({name:"style",className:"BUTTONCLASS"}),Z.DEFAULTS.iconBase===$.ICONBASE&&o.push({name:"iconBase",className:"ICONBASE"}),Z.DEFAULTS.tickIcon===$.TICKICON&&o.push({name:"tickIcon",className:"TICKICON"}),$.DIVIDER="dropdown-divider",$.SHOW="show",$.BUTTONCLASS="btn-light",$.POPOVERHEADER="popover-header",$.ICONBASE="",$.TICKICON="bs-ok-default";for(var r=0;r<o.length;r++)t=o[r],Z.DEFAULTS[t.name]=$[t.className]}"4"<F.major&&(W.DATA_TOGGLE='data-bs-toggle="dropdown"');var l=this.each((function(){var t=e(this);if(t.is("select")){var o=t.data("selectpicker"),r="object"==typeof n&&n;if(r.title&&(r.placeholder=r.title),o){if(r)for(var l in r)Object.prototype.hasOwnProperty.call(r,l)&&(o.options[l]=r[l])}else{var h,d=t.data();for(h in d)Object.prototype.hasOwnProperty.call(d,h)&&-1!==e.inArray(h,a)&&delete d[h];var u=e.extend({},Z.DEFAULTS,e.fn.selectpicker.defaults||{},c(t),d,r);u.template=e.extend({},Z.DEFAULTS.template,e.fn.selectpicker.defaults?e.fn.selectpicker.defaults.template:{},d.template,r.template),u.source=e.extend({},Z.DEFAULTS.source,e.fn.selectpicker.defaults?e.fn.selectpicker.defaults.source:{},r.source),t.data("selectpicker",o=new Z(this,u))}"string"==typeof n&&(i=o[n]instanceof Function?o[n].apply(o,s):o.options[n])}}));return void 0!==i?i:l}Z.VERSION="1.14.0-beta3",Z.DEFAULTS={noneSelectedText:"Nothing selected",noneResultsText:"No results matched {0}",countSelectedText:function(e,t){return 1==e?"{0} item selected":"{0} items selected"},maxOptionsText:function(e,t){return[1==e?"Limit reached ({n} item max)":"Limit reached ({n} items max)",1==t?"Group limit reached ({n} item max)":"Group limit reached ({n} items max)"]},selectAllText:"Select All",deselectAllText:"Deselect All",source:{pageSize:40},chunkSize:40,doneButton:!1,doneButtonText:"Close",multipleSeparator:", ",styleBase:"btn",style:$.BUTTONCLASS,size:"auto",title:null,placeholder:null,allowClear:!1,selectedTextFormat:"values",width:!1,container:!1,hideDisabled:!1,showSubtext:!1,showIcon:!0,showContent:!0,dropupAuto:!0,header:!1,liveSearch:!1,liveSearchPlaceholder:null,liveSearchNormalize:!1,liveSearchStyle:"contains",actionsBox:!1,iconBase:$.ICONBASE,tickIcon:$.TICKICON,showTick:!1,template:{caret:'<span class="caret"></span>'},maxOptions:!1,mobile:!1,selectOnTab:!0,dropdownAlignRight:!1,windowPadding:0,virtualScroll:600,display:!1,sanitize:!0,sanitizeFn:null,whiteList:{"*":["class","dir","id","lang","role","tabindex","style",/^aria-[\w-]*$/i],a:["target","href","title","rel"],area:[],b:[],br:[],col:[],code:[],div:[],em:[],hr:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],i:[],img:["src","alt","title","width","height"],li:[],ol:[],p:[],pre:[],s:[],small:[],span:[],sub:[],sup:[],strong:[],u:[],ul:[]}},Z.prototype={constructor:Z,init:function(){var t=this,i=this.$element.attr("id"),s=this.$element[0],n=s.form;V++,this.selectId="bs-select-"+V,s.classList.add("bs-select-hidden"),this.multiple=this.$element.prop("multiple"),this.autofocus=this.$element.prop("autofocus"),s.classList.contains("show-tick")&&(this.options.showTick=!0),this.$newElement=this.createDropdown(),this.$element.after(this.$newElement).prependTo(this.$newElement),n&&null===s.form&&(n.id||(n.id="form-"+this.selectId),s.setAttribute("form",n.id)),this.$button=this.$newElement.children("button"),this.options.allowClear&&(this.$clearButton=this.$button.children(".bs-select-clear-selected")),this.$menu=this.$newElement.children(W.MENU),this.$menuInner=this.$menu.children(".inner"),this.$searchbox=this.$menu.find("input"),s.classList.remove("bs-select-hidden"),this.fetchData((function(){t.render(!0),t.buildList(),requestAnimationFrame((function(){t.$element.trigger("loaded"+R)}))})),!0===this.options.dropdownAlignRight&&this.$menu[0].classList.add($.MENURIGHT),void 0!==i&&this.$button.attr("data-id",i),this.checkDisabled(),this.clickListener(),4<F.major&&(this.dropdown=new H(this.$button[0])),this.options.liveSearch?(this.liveSearchListener(),this.focusedParent=this.$searchbox[0]):this.focusedParent=this.$menuInner[0],this.setStyle(),this.setWidth(),this.options.container?this.selectPosition():this.$element.on("hide"+R,(function(){var e,i;t.isVirtual()&&(i=(e=t.$menuInner[0]).firstChild.cloneNode(!1),e.replaceChild(i,e.firstChild),e.scrollTop=0)})),this.$menu.data("this",this),this.$newElement.data("this",this),this.options.mobile&&this.mobile(),this.$newElement.on({"hide.bs.dropdown":function(e){t.$element.trigger("hide"+R,e)},"hidden.bs.dropdown":function(e){t.$element.trigger("hidden"+R,e)},"show.bs.dropdown":function(e){t.$element.trigger("show"+R,e)},"shown.bs.dropdown":function(e){t.$element.trigger("shown"+R,e)}}),s.hasAttribute("required")&&this.$element.on("invalid"+R,(function(){t.$button[0].classList.add("bs-invalid"),t.$element.on("shown"+R+".invalid",(function(){t.$element.val(t.$element.val()).off("shown"+R+".invalid")})).on("rendered"+R,(function(){this.validity.valid&&t.$button[0].classList.remove("bs-invalid"),t.$element.off("rendered"+R)})),t.$button.on("blur"+R,(function(){t.$element.trigger("focus").trigger("blur"),t.$button.off("blur"+R)}))})),n&&e(n).on("reset"+R,(function(){requestAnimationFrame((function(){t.render()}))}))},createDropdown:function(){var t=this.multiple||this.options.showTick?" show-tick":"",i=this.multiple?' aria-multiselectable="true"':"",s="",n=this.autofocus?" autofocus":"";F.major<4&&this.$element.parent().hasClass("input-group")&&(s=" input-group-btn");var a="",o="",r="",l="",h="";return this.options.header&&(a='<div class="'+$.POPOVERHEADER+'"><button type="button" class="close" aria-hidden="true">&times;</button>'+this.options.header+"</div>"),this.options.liveSearch&&(o='<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"'+(null===this.options.liveSearchPlaceholder?"":' placeholder="'+N(this.options.liveSearchPlaceholder)+'"')+' role="combobox" aria-label="Search" aria-controls="'+this.selectId+'" aria-autocomplete="list"></div>'),this.multiple&&this.options.actionsBox&&(r='<div class="bs-actionsbox"><div class="btn-group btn-group-sm"><button type="button" class="actions-btn bs-select-all btn '+$.BUTTONCLASS+'">'+this.options.selectAllText+'</button><button type="button" class="actions-btn bs-deselect-all btn '+$.BUTTONCLASS+'">'+this.options.deselectAllText+"</button></div></div>"),this.multiple&&this.options.doneButton&&(l='<div class="bs-donebutton"><div class="btn-group"><button type="button" class="btn btn-sm '+$.BUTTONCLASS+'">'+this.options.doneButtonText+"</button></div></div>"),this.options.allowClear&&(h='<span class="close bs-select-clear-selected" title="'+this.options.deselectAllText+'"><span>&times;</span>'),t='<div class="dropdown bootstrap-select'+t+s+'"><button type="button" tabindex="-1" class="'+this.options.styleBase+' dropdown-toggle" '+("static"===this.options.display?'data-display="static"':"")+W.DATA_TOGGLE+n+' role="combobox" aria-owns="'+this.selectId+'" aria-haspopup="listbox" aria-expanded="false"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">&nbsp;</div></div> </div>'+h+"</span>"+("4"<=F.major?"":'<span class="bs-caret">'+this.options.template.caret+"</span>")+'</button><div class="'+$.MENU+" "+("4"<=F.major?"":$.SHOW)+'">'+a+o+r+'<div class="inner '+$.SHOW+'" role="listbox" id="'+this.selectId+'" tabindex="-1" '+i+'><ul class="'+$.MENU+" inner "+("4"<=F.major?$.SHOW:"")+'" role="presentation"></ul></div>'+l+"</div></div>",e(t)},setPositionData:function(){this.selectpicker.view.canHighlight=[],this.selectpicker.view.size=0,this.selectpicker.view.firstHighlightIndex=!1;for(var e=0;e<this.selectpicker.current.data.length;e++){var t=this.selectpicker.current.data[e],i=!0;"divider"===t.type?(i=!1,t.height=this.sizeInfo.dividerHeight):"optgroup-label"===t.type?(i=!1,t.height=this.sizeInfo.dropdownHeaderHeight):t.height=this.sizeInfo.liHeight,t.disabled&&(i=!1),this.selectpicker.view.canHighlight.push(i),i&&(this.selectpicker.view.size++,t.posinset=this.selectpicker.view.size,!1===this.selectpicker.view.firstHighlightIndex&&(this.selectpicker.view.firstHighlightIndex=e)),t.position=(0===e?0:this.selectpicker.current.data[e-1].position)+t.height}},isVirtual:function(){return!1!==this.options.virtualScroll&&this.selectpicker.main.data.length>=this.options.virtualScroll||!0===this.options.virtualScroll},createView:function(t,i,s){var n=this,a=0;function o(e,i){var s,a=n.selectpicker.current.data.length,r=[],l=!0,h=n.isVirtual();n.selectpicker.view.scrollTop=e;for(var c,u=n.options.chunkSize,m=Math.ceil(a/u)||1,p=0;p<m;p++){var f=p===m-1?a:(p+1)*u;if(r[p]=[p*u+(p?1:0),f],!a)break;void 0===s&&e-1<=n.selectpicker.current.data[f-1].position-n.sizeInfo.menuInnerHeight&&(s=p)}if(void 0===s&&(s=0),w=[n.selectpicker.view.position0,n.selectpicker.view.position1],_=Math.max(0,s-1),v=Math.min(m-1,s+1),n.selectpicker.view.position0=!1!==h&&Math.max(0,r[_][0])||0,n.selectpicker.view.position1=!1===h?a:Math.min(a,r[v][1])||0,_=w[0]!==n.selectpicker.view.position0||w[1]!==n.selectpicker.view.position1,void 0!==n.activeElement&&(i&&(n.activeElement!==n.selectedElement&&n.defocusItem(n.activeElement),n.activeElement=void 0),n.activeElement!==n.selectedElement&&n.defocusItem(n.selectedElement)),void 0!==n.prevActiveElement&&n.prevActiveElement!==n.activeElement&&n.prevActiveElement!==n.selectedElement&&n.defocusItem(n.prevActiveElement),i||_||n.selectpicker.current.hasMore){if(v=n.selectpicker.view.visibleElements?n.selectpicker.view.visibleElements.slice():[],n.selectpicker.view.visibleElements=!1===h?n.selectpicker.current.elements:n.selectpicker.current.elements.slice(n.selectpicker.view.position0,n.selectpicker.view.position1),n.setOptionStatus(),(t||!1===h&&i)&&(w=v,c=n.selectpicker.view.visibleElements,l=!(w.length===c.length&&w.every((function(e,t){return e===c[t]})))),(i||!0===h)&&l){var _=n.$menuInner[0],g=document.createDocumentFragment(),v=_.firstChild.cloneNode(!1),b=n.selectpicker.view.visibleElements,y=[];_.replaceChild(v,_.firstChild);p=0;for(var w,x=b.length;p<x;p++){var D,C,T=b[p];n.options.sanitize&&(D=T.lastChild)&&(C=n.selectpicker.current.data[p+n.selectpicker.view.position0])&&C.content&&!C.sanitized&&(y.push(D),C.sanitized=!0),g.appendChild(T)}n.options.sanitize&&y.length&&d(y,n.options.whiteList,n.options.sanitizeFn),!0===h?(w=0===n.selectpicker.view.position0?0:n.selectpicker.current.data[n.selectpicker.view.position0-1].position,l=n.selectpicker.view.position1>a-1?0:n.selectpicker.current.data[a-1].position-n.selectpicker.current.data[n.selectpicker.view.position1-1].position,_.firstChild.style.marginTop=w+"px",_.firstChild.style.marginBottom=l+"px"):(_.firstChild.style.marginTop=0,_.firstChild.style.marginBottom=0),_.firstChild.appendChild(g),!0===h&&n.sizeInfo.hasScrollBar&&(v=_.firstChild.offsetWidth,i&&v<n.sizeInfo.menuInnerInnerWidth&&n.sizeInfo.totalMenuWidth>n.sizeInfo.selectWidth?_.firstChild.style.minWidth=n.sizeInfo.menuInnerInnerWidth+"px":v>n.sizeInfo.menuInnerInnerWidth&&(n.$menu[0].style.minWidth=0,(w=_.firstChild.offsetWidth)>n.sizeInfo.menuInnerInnerWidth&&(n.sizeInfo.menuInnerInnerWidth=w,_.firstChild.style.minWidth=n.sizeInfo.menuInnerInnerWidth+"px"),n.$menu[0].style.minWidth=""))}(!t&&n.options.source.data||t&&n.options.source.search)&&n.selectpicker.current.hasMore&&s===m-1&&0<e&&(l=Math.floor(s*n.options.chunkSize/n.options.source.pageSize)+2,n.fetchData((function(){n.render(),n.buildList(a,t),n.setPositionData(),o(e)}),t?"search":"data",l,t?n.selectpicker.search.previousValue:void 0))}n.prevActiveElement=n.activeElement,n.options.liveSearch?t&&i&&(n.selectpicker.view.canHighlight[h=0]||(h=1+n.selectpicker.view.canHighlight.slice(1).indexOf(!0)),v=n.selectpicker.view.visibleElements[h],n.defocusItem(n.selectpicker.view.currentActive),n.activeElement=(n.selectpicker.current.data[h]||{}).element,n.focusItem(v)):n.$menuInner.trigger("focus")}this.selectpicker.isSearching=t,this.selectpicker.current=t?this.selectpicker.search:this.selectpicker.main,this.setPositionData(),i&&(s?a=this.$menuInner[0].scrollTop:n.multiple||"number"==typeof(s=((i=n.$element[0]).options[i.selectedIndex]||{}).liIndex)&&!1!==n.options.size&&(s=(i=n.selectpicker.main.data[s])&&i.position)&&(a=s-(n.sizeInfo.menuInnerHeight+n.sizeInfo.liHeight)/2)),o(a,!0),this.$menuInner.off("scroll.createView").on("scroll.createView",(function(e,t){n.noScroll||o(this.scrollTop,t),n.noScroll=!1})),e(window).off("resize"+R+"."+this.selectId+".createView").on("resize"+R+"."+this.selectId+".createView",(function(){n.$newElement.hasClass($.SHOW)&&o(n.$menuInner[0].scrollTop)}))},focusItem:function(e,t,i){var s;e&&(t=t||this.selectpicker.current.data[this.selectpicker.current.elements.indexOf(this.activeElement)],(s=e.firstChild)&&(s.setAttribute("aria-setsize",this.selectpicker.view.size),s.setAttribute("aria-posinset",t.posinset),!0!==i&&(this.focusedParent.setAttribute("aria-activedescendant",s.id),e.classList.add("active"),s.classList.add("active"))))},defocusItem:function(e){e&&(e.classList.remove("active"),e.firstChild&&e.firstChild.classList.remove("active"))},setPlaceholder:function(){var e,t,i,s,n,a,o,r=this,l=!1;return!this.options.placeholder&&!this.options.allowClear||this.multiple||(this.selectpicker.view.titleOption||(this.selectpicker.view.titleOption=document.createElement("option")),e=this.$element[0],t=!(l=!0),i=!this.selectpicker.view.titleOption.parentNode,s=e.selectedIndex,n=e.options[s],a=(a=e.querySelector("select > *:not(:disabled)"))?a.index:0,o=(o=window.performance&&window.performance.getEntriesByType("navigation"))&&o.length?"back_forward"!==o[0].type:2!==window.performance.navigation.type,i&&(this.selectpicker.view.titleOption.className="bs-title-option",this.selectpicker.view.titleOption.value="",t=!n||s===a&&!1===n.defaultSelected&&void 0===this.$element.data("selected")),!i&&0===this.selectpicker.view.titleOption.index||e.insertBefore(this.selectpicker.view.titleOption,e.firstChild),t&&o?e.selectedIndex=0:"complete"!==document.readyState&&window.addEventListener("pageshow",(function(){r.selectpicker.view.displayedValue!==e.value&&r.render()}))),l},fetchData:function(e,t,i,s){i=i||1,t=t||"data";var n,a=this,o=this.options.source[t];o?(this.options.virtualScroll=!0,"function"==typeof o?o.call(this,(function(i,s,o){var r=a.selectpicker["search"===t?"search":"main"];r.hasMore=s,r.totalItems=o,n=a.buildData(i,t),e.call(a,n),a.$element.trigger("fetched"+R)}),i,s):Array.isArray(o)&&(n=a.buildData(o,t),e.call(a,n))):(n=this.buildData(!1,t),e.call(a,n))},buildData:function(t,i){var s=this,n=!1===t?K.fromOption:K.fromDataSource,a=':not([hidden]):not([data-hidden="true"]):not([style*="display: none"])',o=[],r=this.selectpicker.main.data?this.selectpicker.main.data.length:0,l=0,h=this.setPlaceholder()&&!t?1:0,d=("search"===i&&(r=this.selectpicker.search.data.length),this.options.hideDisabled&&(a+=":not(:disabled)"),t?t.filter(q,this):this.$element[0].querySelectorAll("select > *"+a));function c(e){var t=o[o.length-1];t&&"divider"===t.type&&(t.optID||e.optID)||((e=e||{}).type="divider",o.push(e))}function u(i,a){var l,h,d;(a=a||{}).divider=n(i,"divider"),!0===a.divider?c({optID:a.optID}):(l=o.length+r,h=(h=n(i,"style"))?N(h):"",d=(i.className||"")+(a.optgroupClass||""),a.optID&&(d="opt "+d),a.optionClass=d.trim(),a.inlineStyle=h,a.text=n(i,"text"),a.title=n(i,"title"),a.content=n(i,"content"),a.tokens=n(i,"tokens"),a.subtext=n(i,"subtext"),a.icon=n(i,"icon"),a.display=a.content||a.text,a.value=void 0===i.value?i.text:i.value,a.type="option",a.index=l,a.option=i.option||i,a.option.liIndex=l,a.selected=!!i.selected,a.disabled=a.disabled||!!i.disabled,!1!==t&&(s.selectpicker.optionValuesDataMap[a.value]?a=e.extend(s.selectpicker.optionValuesDataMap[a.value],a):s.selectpicker.optionValuesDataMap[a.value]=a),o.push(a))}function m(e,i){var s=i[e],r=!(e-1<h)&&i[e-1],d=(i=i[e+1],t?s.children.filter(q,this):s.querySelectorAll("option"+a));if(d.length){var m,p,f={display:N(n(_,"label")),subtext:n(s,"subtext"),icon:n(s,"icon"),type:"optgroup-label",optgroupClass:" "+(s.className||""),optgroup:s};l++,r&&c({optID:l}),f.optID=l,o.push(f);for(var g=0,v=d.length;g<v;g++){var b=d[g];0===g&&(p=(m=o.length-1)+v),u(b,{headerIndex:m,lastIndex:p,optID:f.optID,optgroupClass:f.optgroupClass,disabled:s.disabled})}i&&c({optID:l})}}for(var p=d.length,f=h;f<p;f++){var _=d[f],g=_.children;g&&g.length?m.call(this,f,d):u.call(this,_,{})}switch(i){case"data":this.selectpicker.main.data||(this.selectpicker.main.data=[]),Array.prototype.push.apply(this.selectpicker.main.data,o),this.selectpicker.current.data=this.selectpicker.main.data;break;case"search":Array.prototype.push.apply(this.selectpicker.search.data,o)}return o},buildList:function(e,t){var i=this,s=(t?this.selectpicker.search:this.selectpicker.main).data,n=[],a=0;!i.options.showTick&&!i.multiple||U.checkMark.parentNode||(U.checkMark.className=this.options.iconBase+" "+i.options.tickIcon+" check-mark",U.a.appendChild(U.checkMark));for(var o=s.length,r=e||0;r<o;r++){var l,h=(c=l=d=h=void 0,n),d=s[r],c=0;switch(d.type){case"divider":l=G.li(!1,$.DIVIDER,d.optID?d.optID+"div":void 0);break;case"option":(l=G.li(G.a(G.text.call(i,d),d.optionClass,d.inlineStyle),"",d.optID)).firstChild&&(l.firstChild.id=i.selectId+"-"+d.index);break;case"optgroup-label":l=G.li(G.label.call(i,d),"dropdown-header"+d.optgroupClass,d.optID)}d.element?d.element.innerHTML=l.innerHTML:d.element=l,h.push(d.element),d.display&&(c+=d.display.length),d.subtext&&(c+=d.subtext.length),d.icon&&(c+=1),a<c&&(a=c,i.selectpicker.view.widestOption=h[h.length-1])}e?t?Array.prototype.push.apply(this.selectpicker.search.elements,n):(Array.prototype.push.apply(this.selectpicker.main.elements,n),this.selectpicker.current.elements=this.selectpicker.main.elements):t?this.selectpicker.search.elements=n:this.selectpicker.main.elements=this.selectpicker.current.elements=n},findLis:function(){return this.$menuInner.find(".inner > li")},render:function(e){var t=this,i=this.$element[0],s=this.setPlaceholder()&&0===i.selectedIndex,n=b.call(this),a=n.length,o=y.call(this,n),r=this.$button[0],l=r.querySelector(".filter-option-inner-inner"),h=document.createTextNode(this.options.multipleSeparator),c=U.fragment.cloneNode(!1),u=!1;if(this.options.source.data&&e&&(n.map((function e(i){i.selected?t.createOption(i,!0):i.children&&i.children.length&&i.children.map(e)})),i.appendChild(this.selectpicker.main.optionQueue),s=s&&0===i.selectedIndex),r.classList.toggle("bs-placeholder",t.multiple?!a:!o&&0!==o),t.multiple||1!==n.length||(t.selectpicker.view.displayedValue=o),"static"===this.options.selectedTextFormat)c=G.text.call(this,{text:this.options.placeholder},!0);else if(!1===(this.multiple&&-1!==this.options.selectedTextFormat.indexOf("count")&&0<a&&(1<(e=this.options.selectedTextFormat.split(">")).length&&a>e[1]||1===e.length&&2<=a))){if(!s){for(var m=0;m<a&&m<50;m++){var p=n[m],f={};p&&(this.multiple&&0<m&&c.appendChild(h.cloneNode(!1)),p.title?f.text=p.title:p.content&&t.options.showContent?(f.content=p.content.toString(),u=!0):(t.options.showIcon&&(f.icon=p.icon),t.options.showSubtext&&!t.multiple&&p.subtext&&(f.subtext=" "+p.subtext),f.text=p.text.trim()),c.appendChild(G.text.call(this,f,!0)))}49<a&&c.appendChild(document.createTextNode("..."))}}else i=':not([hidden]):not([data-hidden="true"]):not([data-divider="true"]):not([style*="display: none"])',o=(this.options.hideDisabled&&(i+=":not(:disabled)"),this.$element[0].querySelectorAll("select > option"+i+", optgroup"+i+" option"+i).length),e="function"==typeof this.options.countSelectedText?this.options.countSelectedText(a,o):this.options.countSelectedText,c=G.text.call(this,{text:e.replace("{0}",a.toString()).replace("{1}",o.toString())},!0);c.childNodes.length||(c=G.text.call(this,{text:this.options.placeholder||this.options.noneSelectedText},!0)),r.title=c.textContent.replace(/<[^>]*>?/g,"").trim(),this.options.sanitize&&u&&d([c],t.options.whiteList,t.options.sanitizeFn),l.innerHTML="",l.appendChild(c),F.major<4&&this.$newElement[0].classList.contains("bs3-has-addon")&&(s=r.querySelector(".filter-expand"),(i=l.cloneNode(!0)).className="filter-expand",s?r.replaceChild(i,s):r.appendChild(i)),this.$element.trigger("rendered"+R)},setStyle:function(e,t){var i=this.$button[0],s=this.$newElement[0],n=this.options.style.trim();this.$element.attr("class")&&this.$newElement.addClass(this.$element.attr("class").replace(/selectpicker|mobile-device|bs-select-hidden|validate\[.*\]/gi,"")),F.major<4&&(s.classList.add("bs3"),s.parentNode.classList&&s.parentNode.classList.contains("input-group")&&(s.previousElementSibling||s.nextElementSibling)&&(s.previousElementSibling||s.nextElementSibling).classList.contains("input-group-addon")&&s.classList.add("bs3-has-addon")),s=e?e.trim():n,"add"==t?s&&i.classList.add.apply(i.classList,s.split(" ")):"remove"==t?s&&i.classList.remove.apply(i.classList,s.split(" ")):(n&&i.classList.remove.apply(i.classList,n.split(" ")),s&&i.classList.add.apply(i.classList,s.split(" ")))},liHeight:function(t){if(t||!1!==this.options.size&&!Object.keys(this.sizeInfo).length){t=U.div.cloneNode(!1);var i,s=U.div.cloneNode(!1),n=U.div.cloneNode(!1),a=document.createElement("ul"),o=U.li.cloneNode(!1),r=U.li.cloneNode(!1),l=U.a.cloneNode(!1),h=U.span.cloneNode(!1),d=this.options.header&&0<this.$menu.find("."+$.POPOVERHEADER).length?this.$menu.find("."+$.POPOVERHEADER)[0].cloneNode(!0):null,c=this.options.liveSearch?U.div.cloneNode(!1):null,u=this.options.actionsBox&&this.multiple&&0<this.$menu.find(".bs-actionsbox").length?this.$menu.find(".bs-actionsbox")[0].cloneNode(!0):null,m=this.options.doneButton&&this.multiple&&0<this.$menu.find(".bs-donebutton").length?this.$menu.find(".bs-donebutton")[0].cloneNode(!0):null,p=this.$element[0].options[0];if(this.sizeInfo.selectWidth=this.$newElement[0].offsetWidth,h.className="text",l.className="dropdown-item "+(p?p.className:""),t.className=this.$menu[0].parentNode.className+" "+$.SHOW,t.style.width=0,"auto"===this.options.width&&(s.style.minWidth=0),s.className=$.MENU+" "+$.SHOW,n.className="inner "+$.SHOW,a.className=$.MENU+" inner "+("4"<=F.major?$.SHOW:""),o.className=$.DIVIDER,r.className="dropdown-header",h.appendChild(document.createTextNode("​")),this.selectpicker.current.data.length)for(var f=0;f<this.selectpicker.current.data.length;f++){var _=this.selectpicker.current.data[f];if("option"===_.type&&"none"!==e(_.element.firstChild).css("display")){i=_.element;break}}else i=U.li.cloneNode(!1),l.appendChild(h),i.appendChild(l);r.appendChild(h.cloneNode(!0)),this.selectpicker.view.widestOption&&a.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),a.appendChild(i),a.appendChild(o),a.appendChild(r),d&&s.appendChild(d),c&&(p=document.createElement("input"),c.className="bs-searchbox",p.className="form-control",c.appendChild(p),s.appendChild(c)),u&&s.appendChild(u),n.appendChild(a),s.appendChild(n),m&&s.appendChild(m),t.appendChild(s),document.body.appendChild(t),l=i.offsetHeight,h=r?r.offsetHeight:0,p=d?d.offsetHeight:0,a=c?c.offsetHeight:0,r=u?u.offsetHeight:0,d=m?m.offsetHeight:0,c=e(o).outerHeight(!0),u=window.getComputedStyle(s),m=s.offsetWidth,u={vert:(o={vert:T(u.paddingTop)+T(u.paddingBottom)+T(u.borderTopWidth)+T(u.borderBottomWidth),horiz:T(u.paddingLeft)+T(u.paddingRight)+T(u.borderLeftWidth)+T(u.borderRightWidth)}).vert+T(u.marginTop)+T(u.marginBottom)+2,horiz:o.horiz+T(u.marginLeft)+T(u.marginRight)+2},n.style.overflowY="scroll",n=s.offsetWidth-m,document.body.removeChild(t),this.sizeInfo.liHeight=l,this.sizeInfo.dropdownHeaderHeight=h,this.sizeInfo.headerHeight=p,this.sizeInfo.searchHeight=a,this.sizeInfo.actionsHeight=r,this.sizeInfo.doneButtonHeight=d,this.sizeInfo.dividerHeight=c,this.sizeInfo.menuPadding=o,this.sizeInfo.menuExtras=u,this.sizeInfo.menuWidth=m,this.sizeInfo.menuInnerInnerWidth=m-o.horiz,this.sizeInfo.totalMenuWidth=this.sizeInfo.menuWidth,this.sizeInfo.scrollBarWidth=n,this.sizeInfo.selectHeight=this.$newElement[0].offsetHeight,this.setPositionData()}},getSelectPosition:function(){var t,i=e(window),s=this.$newElement.offset(),n=e(this.options.container);this.options.container&&n.length&&!n.is("body")?((t=n.offset()).top+=parseInt(n.css("borderTopWidth")),t.left+=parseInt(n.css("borderLeftWidth"))):t={top:0,left:0},n=this.options.windowPadding;this.sizeInfo.selectOffsetTop=s.top-t.top-i.scrollTop(),this.sizeInfo.selectOffsetBot=i.height()-this.sizeInfo.selectOffsetTop-this.sizeInfo.selectHeight-t.top-n[2],this.sizeInfo.selectOffsetLeft=s.left-t.left-i.scrollLeft(),this.sizeInfo.selectOffsetRight=i.width()-this.sizeInfo.selectOffsetLeft-this.sizeInfo.selectWidth-t.left-n[1],this.sizeInfo.selectOffsetTop-=n[0],this.sizeInfo.selectOffsetLeft-=n[3]},setMenuSize:function(e){this.getSelectPosition();var t,i,s,n,a,o,r=this.sizeInfo.selectWidth,l=this.sizeInfo.liHeight,h=this.sizeInfo.headerHeight,d=this.sizeInfo.searchHeight,c=this.sizeInfo.actionsHeight,u=this.sizeInfo.doneButtonHeight,m=this.sizeInfo.dividerHeight,p=this.sizeInfo.menuPadding,f=0;if(this.options.dropupAuto&&(o=l*this.selectpicker.current.data.length+p.vert,o=this.sizeInfo.selectOffsetTop-this.sizeInfo.selectOffsetBot>this.sizeInfo.menuExtras.vert&&o+this.sizeInfo.menuExtras.vert+50>this.sizeInfo.selectOffsetBot,!0===this.selectpicker.isSearching&&(o=this.selectpicker.dropup),this.$newElement.toggleClass($.DROPUP,o),this.selectpicker.dropup=o),"auto"===this.options.size)o=3<this.selectpicker.current.data.length?3*this.sizeInfo.liHeight+this.sizeInfo.menuExtras.vert-2:0,i=this.sizeInfo.selectOffsetBot-this.sizeInfo.menuExtras.vert,s=o+h+d+c+u,a=Math.max(o-p.vert,0),t=(n=i=this.$newElement.hasClass($.DROPUP)?this.sizeInfo.selectOffsetTop-this.sizeInfo.menuExtras.vert:i)-h-d-c-u-p.vert;else if(this.options.size&&"auto"!=this.options.size&&this.selectpicker.current.elements.length>this.options.size){for(var _=0;_<this.options.size;_++)"divider"===this.selectpicker.current.data[_].type&&f++;t=(i=l*this.options.size+f*m+p.vert)-p.vert,n=i+h+d+c+u,s=a=""}this.$menu.css({"max-height":n+"px",overflow:"hidden","min-height":s+"px"}),this.$menuInner.css({"max-height":t+"px",overflow:"hidden auto","min-height":a+"px"}),this.sizeInfo.menuInnerHeight=Math.max(t,1),this.selectpicker.current.data.length&&this.selectpicker.current.data[this.selectpicker.current.data.length-1].position>this.sizeInfo.menuInnerHeight&&(this.sizeInfo.hasScrollBar=!0,this.sizeInfo.totalMenuWidth=this.sizeInfo.menuWidth+this.sizeInfo.scrollBarWidth),"auto"===this.options.dropdownAlignRight&&this.$menu.toggleClass($.MENURIGHT,this.sizeInfo.selectOffsetLeft>this.sizeInfo.selectOffsetRight&&this.sizeInfo.selectOffsetRight<this.sizeInfo.totalMenuWidth-r),this.dropdown&&this.dropdown._popper&&this.dropdown._popper.update()},setSize:function(t){var i,s;this.liHeight(t),this.options.header&&this.$menu.css("padding-top",0),!1!==this.options.size&&(i=this,s=e(window),this.setMenuSize(),this.options.liveSearch&&this.$searchbox.off("input.setMenuSize propertychange.setMenuSize").on("input.setMenuSize propertychange.setMenuSize",(function(){return i.setMenuSize()})),"auto"===this.options.size?s.off("resize"+R+"."+this.selectId+".setMenuSize scroll"+R+"."+this.selectId+".setMenuSize").on("resize"+R+"."+this.selectId+".setMenuSize scroll"+R+"."+this.selectId+".setMenuSize",(function(){return i.setMenuSize()})):this.options.size&&"auto"!=this.options.size&&this.selectpicker.current.elements.length>this.options.size&&s.off("resize"+R+"."+this.selectId+".setMenuSize scroll"+R+"."+this.selectId+".setMenuSize")),this.createView(!1,!0,t)},setWidth:function(){var e=this;"auto"===this.options.width?requestAnimationFrame((function(){e.$menu.css("min-width","0"),e.$element.on("loaded"+R,(function(){e.liHeight(),e.setMenuSize();var t=e.$newElement.clone().appendTo("body"),i=t.css("width","auto").children("button").outerWidth();t.remove(),e.sizeInfo.selectWidth=Math.max(e.sizeInfo.totalMenuWidth,i),e.$newElement.css("width",e.sizeInfo.selectWidth+"px")}))})):"fit"===this.options.width?(this.$menu.css("min-width",""),this.$newElement.css("width","").addClass("fit-width")):this.options.width?(this.$menu.css("min-width",""),this.$newElement.css("width",this.options.width)):(this.$menu.css("min-width",""),this.$newElement.css("width","")),this.$newElement.hasClass("fit-width")&&"fit"!==this.options.width&&this.$newElement[0].classList.remove("fit-width")},selectPosition:function(){function t(t){var r={},l=a.options.display||!!e.fn.dropdown.Constructor.Default&&e.fn.dropdown.Constructor.Default.display;a.$bsContainer.addClass(t.attr("class").replace(/form-control|fit-width/gi,"")).toggleClass($.DROPUP,t.hasClass($.DROPUP)),i=t.offset(),o.is("body")?s={top:0,left:0}:((s=o.offset()).top+=parseInt(o.css("borderTopWidth"))-o.scrollTop(),s.left+=parseInt(o.css("borderLeftWidth"))-o.scrollLeft()),n=t.hasClass($.DROPUP)?0:t[0].offsetHeight,(F.major<4||"static"===l)&&(r.top=i.top-s.top+n,r.left=i.left-s.left),r.width=t[0].offsetWidth,a.$bsContainer.css(r)}this.$bsContainer=e('<div class="bs-container" />');var i,s,n,a=this,o=e(this.options.container);this.$button.on("click.bs.dropdown.data-api",(function(){a.isDisabled()||(t(a.$newElement),a.$bsContainer.appendTo(a.options.container).toggleClass($.SHOW,!a.$button.hasClass($.SHOW)).append(a.$menu))})),e(window).off("resize"+R+"."+this.selectId+" scroll"+R+"."+this.selectId).on("resize"+R+"."+this.selectId+" scroll"+R+"."+this.selectId,(function(){a.$newElement.hasClass($.SHOW)&&t(a.$newElement)})),this.$element.on("hide"+R,(function(){a.$menu.data("height",a.$menu.height()),a.$bsContainer.detach()}))},createOption:function(e,t){var i,s=e.option||e;s&&1!==s.nodeType&&(i=(t?U.selectedOption:U.option).cloneNode(!0),void 0!==s.value&&(i.value=s.value),i.textContent=s.text,i.selected=!0,void 0!==s.liIndex?i.liIndex=s.liIndex:t||(i.liIndex=e.index),e.option=i,this.selectpicker.main.optionQueue.appendChild(i))},setOptionStatus:function(e){var t=this;if(t.noScroll=!1,t.selectpicker.view.visibleElements&&t.selectpicker.view.visibleElements.length){for(var i=0;i<t.selectpicker.view.visibleElements.length;i++){var s=t.selectpicker.current.data[i+t.selectpicker.view.position0];s.option&&(!0!==e&&t.setDisabled(s),t.setSelected(s))}this.options.source.data&&this.$element[0].appendChild(this.selectpicker.main.optionQueue)}},setSelected:function(e,t){t=void 0===t?e.selected:t;var i,s=e.element,n=void 0!==this.activeElement,a=this.activeElement===s||t&&!this.multiple&&!n;s&&(void 0!==t&&(e.selected=t,e.option&&(e.option.selected=t)),t&&this.options.source.data&&this.createOption(e,!1),i=s.firstChild,t&&(this.selectedElement=s),s.classList.toggle("selected",t),a?(this.focusItem(s,e),this.selectpicker.view.currentActive=s,this.activeElement=s):this.defocusItem(s),i&&(i.classList.toggle("selected",t),t?i.setAttribute("aria-selected",!0):this.multiple?i.setAttribute("aria-selected",!1):i.removeAttribute("aria-selected")),a||n||!t||void 0===this.prevActiveElement||(e=this.prevActiveElement,this.defocusItem(e)))},setDisabled:function(e){var t,i=e.disabled;(e=e.element)&&(t=e.firstChild,e.classList.toggle($.DISABLED,i),t&&("4"<=F.major&&t.classList.toggle($.DISABLED,i),i?(t.setAttribute("aria-disabled",i),t.setAttribute("tabindex",-1)):(t.removeAttribute("aria-disabled"),t.setAttribute("tabindex",0))))},isDisabled:function(){return this.$element[0].disabled},checkDisabled:function(){this.isDisabled()?(this.$newElement[0].classList.add($.DISABLED),this.$button.addClass($.DISABLED).attr("aria-disabled",!0)):this.$button[0].classList.contains($.DISABLED)&&(this.$newElement[0].classList.remove($.DISABLED),this.$button.removeClass($.DISABLED).attr("aria-disabled",!1))},clickListener:function(){var t=this,i=e(document);function s(){(t.options.liveSearch?t.$searchbox:t.$menuInner).trigger("focus")}function n(){t.dropdown&&t.dropdown._popper&&t.dropdown._popper.state?s():requestAnimationFrame(n)}i.data("spaceSelect",!1),this.$button.on("keyup",(function(e){/(32)/.test(e.keyCode.toString(10))&&i.data("spaceSelect")&&(e.preventDefault(),i.data("spaceSelect",!1))})),this.$newElement.on("show.bs.dropdown",(function(){t.dropdown||"4"!==F.major||(t.dropdown=t.$button.data("bs.dropdown"),t.dropdown._menu=t.$menu[0])})),this.$button.on("click.bs.dropdown.data-api",(function(e){var i,s,n;t.options.allowClear&&(i=e.target,s=t.$clearButton[0],(i=/MSIE|Trident/.test(window.navigator.userAgent)?document.elementFromPoint(e.clientX,e.clientY):i)!==s&&i.parentElement!==s||(e.stopImmediatePropagation(),t.multiple?t.deselectAll():(s=(i=t.$element[0]).value,e=i.selectedIndex,(n=!!(n=i.options[e])&&t.selectpicker.main.data[n.liIndex])&&t.setSelected(n,!1),i.selectedIndex=0,x=[e,!1,s],t.$element.triggerNative("change")),t.$newElement.hasClass($.SHOW)&&(t.options.liveSearch&&t.$searchbox.trigger("focus"),t.createView(!1)))),t.$newElement.hasClass($.SHOW)||t.setSize()})),this.$element.on("shown"+R,(function(){t.$menuInner[0].scrollTop!==t.selectpicker.view.scrollTop&&(t.$menuInner[0].scrollTop=t.selectpicker.view.scrollTop),3<F.major?requestAnimationFrame(n):s()})),this.$menuInner.on("mouseenter","li a",(function(e){var i=this.parentElement,s=t.isVirtual()?t.selectpicker.view.position0:0,n=Array.prototype.indexOf.call(i.parentElement.children,i);n=t.selectpicker.current.data[n+s];t.focusItem(i,n,!0)})),this.$menuInner.on("click","li a",(function(i,s){var n=e(this),a=t.$element[0],o=t.isVirtual()?t.selectpicker.view.position0:0,r=t.selectpicker.current.data[n.parent().index()+o],l=(o=r.element,y.call(t)),h=a.selectedIndex,d=!!(d=a.options[h])&&t.selectpicker.main.data[d.liIndex],c=!0;if(t.multiple&&1!==t.options.maxOptions&&i.stopPropagation(),i.preventDefault(),!t.isDisabled()&&!n.parent().hasClass($.DISABLED)){i=r.option,n=e(i);var u=i.selected,m=t.selectpicker.current.data.find((function(e){return e.optID===r.optID&&"optgroup-label"===e.type})),p=m?m.optgroup:void 0,f=(m=p instanceof Element?K.fromOption:K.fromDataSource,p&&p.children),_=parseInt(t.options.maxOptions);m=p&&parseInt(m(p,"maxOptions"))||!1;if((s=o===t.activeElement||s)||(t.prevActiveElement=t.activeElement,t.activeElement=void 0),t.multiple&&1!==_){if(t.setSelected(r,!u),t.focusedParent.focus(),!1!==_||!1!==m){o=_<b.call(t).length;var g=0;if(p&&p.children)for(var v=0;v<p.children.length;v++)p.children[v].selected&&g++;if(s=m<g,_&&o||m&&s)if(_&&1===_)a.selectedIndex=-1,t.setOptionStatus(!0);else if(m&&1===m){for(v=0;v<f.length;v++){var w=f[v];t.setSelected(t.selectpicker.current.data[w.liIndex],!1)}t.setSelected(r,!0)}else{var D=(u="function"==typeof(u="string"==typeof t.options.maxOptionsText?[t.options.maxOptionsText,t.options.maxOptionsText]:t.options.maxOptionsText)?u(_,m):u)[0].replace("{n}",_),C=u[1].replace("{n}",m),T=e('<div class="notify"></div>');u[2]&&(D=D.replace("{var}",u[2][1<_?0:1]),C=C.replace("{var}",u[2][1<m?0:1])),t.$menu.append(T),_&&o&&(T.append(e("<div>"+D+"</div>")),c=!1,t.$element.trigger("maxReached"+R)),m&&s&&(T.append(e("<div>"+C+"</div>")),c=!1,t.$element.trigger("maxReachedGrp"+R)),setTimeout((function(){t.setSelected(r,!1)}),10),T[0].classList.add("fadeOut"),setTimeout((function(){T.remove()}),1050)}}}else d&&t.setSelected(d,!1),t.setSelected(r,!0);t.options.source.data&&t.$element[0].appendChild(t.selectpicker.main.optionQueue),!t.multiple||t.multiple&&1===t.options.maxOptions?t.$button.trigger("focus"):t.options.liveSearch&&t.$searchbox.trigger("focus"),!c||!t.multiple&&h===a.selectedIndex||(x=[i.index,n.prop("selected"),l],t.$element.triggerNative("change"))}})),this.$menu.on("click","li."+$.DISABLED+" a, ."+$.POPOVERHEADER+", ."+$.POPOVERHEADER+" :not(.close)",(function(i){i.currentTarget==this&&(i.preventDefault(),i.stopPropagation(),(t.options.liveSearch&&!e(i.target).hasClass("close")?t.$searchbox:t.$button).trigger("focus"))})),this.$menuInner.on("click",".divider, .dropdown-header",(function(e){e.preventDefault(),e.stopPropagation(),(t.options.liveSearch?t.$searchbox:t.$button).trigger("focus")})),this.$menu.on("click","."+$.POPOVERHEADER+" .close",(function(){t.$button.trigger("click")})),this.$searchbox.on("click",(function(e){e.stopPropagation()})),this.$menu.on("click",".actions-btn",(function(i){(t.options.liveSearch?t.$searchbox:t.$button).trigger("focus"),i.preventDefault(),i.stopPropagation(),e(this).hasClass("bs-select-all")?t.selectAll():t.deselectAll()})),this.$button.on("focus"+R,(function(e){var i=t.$element[0].getAttribute("tabindex");void 0!==i&&e.originalEvent&&e.originalEvent.isTrusted&&(this.setAttribute("tabindex",i),t.$element[0].setAttribute("tabindex",-1),t.selectpicker.view.tabindex=i)})).on("blur"+R,(function(e){void 0!==t.selectpicker.view.tabindex&&e.originalEvent&&e.originalEvent.isTrusted&&(t.$element[0].setAttribute("tabindex",t.selectpicker.view.tabindex),this.setAttribute("tabindex",-1),t.selectpicker.view.tabindex=void 0)})),this.$element.on("change"+R,(function(){t.render(),t.$element.trigger("changed"+R,x),x=null})).on("focus"+R,(function(){t.options.mobile||t.$button[0].focus()}))},liveSearchListener:function(){var e=this;this.$button.on("click.bs.dropdown.data-api",(function(){e.$searchbox.val()&&(e.$searchbox.val(""),e.selectpicker.search.previousValue=void 0)})),this.$searchbox.on("click.bs.dropdown.data-api focus.bs.dropdown.data-api touchend.bs.dropdown.data-api",(function(e){e.stopPropagation()})),this.$searchbox.on("input propertychange",(function(){var t=e.$searchbox[0].value;if(e.selectpicker.search.elements=[],e.selectpicker.search.data=[],t)if(e.selectpicker.search.previousValue=t,e.options.source.search)e.fetchData((function(i){e.render(),e.buildList(void 0,!0),e.noScroll=!0,e.$menuInner.scrollTop(0),e.createView(!0),X.call(e,i,t)}),"search",0,t);else{var i=[],s=t.toUpperCase(),n={},a=[],o=e._searchStyle(),r=e.options.liveSearchNormalize;r&&(s=M(s));for(var l=0;l<e.selectpicker.main.data.length;l++){var h=e.selectpicker.main.data[l];n[l]||(n[l]=C(h,s,o,r)),n[l]&&void 0!==h.headerIndex&&-1===a.indexOf(h.headerIndex)&&(0<h.headerIndex&&(n[h.headerIndex-1]=!0,a.push(h.headerIndex-1)),n[h.headerIndex]=!0,a.push(h.headerIndex),n[h.lastIndex+1]=!0),n[l]&&"optgroup-label"!==h.type&&a.push(l)}l=0;for(var d=a.length;l<d;l++){var c=a[l],u=a[l-1];h=e.selectpicker.main.data[c],u=e.selectpicker.main.data[u];("divider"!==h.type||"divider"===h.type&&u&&"divider"!==u.type&&d-1!==l)&&(e.selectpicker.search.data.push(h),i.push(e.selectpicker.main.elements[c]))}e.activeElement=void 0,e.noScroll=!0,e.$menuInner.scrollTop(0),e.selectpicker.search.elements=i,e.createView(!0),X.call(e,i,t)}else e.selectpicker.search.previousValue&&(e.$menuInner.scrollTop(0),e.createView(!1))}))},_searchStyle:function(){return this.options.liveSearchStyle||"contains"},val:function(e){var t=this.$element[0];if(void 0===e)return this.$element.val();var i=b.call(this),s=y.call(this,i);x=[null,null,s],(e=Array.isArray(e)?e:[e]).map(String);for(var n=0;n<i.length;n++){var a=i[n];a&&-1===e.indexOf(String(a.value))&&this.setSelected(a,!1)}return this.selectpicker.main.data.filter((function(t){return-1!==e.indexOf(String(t.value))&&(this.setSelected(t,!0),!0)}),this),this.options.source.data&&t.appendChild(this.selectpicker.main.optionQueue),this.$element.trigger("changed"+R,x),this.$newElement.hasClass($.SHOW)&&(this.multiple?this.setOptionStatus(!0):"number"==typeof(s=(t.options[t.selectedIndex]||{}).liIndex)&&this.setSelected(this.selectpicker.current.data[s],!0)),this.render(),x=null,this.$element},changeAll:function(e){if(this.multiple){void 0===e&&(e=!0);var t=this.$element[0],i=0,s=0,n=y.call(this);t.classList.add("bs-select-hidden");for(var a=0,o=this.selectpicker.current.data,r=o.length;a<r;a++){var l=o[a],h=l.option;h&&!l.disabled&&"divider"!==l.type&&(l.selected&&i++,h.selected=e,!0===(l.selected=e)&&s++)}t.classList.remove("bs-select-hidden"),i!==s&&(this.setOptionStatus(),x=[null,null,n],this.$element.triggerNative("change"))}},selectAll:function(){return this.changeAll(!0)},deselectAll:function(){return this.changeAll(!1)},toggle:function(e,t){var i=void 0===t;(e=e||window.event)&&e.stopPropagation(),!1===i&&(e=this.$newElement[0].classList.contains($.SHOW),i=!0===t&&!1===e||!1===t&&!0===e),i&&this.$button.trigger("click.bs.dropdown.data-api")},open:function(e){this.toggle(e,!0)},close:function(e){this.toggle(e,!1)},keydown:function(t){var i,s,n,a,o=e(this),r=((d=o.hasClass("dropdown-toggle"))?o.closest(".dropdown"):o.closest(W.MENU)).data("this"),l=r.findLis(),h=!1,d=9===t.which&&!d&&!r.options.selectOnTab,c=Y.test(t.which)||d,u=r.$menuInner[0].scrollTop,m=!0===r.isVirtual()?r.selectpicker.view.position0:0;if(!(112<=t.which&&t.which<=123))if(!(i=r.$menu.hasClass($.SHOW))&&(c||48<=t.which&&t.which<=57||96<=t.which&&t.which<=105||65<=t.which&&t.which<=90)&&(r.$button.trigger("click.bs.dropdown.data-api"),r.options.liveSearch))r.$searchbox.trigger("focus");else{if(27===t.which&&i&&(t.preventDefault(),r.$button.trigger("click.bs.dropdown.data-api").trigger("focus")),c){if(!l.length)return;-1!==(c=(s=r.activeElement)?Array.prototype.indexOf.call(s.parentElement.children,s):-1)&&r.defocusItem(s),38===t.which?(-1!==c&&c--,c+m<0&&(c+=l.length),r.selectpicker.view.canHighlight[c+m]||-1===(c=r.selectpicker.view.canHighlight.slice(0,c+m).lastIndexOf(!0)-m)&&(c=l.length-1)):40!==t.which&&!d||(++c+m>=r.selectpicker.view.canHighlight.length&&(c=r.selectpicker.view.firstHighlightIndex),r.selectpicker.view.canHighlight[c+m]||(c=c+1+r.selectpicker.view.canHighlight.slice(c+m+1).indexOf(!0))),t.preventDefault();var p=m+c;38===t.which?0===m&&c===l.length-1?(r.$menuInner[0].scrollTop=r.$menuInner[0].scrollHeight,p=r.selectpicker.current.elements.length-1):(n=r.selectpicker.current.data[p])&&(h=(a=n.position-n.height)<u):40!==t.which&&!d||(c===r.selectpicker.view.firstHighlightIndex?(r.$menuInner[0].scrollTop=0,p=r.selectpicker.view.firstHighlightIndex):(n=r.selectpicker.current.data[p])&&(h=u<(a=n.position-r.sizeInfo.menuInnerHeight))),s=r.selectpicker.current.elements[p],r.activeElement=(r.selectpicker.current.data[p]||{}).element,r.focusItem(s),r.selectpicker.view.currentActive=s,h&&(r.$menuInner[0].scrollTop=a),(r.options.liveSearch?r.$searchbox:o).trigger("focus")}else if(!o.is("input")&&!B.test(t.which)||32===t.which&&r.selectpicker.keydown.keyHistory){var f,_=[];t.preventDefault(),r.selectpicker.keydown.keyHistory+=z[t.which],r.selectpicker.keydown.resetKeyHistory.cancel&&clearTimeout(r.selectpicker.keydown.resetKeyHistory.cancel),r.selectpicker.keydown.resetKeyHistory.cancel=r.selectpicker.keydown.resetKeyHistory.start(),f=r.selectpicker.keydown.keyHistory,/^(.)\1+$/.test(f)&&(f=f.charAt(0));for(var g=0;g<r.selectpicker.current.data.length;g++){var v=r.selectpicker.current.data[g];C(v,f,"startsWith",!0)&&r.selectpicker.view.canHighlight[g]&&_.push(v.element)}_.length&&(m=0,l.removeClass("active").find("a").removeClass("active"),1===f.length&&(-1===(m=_.indexOf(r.activeElement))||m===_.length-1?m=0:m++),d=_[m],h=0<u-(n=r.selectpicker.main.data[d]).position?(a=n.position-n.height,!0):(a=n.position-r.sizeInfo.menuInnerHeight,n.position>u+r.sizeInfo.menuInnerHeight),s=r.selectpicker.main.elements[d],r.activeElement=s,r.focusItem(s),s&&s.firstChild.focus(),h&&(r.$menuInner[0].scrollTop=a),o.trigger("focus"))}i&&(32===t.which&&!r.selectpicker.keydown.keyHistory||13===t.which||9===t.which&&r.options.selectOnTab)&&(32!==t.which&&t.preventDefault(),r.options.liveSearch&&32===t.which||(r.$menuInner.find(".active a").trigger("click",!0),o.trigger("focus"),r.options.liveSearch||(t.preventDefault(),e(document).data("spaceSelect",!0))))}},mobile:function(){this.options.mobile=!0,this.$element[0].classList.add("mobile-device")},refresh:function(){var t=this,i=e.extend({},this.options,c(this.$element),this.$element.data());this.options=i,this.options.source.data?(this.render(),this.buildList()):this.fetchData((function(){t.render(),t.buildList()})),this.checkDisabled(),this.setStyle(),this.setWidth(),this.setSize(!0),this.$element.trigger("refreshed"+R)},hide:function(){this.$newElement.hide()},show:function(){this.$newElement.show()},remove:function(){this.$newElement.remove(),this.$element.remove()},destroy:function(){this.$newElement.before(this.$element).remove(),(this.$bsContainer||this.$menu).remove(),this.selectpicker.view.titleOption&&this.selectpicker.view.titleOption.parentNode&&this.selectpicker.view.titleOption.parentNode.removeChild(this.selectpicker.view.titleOption),this.$element.off(R).removeData("selectpicker").removeClass("bs-select-hidden selectpicker mobile-device"),e(window).off(R+"."+this.selectId)}};var J=e.fn.selectpicker;function ee(){return F.major<5?e.fn.dropdown?(e.fn.dropdown.Constructor._dataApiKeydownHandler||e.fn.dropdown.Constructor.prototype.keydown).apply(this,arguments):void 0:H.dataApiKeydownHandler}e.fn.selectpicker=Q,e.fn.selectpicker.Constructor=Z,e.fn.selectpicker.noConflict=function(){return e.fn.selectpicker=J,this},e(document).off("keydown.bs.dropdown.data-api").on("keydown.bs.dropdown.data-api",":not(.bootstrap-select) > ["+W.DATA_TOGGLE+"]",ee).on("keydown.bs.dropdown.data-api",":not(.bootstrap-select) > .dropdown-menu",ee).on("keydown"+R,".bootstrap-select ["+W.DATA_TOGGLE+'], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input',Z.prototype.keydown).on("focusin.modal",".bootstrap-select ["+W.DATA_TOGGLE+'], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input',(function(e){e.stopPropagation()})),document.addEventListener("DOMContentLoaded",(function(){e(".selectpicker").each((function(){var t=e(this);Q.call(t,t.data())}))}))}(e)}));var isSafariOrEdge=-1!=navigator.userAgent.indexOf("Safari")&&-1==navigator.userAgent.indexOf("Chrome")||-1!=navigator.userAgent.indexOf("Edge"),timeformat="",dateFormat="";function renderSchedulePopUp(){var e="",t="",i="",s="",n="";$.ajax({type:"POST",url:getRecurrenceTypeUrl,async:!1,success:function(a){null!=a.RecurrenceType&&a.RecurrenceType.length>0&&(e=location.href.match(/schedule-azure-synchronization/)?"<option value= "+a.RecurrenceType[4]+" selected>"+window.Server.App.LocalizationContent.Hourly+"</option><option value= "+a.RecurrenceType[0]+">"+window.Server.App.LocalizationContent.Daily+"</option><option value= "+a.RecurrenceType[1]+">"+window.Server.App.LocalizationContent.Weekly+"</option><option value= "+a.RecurrenceType[2]+">"+window.Server.App.LocalizationContent.Monthly+"</option><option value= "+a.RecurrenceType[3]+">"+window.Server.App.LocalizationContent.Yearly+"</option>":"<option value= "+a.RecurrenceType[0]+" selected>"+window.Server.App.LocalizationContent.Daily+"</option><option value= "+a.RecurrenceType[1]+">"+window.Server.App.LocalizationContent.Weekly+"</option><option value= "+a.RecurrenceType[2]+">"+window.Server.App.LocalizationContent.Monthly+"</option><option value= "+a.RecurrenceType[3]+">"+window.Server.App.LocalizationContent.Yearly+"</option>");for(var o=0;o<a.Days.length;o++)"day"==a.Days[o].toString().toLowerCase()||"weekday"==a.Days[o].toString().toLowerCase()?t+="<option value= "+a.Days[o]+">"+a.Days[o]+"</option>":"weekendday"==a.Days[o].toString().toLowerCase()?t+="<option value= "+a.Days[o]+">weekend day</option>":t+="<option value= "+a.Days[o]+">"+a.Days[o]+"</option>";for(o=0;o<a.Weeks.length;o++)i+="<option value= "+a.Weeks[o]+">"+a.Weeks[o]+"</option>";for(o=0;o<a.Months.length;o++)s+="<option value= "+a.Months[o]+">"+a.Months[o]+"</option>";n=a.TimeZoneDateTime.toString()},error:handleAjaxError(),complete:hideWaitingPopup($("#page_content_Div"))}),$("#recurrence-type").append(e),$("#monthly-dow-week").append(i),$("#monthly-dow-day").append(t),$("#yearly-month").append(s),$("#yearly-dow-week").append(i),$("#yearly-dow-day").append(t),$("#yearly-dow-month").append(s),new ejs.inputs.NumericTextBox({value:1,min:1,max:31,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#every-x-days"),$("#every-x-days")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:31,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#monthly-date"),$("#monthly-date")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:31,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#yearly-day"),$("#yearly-day")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:99,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#every-x-weeks"),$("#every-x-weeks")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:12,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#monthly-every-x-months"),$("#monthly-every-x-months")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:12,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#monthly-dow-every-x-months"),$("#monthly-dow-every-x-months")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:99,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#every-x-years"),$("#every-x-years")[0].ej2_instances[0].value=1,new ejs.inputs.NumericTextBox({value:1,min:1,max:999,width:"110px",format:"#",cssClass:"numeric-text-box-height"}).appendTo("#occurenceCount"),"false"==timeformat.toLowerCase()?$("#start-date").ejTimePicker({interval:10,value:n,enableStrictMode:!1,popupHeight:"150px",timeFormat:"hh:mm tt"}):$("#start-date").ejTimePicker({interval:10,value:n,enableStrictMode:!1,popupHeight:"150px",timeFormat:"HH:mm"}),$("#start-date").css({cursor:"default"}),$("#recurrence-type, #monthly-dow-week, #monthly-dow-day, #yearly-dow-week, #yearly-dow-day, #yearly-dow-month, #yearly-month").selectpicker("destroy"),$("#recurrence-type, #monthly-dow-week, #monthly-dow-day, #yearly-dow-week, #yearly-dow-day, #yearly-dow-month, #yearly-month").selectpicker()}function validateSchedule(){var e=$("#start-date").data("ejTimePicker");switch($("#recurrence-type").val().toString().toLowerCase()){case"hourly":if(""==$(".time-format").val())return $(".frequency-error").css("display","inline"),$(".time-format").parent("span").addClass("validation-error"),!1;var t=$(".time-format").val().split(":");if(!(60*t[0]+t[1]>3))return $(".frequency-error").css("display","inline"),$(".time-format").parent("span").addClass("validation-error"),!1;$(".frequency-error").css("display","none"),$(".time-format").parent("span").removeClass("validation-error");break;case"daily":case"monthly":break;case"weekly":if(!$("#days-check-box input[type='checkbox']").is(":checked"))return $("#weekly-day-error-container").css("display","block"),$("#weekly-days-validator").html(window.Server.App.LocalizationContent.WeekDaysValidator),!1;$("#weekly-day-error-container").css("display","none");break;case"yearly":var i=$("#yearly-month").val().toString(),s=parseInt($("#yearly-day").val()),n=(new Date).getFullYear()+Number($("#every-x-years").val()),a=document.getElementById("yearly-day").ej2_instances[0];switch(i.toLowerCase()){case"february":s>28&&a.option("value",n%4==0?29:28);break;case"april":case"june":case"september":case"november":s>30&&a.option("value",30);break;case"january":case"march":case"may":case"july":case"august":case"october":case"december":s>31&&a.option("value",31)}}return"h:mm tt"==!e.model.dateTimeFormat?($("#start-date-error-container").css("display","block"),$("#start-date-validator").html(window.Server.App.LocalizationContent.ScheduleTimeValidator),!1):($("#start-date-error-container").css("display","none"),!0)}function EnableSchedule(){$(".schedule-dropdown").removeAttr("disabled").selectpicker("destroy"),$(".schedule-dropdown").removeAttr("disabled").selectpicker(),$(".numeric-text-box").each((function(){$(this)[0].ej2_instances[0].enabled=!0})),$(".schedule-checkbox, #every-x-hours-value, #daily-every-x-days, #daily-week-days, #monthly, #monthly-dow,#yearly, #yearly-dow").prop("disabled",!1),$("#start-date").data("ejTimePicker").enable()}function DisableSchedule(){$(".schedule-dropdown").attr("disabled",!0).selectpicker("destroy"),$(".schedule-dropdown").attr("disabled",!0).selectpicker(),$(".numeric-text-box").each((function(){$(this)[0].ej2_instances[0].enabled=!1})),$(".schedule-checkbox, #every-x-hours-value, #daily-every-x-days, #daily-week-days, #monthly, #monthly-dow, #yearly, #yearly-dow").prop("disabled",!0),$("#start-date").data("ejTimePicker").disable()}function extractXSRFTokenFromCookie(){var e=parent.document.cookie.split("; ").find((e=>e.startsWith("XSRF-TOKEN=")));return e?e.split("=")[1]:null}function setXSRFRequestHeader(e){e.setRequestHeader("X-XSRF-TOKEN",extractXSRFTokenFromCookie())}function decodeHtmlAsString(e){var t=document.createElement("textarea");return t.innerHTML=e,t.value}function EscapeHtml(e){return e.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}$(document).ready((function(){generateProfileAvatar(),$(".time-format").ejTimePicker({timeFormat:"HH:mm",minutesInterval:5,minTime:"00:05"}),timeformat=$("#timeFormat").val(),dateFormat=$("#dateFormat").val(),showWaitingPopup($("#server-app-container")),renderSchedulePopUp(),$(parent.window).width()>1400?$(".schedule-dialog").addClass("lg-flexible-editschedule"):$(".schedule-dialog").removeClass("lg-flexible-editschedule");var e="",t="",i="";$.ajax({type:"POST",url:getScheduleInfoUrl,success:function(s){if(null!==s&&""!==s){switch(e=s.ScheduleItem,$("#hourly-schedule-option, #daily-schedule-option, #weekly-schedule-option, #monthly-schedule-option, #yearly-schedule-option").css("display","none"),$("#yearly, #daily-every-x-days, #monthly").prop("checked","checked"),e.RecurrenceType.toLowerCase()){case"hourly":t="Hourly",$("#hourly-schedule-option").css("display","block");var n=e.Recurrence.HourlySchedule.MinutesInterval,a=n%60;conversionToMinutes=a<9?parseInt(n/60)+":0"+a:parseInt(n/60)+":"+n%60;var o=conversionToMinutes.split(":"),r=(o[0],o[1],"");parseInt(o[0])>0&&(r+=o[0]+" hour(s) "),parseInt(o[1])>0&&(r+=o[1]+" minute(s)"),i=window.Server.App.LocalizationContent.OccursEvery+" "+r,$("#hourly-schedule-option").find("input").val(conversionToMinutes);break;case"daily":t="Daily",$("#daily-schedule-option").css("display","block"),$("#daily-every-x-days").prop("checked","checked"),document.getElementById("every-x-days").ej2_instances[0].value=e.Recurrence.DailySchedule.DaysInterval,i=1==e.Recurrence.DailySchedule.DaysInterval?window.Server.App.LocalizationContent.OccursEveryDay:window.Server.App.LocalizationContent.OccursEvery+e.Recurrence.DailySchedule.DaysInterval.toString()+window.Server.App.LocalizationContent.Days;break;case"dailyweekday":$("#daily-every-x-days").removeAttr("checked"),t="Daily",$("#daily-schedule-option").css("display","block"),$("#daily-every-x-days").prop("checked",!1),$("#daily-week-days").prop("checked","checked"),i=window.Server.App.LocalizationContent.OccursEveryWeek;break;case"weekly":t="Weekly",$("#weekly-schedule-option").css("display","block"),document.getElementById("every-x-weeks").ej2_instances[0].value=e.Recurrence.WeeklySchedule.WeeksInterval,$("#sun").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Sunday),$("#mon").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Monday),$("#tues").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Tuesday),$("#wed").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Wednesday),$("#thu").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Thursday),$("#fri").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Friday),$("#sat").prop("checked",e.Recurrence.WeeklySchedule.DaysOfWeek.Saturday);for(var l="",h=$(".schedule-checkbox:checked"),d=0;d<h.length;d++)l=1==h.length||0==d?$(h[d]).siblings("label").text():d>0&&d!=h.length-1?l+", "+$(h[d]).siblings("label").text():l+window.Server.App.LocalizationContent.And+$(h[d]).siblings("label").text();i=1==e.Recurrence.WeeklySchedule.WeeksInterval?window.Server.App.LocalizationContent.OccursEvery+l:window.Server.App.LocalizationContent.OccursEvery+e.Recurrence.WeeklySchedule.WeeksInterval.toString()+window.Server.App.LocalizationContent.WeeksOn+l;break;case"monthly":t="Monthly",$("#monthly-schedule-option").css("display","block"),$("#monthly").prop("checked","checked"),document.getElementById("monthly-date").ej2_instances[0].value=e.Recurrence.MonthlySchedule.DayOfMonth,document.getElementById("monthly-every-x-months").ej2_instances[0].value=e.Recurrence.MonthlySchedule.Months,i=window.Server.App.LocalizationContent.OccursDay+e.Recurrence.MonthlySchedule.DayOfMonth.toString()+window.Server.App.LocalizationContent.Every+e.Recurrence.MonthlySchedule.Months.toString()+window.Server.App.LocalizationContent.Month;break;case"monthlydow":t="Monthly",$("#monthly").removeAttr("checked"),$("#monthly-schedule-option").css("display","block"),$("#monthly").prop("checked",!1),$("#monthly-dow").prop("checked","checked"),$("#monthly-dow-week").find("option[value='"+e.Recurrence.MonthlyDowSchedule.WeeksOfTheMonth+"']").prop("selected","selected"),$("#monthly-dow-week").selectpicker("destroy"),$("#monthly-dow-week").selectpicker(),$("#monthly-dow-day").find("option[value='"+e.Recurrence.MonthlyDowSchedule.DaysOfTheWeek+"']").prop("selected","selected"),$("#monthly-dow-day").selectpicker("destroy"),$("#monthly-dow-day").selectpicker(),document.getElementById("monthly-dow-every-x-months").ej2_instances[0].value=e.Recurrence.MonthlyDowSchedule.Months,i=window.Server.App.LocalizationContent.Occurs+e.Recurrence.MonthlyDowSchedule.WeeksOfTheMonth.toString()+" "+$("#monthly-dow-day option:selected").text()+window.Server.App.LocalizationContent.Every+e.Recurrence.MonthlyDowSchedule.Months+window.Server.App.LocalizationContent.Month;break;case"yearly":t="Yearly",$("#yearly-schedule-option").css("display","block"),$("#yearly").prop("checked","checked"),document.getElementById("every-x-years").ej2_instances[0].value=e.Recurrence.YearlySchedule.YearsInterval,$("#yearly-month").find("option[value='"+e.Recurrence.YearlySchedule.MonthsOfTheYear+"']").prop("selected","selected"),$("#yearly-month").selectpicker("destroy"),$("#yearly-month").selectpicker(),document.getElementById("yearly-day").ej2_instances[0].value=e.Recurrence.YearlySchedule.DayOfMonth,i=1==e.Recurrence.YearlySchedule.YearsInterval?window.Server.App.LocalizationContent.OccursEvery+e.Recurrence.YearlySchedule.MonthsOfTheYear.toString()+" "+e.Recurrence.YearlySchedule.DayOfMonth.toString():window.Server.App.LocalizationContent.OccursEvery+e.Recurrence.YearlySchedule.YearsInterval.toString()+window.Server.App.LocalizationContent.Year+e.Recurrence.YearlySchedule.MonthsOfTheYear.toString()+" "+e.Recurrence.YearlySchedule.DayOfMonth.toString();break;case"yearlydow":$("#yearly").removeAttr("checked"),t="Yearly",$("#yearly-schedule-option").css("display","block"),$("#yearly").prop("checked",!1),$("#yearly-dow").prop("checked","checked"),document.getElementById("every-x-years").ej2_instances[0].value=e.Recurrence.YearlyDowSchedule.YearsInterval,$("#yearly-dow-week").find("option[value='"+e.Recurrence.YearlyDowSchedule.WeeksOfTheMonth+"']").prop("selected","selected"),$("#yearly-dow-week").selectpicker("destroy"),$("#yearly-dow-week").selectpicker(),$("#yearly-dow-day").find("option[value='"+e.Recurrence.YearlyDowSchedule.DaysOfTheWeek+"']").prop("selected","selected"),$("#yearly-dow-day").selectpicker("destroy"),$("#yearly-dow-day").selectpicker(),$("#yearly-dow-month").find("option[value='"+e.Recurrence.YearlyDowSchedule.MonthsOfTheYear+"']").prop("selected","selected"),$("#yearly-dow-month").selectpicker("destroy"),$("#yearly-dow-month").selectpicker(),i=1==e.Recurrence.YearlyDowSchedule.YearsInterval?window.Server.App.LocalizationContent.Occurs+e.Recurrence.YearlyDowSchedule.WeeksOfTheMonth.toString()+" "+$("#yearly-dow-day option:selected").text()+" of "+e.Recurrence.YearlyDowSchedule.MonthsOfTheYear.toString():window.Server.App.LocalizationContent.OccursEvery+e.Recurrence.YearlyDowSchedule.YearsInterval.toString()+window.Server.App.LocalizationContent.Year+e.Recurrence.YearlyDowSchedule.WeeksOfTheMonth.toString()+" "+$("#yearly-dow-day option:selected").text()+" "+window.Server.App.LocalizationContent.Of+" "+e.Recurrence.YearlyDowSchedule.MonthsOfTheYear.toString()}$("#recurrence-type").find("option[value='"+t+"']").prop("selected","selected"),$("#recurrence-type").selectpicker("destroy"),$("#recurrence-type").selectpicker();var c="";if("dd/MM/yyyy"==dateFormat||"dd.MM.yyyy"==dateFormat)var u=e.StartDateString.split(/[/.]/),m=u[0],p=u[1],f=u[2],_=new Date(p+"/"+m+"/"+f);else _=new Date(e.StartDateString);if("false"==timeformat.toLowerCase()){c=new Date(_);DateCustomFormat(dateFormat+" hh:mm",c,timeformat);var g=c.getHours()>=12?"PM":"AM",v="PM"==g?c.getHours()-12:c.getHours();$("#start-date").ejTimePicker({value:v+":"+c.getMinutes()+" "+g})}else{c=new Date(_);DateCustomFormat(dateFormat+" HH:mm",c,timeformat);$("#start-date").ejTimePicker({value:c.getHours()+":"+c.getMinutes()+" "})}$("#next-schedule").html(e.NextScheduleString),$(".recurrence-information").html(i+window.Server.App.LocalizationContent.Effective+e.StartDateString),$("#enable-schedule").prop("checked",e.IsEnabled).trigger("change")}else $("#enable-schedule").prop("checked",!1).trigger("change"),$(".recurrence-information").html("")},error:handleAjaxError(),complete:hideWaitingPopup($("#server-app-container"))}),$(".e-select").each((function(){var e=$(this).find(".e-spin-up"),t=$(this).find(".e-spin-down");e.length&&t.length>1&&$(this).find(".e-spin-down:gt(0)").remove(),e.length&&t.length&&$.contains(e[0],t[0])&&t.first().appendTo(e.parent())})),$("#enable-checkbox,#enable-sunday,#enable-monday,#enable-tuesday,#enable-wednesday,#enable-thursday,#enable-friday,#enable-saturday").on("click",(function(){isSafariOrEdge&&$(this).find("label").toggleClass("check")}))})),$(document).on("change","#recurrence-type",(function(){var e=$(this).find("option:selected").val();$("#hourly-schedule-option, #daily-schedule-option, #weekly-schedule-option, #monthly-schedule-option, #yearly-schedule-option").css("display","none"),$("#"+e.toString().toLowerCase()+"-schedule-option").css("display","block"),$("#weekly-day-error-container").hide()})),$(document).on("click","#update-schedule-synchronization-bottom",(function(){var e="";if(validateSchedule()){showWaitingPopup($("#server-app-container"));var t={};switch($("#recurrence-type").val().toString().toLowerCase()){case"hourly":t.RecurrenceType="Hourly",t.Frequency=$(".time-format").val(),t.RecurrenceInterval=$("#every-x-hours-value").val();var i=t.Frequency.split(":"),s=(i[0],i[1],"");parseInt(i[0])>0&&(s+=i[0]+" hour(s) "),parseInt(i[1])>0&&(s+=i[1]+" minute(s)"),e=window.Server.App.LocalizationContent.OccursEvery+" "+s;break;case"daily":$("#daily-every-x-days").is(":checked")?(t.RecurrenceType="Daily",t.RecurrenceInterval=$("#every-x-days").val(),e=1==t.RecurrenceInterval?window.Server.App.LocalizationContent.OccursEveryDay:window.Server.App.LocalizationContent.OccursEvery+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.Days):(t.RecurrenceType="DailyWeekDay",e=window.Server.App.LocalizationContent.OccursEveryWeek);break;case"weekly":t.RecurrenceType="Weekly",t.RecurrenceInterval=$("#every-x-weeks").val(),t.Sunday=$("#sun").prop("checked"),t.Monday=$("#mon").prop("checked"),t.Tuesday=$("#tues").prop("checked"),t.Wednesday=$("#wed").prop("checked"),t.Thursday=$("#thu").prop("checked"),t.Friday=$("#fri").prop("checked"),t.Saturday=$("#sat").prop("checked");for(var n="",a=$(".schedule-checkbox:checked"),o=0;o<a.length;o++)n=1==a.length||0==o?$(a[o]).siblings("label").text():o>0&&o!=a.length-1?n+", "+$(a[o]).siblings("label").text():n+window.Server.App.LocalizationContent.And+$(a[o]).siblings("label").text();e=1==t.RecurrenceInterval?window.Server.App.LocalizationContent.OccursEvery+n:window.Server.App.LocalizationContent.OccursEvery+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.WeeksOn+n;break;case"monthly":$("#monthly").is(":checked")?(t.RecurrenceType="Monthly",t.DaysOfMonth=$("#monthly-date").val(),t.RecurrenceInterval=$("#monthly-every-x-months").val(),e=window.Server.App.LocalizationContent.OccursDay+t.DaysOfMonth.toString()+window.Server.App.LocalizationContent.Every+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.Month):(t.RecurrenceType="MonthlyDOW",t.WeekOfMonth=$("#monthly-dow-week").val(),t.DayOfWeek=$("#monthly-dow-day").val(),t.RecurrenceInterval=$("#monthly-dow-every-x-months").val(),e=window.Server.App.LocalizationContent.Occurs+t.WeekOfMonth.toString()+" "+$("#monthly-dow-day option:selected").text()+window.Server.App.LocalizationContent.Every+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.Month);break;case"yearly":t.RecurrenceInterval=$("#every-x-years").val(),$("#yearly").is(":checked")?(t.RecurrenceType="Yearly",t.DaysOfMonth=$("#yearly-day").val(),t.MonthOfYear=$("#yearly-month").val(),e=1==t.RecurrenceInterval?window.Server.App.LocalizationContent.OccursEvery+t.MonthOfYear.toString()+" "+t.DaysOfMonth.toString():window.Server.App.LocalizationContent.OccursEvery+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.Year+t.MonthOfYear.toString()+" "+t.DaysOfMonth.toString()):(t.RecurrenceType="YearlyDOW",t.WeekOfMonth=$("#yearly-dow-week").val(),t.DayOfWeek=$("#yearly-dow-day").val(),t.MonthOfYear=$("#yearly-dow-month").val(),e=1==t.RecurrenceInterval?window.Server.App.LocalizationContent.Occurs+t.WeekOfMonth.toString()+" "+$("#yearly-dow-day option:selected").text()+" "+window.Server.App.LocalizationContent.Of+" "+t.MonthOfYear.toString():window.Server.App.LocalizationContent.OccursEvery+t.RecurrenceInterval.toString()+window.Server.App.LocalizationContent.Year+t.WeekOfMonth.toString()+" "+$("#yearly-dow-day option:selected").text()+" "+window.Server.App.LocalizationContent.Of+" "+t.MonthOfYear.toString())}t.StartDate=$("#start-date").val(),t.IsEnabled=$("#enable-schedule").prop("checked"),$.ajax({type:"POST",url:updateAdScheduleUrl,data:{scheduleSettingsData:JSON.stringify({ScheduleItem:t})},success:function(i){t.IsEnabled&&($("#next-schedule").html(i.NextScheduleValue),$(".recurrence-information").html(e+window.Server.App.LocalizationContent.Effective+i.StartDateValue)),i.permissionDenied?WarningAlert(window.Server.App.LocalizationContent.ScheduleSyncSettings,window.Server.App.LocalizationContent.PermissionWarningAlert,7e3):SuccessAlert(window.Server.App.LocalizationContent.ScheduleSyncSettings,window.Server.App.LocalizationContent.SettingsSuccessAlert,7e3)},error:handleAjaxError(),complete:function(){hideWaitingPopup($("#server-app-container"))}})}})),$(document).on("change","#enable-schedule",(function(){$(this).is(":checked")?EnableSchedule():DisableSchedule(),isSafariOrEdge&&($("#enable-sunday,#enable-monday,#enable-tuesday,#enable-wednesday,#enable-thursday,#enable-friday,#enable-saturday").find("label").toggleClass("check"),$("#daily-every-x-days, #daily-week-days, #monthly, #monthly-dow,#yearly, #yearly-dow").next().toggleClass("check")),$(".validation-message").hide()})),$.ajaxSetup({beforeSend:function(e){setXSRFRequestHeader(e)}});